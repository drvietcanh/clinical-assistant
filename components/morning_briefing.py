...
def render_morning_briefing():
    ...
    html_content = f"""
    <div style="background: linear-gradient(135deg, #00897B 0%, #00695C 100%); padding: 2rem; border-radius: 16px; margin-bottom: 2rem; color: white; box-shadow: 0 4px 12px rgba(0, 137, 123, 0.3);">
        <p style="color: rgba(255,255,255,0.9); font-size: 0.9rem; margin-bottom: 0.5rem; font-weight: 500;">{day_of_week}, {date_str}</p>
        <h1 style="font-size: 2.5rem; font-weight: 700; margin: 0 0 1.5rem 0; letter-spacing: -0.02em;">{emoji} {greeting}, Bác sĩ!</h1>
