...
def render_guideline_card(guideline, index: int):
    ...
    # Build HTML using f-string with triple quotes (same pattern as Articles page)
    card_html = f"""
    <div class="guideline-card" style="border-left-color: {border_color};">
        ...
        <div style="margin-top: 12px; display: flex; gap: 12px; flex-wrap: wrap; align-items: center;">
            {f'<a href="{html.escape(guideline.url)}" target="_blank" style="color: #1976d2; text-decoration: none; font-size: 0.9rem; font-weight: 500;">🔗 Xem guideline đầy đủ</a>' if guideline.url else ''}
