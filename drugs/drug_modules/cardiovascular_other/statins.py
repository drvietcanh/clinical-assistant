...
STATINS_DRUGS = {
    "High-intensity statin (đột quỵ/TIA)":     {
        ...
        "mechanism_of_action": """Ức chế HMG-CoA reductase → giảm tổng hợp cholesterol gan, tăng LDL receptor, giảm LDL-C. Hiệu ứng chống viêm/ổn định mảng xơ vữa giúp giảm tái phát đột quỵ và biến cố tim mạch.""",
        "monitoring": [
            ...
            "minor": [
    {
        ...
        "risk_flags": {
            ...
            "bleeding_risk": "Low",
            "organ_toxicity": {"hepatic": "Moderate", "musculoskeletal": "High (rhabdomyolysis)", "metabolic": "Moderate (new-onset diabetes)"}
        },
        "guideline_tags": [
            "AHA/ASA 2021 Secondary Stroke Prevention Guidelines",
            "AHA/ASA 2023 Stroke Prevention Update",
