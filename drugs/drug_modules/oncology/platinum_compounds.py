...
PLATINUM_COMPOUNDS_DRUGS = {
    ...
    "Cisplatin": {'group': 'Oncology - Platinum Compound',
        ...
        'compatibility': ['NS 0.9%', 'Dung dịch chứa clorua', 'Các thuốc khác'],
        'notes':
    ...
    "Oxaliplatin": {'group': 'Oncology - Platinum Compound',
        ...
        'reversal_agents': {'available': False, 'agents': [],
        'notes': 'Không có antidote đặc hiệu. Điều trị quá liều chủ yếu là hỗ trợ. Tránh tiếp xúc với lạnh (quan trọng).'},
        'administration_instructions': {'oral': {
        'with_food': 'Không áp dụng', 'timing':
        'Không có dạng uống (chỉ có IV)'},
        'iv': {'reconstitution':
