...
TOPOISOMERASE_INHIBITORS_DRUGS = {
    ...
    "Irinotecan": {'group': 'Oncology - Topoisomerase Inhibitor',
        'vietnamese_name':
        ...
        'Atropine: giảm cholinergic syndrome (dùng kèm)'],
        'pregnancy':
        ...
        'Dấu hiệu mất nước do tiêu chảy'],
        'precautions': [
        ...
        'Tương tác với CYP3A4 inhibitors/inducers (ảnh hưởng nồng độ irinotecan)'],
        'pharmacokinetics': {
        ...
        'Gan (chuyển hóa irinotecan thành SN-38 qua CYP3A4, UGT1A1), thận (thải trừ - ít)'},
        'storage':
        ...
        'Thận trọng, có thể cần giảm liều irinotecan.'}],
        'minor': []},
