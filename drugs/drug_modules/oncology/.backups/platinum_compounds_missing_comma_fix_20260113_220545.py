...
PLATINUM_COMPOUNDS_DRUGS = {
    "Carboplatin": {'group': 'Oncology - Platinum Compound',vietnamese_name':
        'Carboplatin, Paraplatin', 'administration': ['IV'],
        'indications': [
        'Ung thư buồng trứng', 'Ung thư phổi (NSCLC)', 'Ung thư đầu cổ',
        'Ung thư cổ tử cung', 'Ung thư tinh hoàn'],
        'contraindications': [
        ...
        'Hạ magne máu'],interactions': [
        'Thuốc độc thận: tránh dùng đồng thời',
        'Phenytoin: giảm nồng độ phenytoin'],mechanism_of_action':
        ...
        'Thận trọng. Theo dõi chức năng thận.'}],minor': []},contraindications': {'tuyệt_đối': ['Có thai', 'Đang cho con bú',
        'Dị ứng carboplatin hoặc platinum compounds',
        ...
        'Đã dùng platinum compounds trước đây - tăng nguy cơ phản ứng dị ứng']},pregnancy_lactation': {'fda_category': 'D', 'pregnancy_details':
        ...
        , 'recommendation':
        'Không dùng khi cho con bú. Ngừng cho con bú hoặc ngừng điều trị.'}},hepatic_adjustment': {'mild': 'Không đổi', 'moderate':
        ...
        'Không có antidote đặc hiệu. Điều trị chủ yếu là hỗ trợ và điều trị triệu chứng. Hydration đầy đủ để tăng thải trừ. Điều trị độc thận, độc thần kinh hỗ trợ.'},administration_instructions': {'oral': {'with_food': 'N/A', 'timing':
        ...
        'compatibility': ['D5W', 'NS'],incompatibility': ['Các thuốc khác'],notes':
        ...
        "Goodman & Gilman's The Pharmacological Basis of Therapeutics"],last_updated': '2024-12-19', 'evidence_level':
        'High - Multiple RCTs and systematic reviews'}},
    "Cisplatin": {'group': 'Oncology - Platinum Compound',vietnamese_name':
        'Cisplatin, Platinol', 'administration': ['IV'],
        'indications': [
        ...
        'Giảm liều 25-50%', 'under_30': 'Không dùng hoặc giảm liều 50-75%'},side_effects': ['Độc thận (phổ biến và nghiêm trọng - cần hydration)',
        ...
        'Theo dõi INR thường xuyên. Điều chỉnh liều warfarin nếu cần.'}],minor': [{'drug': 'Nephrotoxic drugs (NSAIDs, ACE inhibitors)',
        'mechanism': 'Tăng độc thận', 'effect': 'Tăng nguy cơ suy thận',
        'management': 'Thận trọng. Theo dõi chức năng thận.'}]},contraindications': {'tuyệt_đối': ['Suy thận nặng (CrCl <60)',
        ...
        'Đã dùng cisplatin trước đây - tích lũy độc tính']},pregnancy_lactation': {'fda_category': 'D', 'pregnancy_details':
        ...
        'Hạ magne máu nặng', 'Độc tim (rối loạn nhịp, suy tim)', 'Suy hô hấp'],antidote': 'Không có antidote đặc hiệu. Điều trị hỗ trợ', 'treatment':
        ['Ngừng truyền ngay lập tức',
    ...
    "Oxaliplatin": {'group': 'Oncology - Platinum Compound',vietnamese_name':
        'Oxaliplatin, Eloxatin', 'administration': ['IV'],
        'indications': [
        ...
        'Suy gan nặng', 'Có thai', 'Đang cho con bú'],
        'dosage': {
        'adult_folfox':
        '85mg/m² IV mỗi 2 tuần (phối hợp với 5-FU và leucovorin)',
        'adult_single': '85-130mg/m² IV mỗi 2-3 tuần', 'notes':
        'Truyền 2-6 giờ. Tránh lạnh (độc lạnh - cold-induced neuropathy)'},renal_adjustment': {'normal': 'Không đổi', '30_60':
        ...
        'Theo dõi nồng độ phenytoin. Có thể cần tăng liều phenytoin.'}],minor': []},contraindications': {'tuyệt_đối': [
        'Dị ứng oxaliplatin hoặc platinum compounds',
        ...
        'Phản ứng dị ứng nặng'],treatment': ['Ngừng ngay oxaliplatin',
        ...
        },reversal_agents': {'available': False, 'agents': [],notes': 'Không có antidote đặc hiệu. Điều trị quá liều chủ yếu là hỗ trợ. Tránh tiếp xúc với lạnh (quan trọng).'},administration_instructions': {'oral': {
        ...
        , 'infusion_rate': 'Truyền trong 2-6 giờ', 'compatibility': ['D5W'],incompatibility': ['NS', 'NaCl'],notes':
