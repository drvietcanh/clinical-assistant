...
ANTHRACYCLINES_DRUGS = {
    "Doxorubicin": {'group': 'Oncology - Anthracycline',
        ...
        'available': False, 'agents': [],notes': 'Không có antidote đặc hiệu. Điều trị quá liều chủ yếu là hỗ trợ. Nếu có extravasation: ngừng truyền ngay, không rút kim, chườm lạnh, tham khảo phẫu thuật.'},
        'pregnancy_lactation':
