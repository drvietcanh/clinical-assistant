...
ALKYLATING_AGENTS_DRUGS = {
    "Cyclophosphamide": {'group': 'Oncology - Alkylating Agent',vietnamese_name':
        'Cyclophosphamide, Endoxan, Cytoxan', 'administration': ['PO', 'IV'],indications': ['U lympho (lymphoma)', 'Bệnh bạch cầu', 'Ung thư vú',
        'Ung thư buồng trứng', 'Bệnh tự miễn (lupus, vasculitis, liều thấp)'],contraindications': ['Dị ứng cyclophosphamide',
        ...
        'Giảm liều 25-50%', 'under_30': 'Thận trọng, giảm liều đáng kể'},side_effects': [
        ...
        'Thận trọng. Theo dõi độc tính chặt chẽ. Có thể cần điều chỉnh liều.'}],moderate': [{'drug': 'Succinylcholine', 'mechanism':
        ...
        'Theo dõi INR thường xuyên. Điều chỉnh liều warfarin nếu cần.'}],minor': [{'drug': 'Mesna', 'mechanism': 'Bảo vệ chống viêm bàng quang',
        'effect': 'Giảm nguy cơ viêm bàng quang chảy máu', 'management':
        'Dùng kèm khi dùng liều cao. Liều: 20% liều cyclophosphamide.'}]},contraindications': {'tuyệt_đối': [
        ...
        'Đã dùng cyclophosphamide trước đây - tích lũy độc tính']},pregnancy_lactation': {'fda_category': 'D', 'pregnancy_details':
        ...
        'Độc tim (rối loạn nhịp, suy tim)', 'Suy thận cấp', 'Suy hô hấp'],antidote':
        ...
        'Điều trị hỗ trợ: Chống nôn, truyền dịch, theo dõi tim mạch'],monitoring':
        ...
        'Mesna (bảo vệ bàng quang, không phải antidote)']},administration_instructions': {'oral': {'with_food':
    ...
    "Ifosfamide": {'group': 'Oncology - Alkylating Agent',vietnamese_name':
        ...
        'Luôn dùng kèm mesna để bảo vệ bàng quang. Uống nhiều nước'},renal_adjustment': {'normal': 'Không đổi', '30_60':
        ...
        'Phenobarbital: tăng chuyển hóa', 'Cisplatin: tăng độc thận'],pregnancy': 'D - Chống chỉ định', 'mechanism_of_action':
        ...
        'Gan (chuyển hóa chủ yếu qua CYP2B6, CYP3A4), thận (thải trừ)'},storage':
        ...
        'management':
        'Theo dõi đáp ứng điều trị. Có thể cần tăng liều ifosfamide.'}],minor': []},contraindications': {'tuyệt_đối': [
        'Có thai - chống chỉ định tuyệt đối, gây dị tật thai nhi (category D)',
        'Đang cho con bú - chống chỉ định',
        'Viêm bàng quang chảy máu nặng - chống chỉ định cho đến khi hồi phục'],tương_đối': [
        ...
        'infusion_rate': 'Truyền trong 1-4 giờ', 'compatibility': ['NS', 'D5W'],incompatibility': [],notes':
