...
ANTHRACYCLINES_DRUGS = {
    "Doxorubicin": {'group': 'Oncology - Anthracycline',vietnamese_name':
        'Doxorubicin, Adriamycin', 'administration': ['IV'],indications': [
        'Ung thư vú', 'U lympho', 'Bệnh bạch cầu', 'Sarcoma mô mềm',
        'Ung thư buồng trứng', 'Ung thư phổi (SCLC)'],contraindications': [
        ...
        'Thận trọng, có thể giảm liều', 'under_30': 'Thận trọng, giảm liều'},side_effects': [
        ...
        'Nước tiểu đỏ (bình thường, không phải máu)', 'Vô sinh'],interactions': ['Cyclophosphamide: tăng độc tim',
        ...
        'Nước tiểu đỏ (bình thường, không phải máu)'],precautions': [
        ...
        'Có thể gây vô sinh (cần tư vấn trước điều trị)'],pharmacokinetics':
