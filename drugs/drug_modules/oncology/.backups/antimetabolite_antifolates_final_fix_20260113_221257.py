...
ANTIMETABOLITE_ANTIFOLATES_DRUGS = {
    "Methotrexate": {'group': 'Oncology - Antimetabolite (Antifolate)',
        'vietnamese_name':
        ...
        'Không dùng hoặc giảm liều đáng kể, theo dõi sát'},
        'side_effects': [
        ...
        'Độc thận (với liều cao)', 'Rụng tóc', 'Phát ban'],
        'interactions': [
        ...
        , 'clearance': 'Chủ yếu qua thận (80-90%), cần điều chỉnh thận'},storage':
        ...
        'Giảm bạch cầu/tiểu cầu nặng', 'Loét dạ dày tá tràng hoạt động'],tương_đối': ['Suy thận (CrCl 30-60: giảm liều 25-50%)',
