...
ANTIMETABOLITES_DRUGS = {
    "5-Fluorouracil": {'group': 'Oncology - Antimetabolite',vietnamese_name':
        '5-Fluorouracil, 5-FU, Fluorouracil', 'administration': ['IV'],indications': [        'Ung thư đại trực tràng (adjuvant và metastatic)',
        'Ung thư dạ dày', 'Ung thư đầu cổ', 'Ung thư tụy', 'Ung thư vú',
        'Ung thư da (topical)'],contraindications': [
        ...
        'notes':
        'Phối hợp với leucovorin để tăng hiệu quả. Cần test DPD nếu có thể'},renal_adjustment': {'normal': 'Không đổi', '30_60':
        ...
        'Warfarin: tăng nguy cơ chảy máu', 'Phenytoin: tăng nồng độ phenytoin'],pregnancy': 'D - Chống chỉ định', 'mechanism_of_action':
        ...
        , 'Dấu hiệu nhiễm trùng (sốt, ớn lạnh) do giảm bạch cầu'],precautions': [
        ...
        , 'recommendation':
        'Không cho con bú khi dùng 5-FU. Ngừng cho con bú hoặc ngừng thuốc.'}},hepatic_adjustment': {'mild': 'Không đổi', 'moderate':
        ...
        'Độc tim (hiếm)', 'Rối loạn thần kinh (hiếm)', 'Tăng bilirubin'],antidote':
        ...
        "Goodman & Gilman's Pharmacological Basis of Therapeutics, 14th ed"],last_updated': '2025-01-15', 'evidence_level':
    ...
    "Gemcitabine": {'group': 'Oncology - Antimetabolite',vietnamese_name':
        ...
        'Live vaccines: tránh dùng trong điều trị'],mechanism_of_action':
        ...
        'Theo dõi CBC chặt chẽ. Có thể cần giảm liều hoặc trì hoãn điều trị.'}],moderate': [{'drug': 'Warfarin', 'mechanism':
        ...
        'Tránh dùng live vaccines trong điều trị và ít nhất 3 tháng sau điều trị.'}]},contraindications': {'tuyệt_đối': [
        ...
        , 'recommendation':
        'Không cho con bú khi dùng gemcitabine. Ngừng cho con bú hoặc ngừng thuốc.'}},hepatic_adjustment': {'mild': 'Không đổi', 'moderate':
        'Thận trọng, có thể cần giảm liều', 'severe':
        'Thận trọng, giảm liều 25-50%', 'notes':
        'Gemcitabine chuyển hóa một phần qua gan (deamination). Suy gan có thể làm giảm chuyển hóa, tăng nồng độ và độc tính. Theo dõi chức năng gan và độc tính chặt chẽ.'},overdose_management': {'symptoms': [
        'Giảm bạch cầu, tiểu cầu nặng (nhiễm trùng, chảy máu)',
        ...
        'CBC mỗi ngày, chức năng gan, chức năng thận, dấu hiệu nhiễm trùng, dấu hiệu chảy máu, dấu hiệu độc phổi'},reversal_agents': {'available': False, 'agents': [],notes':
        'Không có antidote đặc hiệu. Điều trị chủ yếu là hỗ trợ và điều trị triệu chứng. Ngừng thuốc ngay. Điều trị độc phổi (corticosteroid nếu có viêm phổi kẽ), độc tính máu, và nhiễm trùng hỗ trợ.'},administration_instructions': {'oral': None, 'iv': {'reconstitution':
        'Pha với NS hoặc D5W theo hướng dẫn nhà sản xuất. Nồng độ cuối: ≤40mg/ml.',
        'infusion_rate': 'Truyền trong 30 phút (tốc độ tiêu chuẩn)',
        'compatibility': ['NS', 'D5W'],incompatibility': [],notes':
        'Truyền trong 30 phút. Theo dõi extravasation. Có thể phối hợp với cisplatin, carboplatin, hoặc paclitaxel.'}},references': {'primary_sources': ['FDA Drug Label - Gemcitabine (Gemzar)',
