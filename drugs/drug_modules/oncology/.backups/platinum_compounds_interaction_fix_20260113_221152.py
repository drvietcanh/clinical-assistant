...
PLATINUM_COMPOUNDS_DRUGS = {
    "Carboplatin": {'group': 'Oncology - Platinum Compound',
        'vietnamese_name':
    ...
    "Cisplatin": {'group': 'Oncology - Platinum Compound',
        'vietnamese_name':
        ...
        'Hạ magne máu (phổ biến)', 'Độc tim (hiếm)'],
        'interactions': [
        ...
        "Goodman & Gilman's The Pharmacological Basis of Therapeutics"],last_updated': '2024-12-19', 'evidence_level':
        'High - Multiple RCTs and systematic reviews'}},
    "Oxaliplatin": {'group': 'Oncology - Platinum Compound',
        'vietnamese_name':
