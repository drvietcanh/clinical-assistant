...
TAXANES_DRUGS = {
    "Docetaxel": {'group': 'Oncology - Taxane',
        ...
        'CYP3A4 inducers: giảm nồng độ docetaxel'],
        'pregnancy':
        ...
        'clearance':
        'Gan (chuyển hóa qua CYP3A4), thận (thải trừ - ít, <5%)'},
        'storage':
    ...
    "Paclitaxel": {'group': 'Oncology - Taxane',
        ...
        'CYP2C8 inhibitors: tăng nồng độ paclitaxel'],
        'pregnancy':
        'D - Chống chỉ định', 'mechanism_of_action':
        ...
        'clearance':
        'Gan (chuyển hóa qua CYP2C8, CYP3A4), thận (thải trừ - ít, <5%)'},
        'storage':
