...
TAXANES_DRUGS = {
    "Docetaxel": {'group': 'Oncology - Taxane',
        'vietnamese_name':
        'Docetaxel, Taxotere', 'administration': ['IV'],
        'indications': [
        ...
        'Ung thư đầu cổ'],
        'contraindications': [
        'Giảm bạch cầu nặng (ANC <1500)', 'Có thai', 'Đang cho con bú'],
        'dosage': {
        ...
        'Độc da (rash, nail changes - phổ biến)'],
        'interactions': [
        ...
        'Dấu hiệu độc da (rash, nail changes) - phổ biến'],
        'precautions': [
        ...
        'Tương tác với CYP3A4 inhibitors/inducers (ảnh hưởng nồng độ docetaxel)'],
        'pharmacokinetics': {
        ...
        'Tránh dùng với ketoconazole, itraconazole. Nếu phải dùng, giảm liều docetaxel.'}],moderate': [{'drug': 'CYP3A4 inducers (Rifampin, Carbamazepine)', 'mechanism':
        'Cảm ứng CYP3A4, giảm nồng độ docetaxel', 'effect':
        'Giảm nồng độ docetaxel, giảm hiệu quả', 'management':
        'Theo dõi đáp ứng điều trị. Có thể cần tăng liều docetaxel.'}],minor': []},contraindications': {'tuyệt_đối': [
        ...
        , 'recommendation':
        'Không cho con bú khi dùng docetaxel. Ngừng cho con bú hoặc ngừng thuốc.'}},hepatic_adjustment': {'mild': 'Không đổi', 'moderate':
        ...
        'Docetaxel chuyển hóa chủ yếu qua gan (CYP3A4). Suy gan làm giảm chuyển hóa, tăng nồng độ và độc tính nghiêm trọng. CHỐNG CHỈ ĐỊNH trong suy gan.'},overdose_management': {'symptoms': [
        ...
        'monitoring':
        'CBC mỗi ngày, chức năng gan, chức năng thận, dấu hiệu nhiễm trùng, dấu hiệu chảy máu, dấu hiệu độc thần kinh, dấu hiệu giữ nước (cân nặng, phù)'},reversal_agents': {'available': False, 'agents': [],notes':
        'Không có antidote đặc hiệu. Điều trị chủ yếu là hỗ trợ và điều trị triệu chứng. Ngừng thuốc ngay. Điều trị độc tính máu, độc thần kinh, giữ nước, và nhiễm trùng hỗ trợ.'},administration_instructions': {'oral': None, 'iv': {'reconstitution':
        ...
        'Theo dõi sát trong 30 phút đầu (phản ứng quá mẫn). Có thể phối hợp với carboplatin, cisplatin, hoặc prednisone (ung thư tuyến tiền liệt).'}},references': {'primary_sources': ['FDA Drug Label - Docetaxel (Taxotere)',
    ...
    "Paclitaxel": {'group': 'Oncology - Taxane',
        'vietnamese_name':
        'Paclitaxel, Taxol', 'administration': ['IV'],
        'indications': [
        'Ung thư vú (adjuvant và metastatic)', 'Ung thư phổi không tế bào nhỏ (NSCLC)',
        ...
        'Truyền qua filter không chứa DEHP (Cremophor EL có thể hòa tan DEHP)'],
        'pharmacokinetics': {
        ...
        'Tránh dùng với ketoconazole, itraconazole. Nếu phải dùng, giảm liều paclitaxel.'}],moderate': [{'drug': 'Doxorubicin', 'mechanism':
        'Cả hai đều có thể gây độc tim', 'effect': 'Tăng nguy cơ độc tim', 'management':
        'Theo dõi chức năng tim chặt chẽ. Có thể cần giảm liều hoặc tránh dùng đồng thời.'}],minor': [{'drug': 'CYP2C8 inhibitors (gemfibrozil)', 'mechanism':
        ...
        , 'recommendation':
        'Không cho con bú khi dùng paclitaxel. Ngừng cho con bú hoặc ngừng thuốc.'}},hepatic_adjustment': {'mild': 'Không đổi', 'moderate':
        'Thận trọng, có thể cần giảm liều 25%', 'severe':
        'Thận trọng, giảm liều 25-50%', 'notes':
        'Paclitaxel chuyển hóa chủ yếu qua gan (CYP2C8, CYP3A4). Suy gan có thể làm giảm chuyển hóa, tăng nồng độ và độc tính. Theo dõi chức năng gan và độc tính chặt chẽ.'},overdose_management': {'symptoms': [
        'Phản ứng quá mẫn nặng (sốc phản vệ - nguy hiểm tính mạng)',
        'Giảm bạch cầu, tiểu cầu nặng (nhiễm trùng, chảy máu)',
        'Độc thần kinh ngoại biên nặng (tê bì, dị cảm, yếu cơ)',
        ...
        'Theo dõi và điều trị triệu chứng'],
        'monitoring':
        'CBC mỗi ngày, chức năng gan, chức năng thận, dấu hiệu nhiễm trùng, dấu hiệu chảy máu, dấu hiệu độc thần kinh, dấu hiệu độc tim'},reversal_agents': {'available': False, 'agents': [],notes':
        'Không có antidote đặc hiệu. Điều trị chủ yếu là hỗ trợ và điều trị triệu chứng. Ngừng thuốc ngay. Điều trị độc tính máu, độc thần kinh, độc tim, và nhiễm trùng hỗ trợ.'},administration_instructions': {'oral': None, 'iv': {'reconstitution':
        ...
        'compatibility': ['NS', 'D5W'],incompatibility': ['DEHP-containing filters'],notes':
        'Truyền qua filter không chứa DEHP. Theo dõi sát trong 30 phút đầu (phản ứng quá mẫn). Có thể phối hợp với carboplatin, cisplatin, hoặc doxorubicin.'}},references': {'primary_sources': ['FDA Drug Label - Paclitaxel (Taxol)',
