...
ANTI_EMETIC_5_HT3_ANTAGONISTS_DRUGS = {
    "Granisetron": {'group': 'Oncology - Anti-emetic (5-HT3 Antagonist)',vietnamese_name':
        ...
        'normal': 'Không đổi', '30_60': 'Không đổi', 'under_30': 'Không đổi'},side_effects': ['Đau đầu (phổ biến)', 'Táo bón', 'Chóng mặt',
        'Mệt mỏi', 'Tăng transaminase (hiếm)', 'QT kéo dài (hiếm)'],interactions': ['Apomorphine: chống chỉ định (tăng tác dụng)',
        ...
        'Chức năng gan nếu dùng lâu dài (tăng transaminase - hiếm)'],precautions': [
        ...
        'Có thể dùng trong thai kỳ (category B - thận trọng)'],pharmacokinetics': {'half_life': '3-5 giờ (IV), 6-9 giờ (PO)', 'onset':
        ...
        'Không nên dùng đồng thời. Chọn một trong hai.'}],minor': []},contraindications': {'tuyệt_đối': [
        ...
        'Điều trị táo bón nếu cần']},reversal_agents': None, 'administration_instructions': {'oral': {
    ...
    "Palonosetron": {'group': 'Oncology - Anti-emetic (5-HT3 Antagonist)',vietnamese_name':
        ...
        'Phòng nôn do hóa trị (ngắn và trung hạn)', 'Phòng nôn sau phẫu thuật'],contraindications': ['Dị ứng palonosetron hoặc 5-HT3 antagonists'],dosage': {'adult_chemotherapy': '0.25mg IV x 1 lần trước hóa trị',
        'adult_surgery': '0.075mg IV x 1 lần trước gây mê', 'notes':
        'Tác dụng dài (48-72 giờ), chỉ cần 1 liều'},renal_adjustment': {
        'normal': 'Không đổi', '30_60': 'Không đổi', 'under_30': 'Không đổi'},side_effects': ['Đau đầu', 'Táo bón', 'Chóng mặt', 'Mệt mỏi',
        'QT kéo dài (hiếm)'],interactions': ['Apomorphine: chống chỉ định'],pregnancy': 'B - Thận trọng', 'mechanism_of_action':
        ...
        'Tác dụng dài hơn so với ondansetron và granisetron'],pharmacokinetics': {'half_life': '40 giờ (rất dài)', 'onset':
