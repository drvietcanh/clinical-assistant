...
"Epinephrine": {
    ...
    "Atropine": {
        ...
        "drug_interactions": {
            "major": [
                {
                    "drug": "Các anticholinergics khác (Benztropine, Diphenhydramine, Scopolamine)",
                    "mechanism": "Tác dụng cộng dồn kháng cholinergic, tăng tác dụng phụ.",
                    "effect": "Tăng tác dụng phụ: khô miệng nặng, bí tiểu, lú lẫn, tăng nhãn áp",
                    "management": "Thận trọng khi dùng đồng thời. Giảm liều hoặc tránh dùng nếu có thể. Theo dõi dấu hiệu kháng cholinergic quá mức."
                }
            ],
            "moderate": [
                {
                    "drug": "Digoxin",
                    "mechanism": "Atropine có thể làm chậm nhu động ruột, tăng hấp thu digoxin.",
                    "effect": "Tăng nồng độ digoxin, tăng nguy cơ độc tính",
                    "management": "Theo dõi nồng độ digoxin và dấu hiệu độc tính digoxin. Điều chỉnh liều digoxin nếu cần."
                },
                {
                    "drug": "Thuốc chống trầm cảm ba vòng (TCA)",
                    "mechanism": "Cả hai đều có tác dụng kháng cholinergic, tác dụng cộng dồn.",
                    "effect": "Tăng tác dụng phụ kháng cholinergic: khô miệng, bí tiểu, lú lẫn",
                    "management": "Thận trọng khi dùng đồng thời. Theo dõi dấu hiệu kháng cholinergic quá mức."
                }
            ],
            "minor": [
                {
                    "drug": "Ketamine",
                    "mechanism": "Atropine có thể làm tăng nhịp tim, có thể tương tác với ketamine.",
                    "effect": "Tăng nhịp tim",
                    "management": "Theo dõi nhịp tim khi dùng đồng thời."
                }
            ]
        },
        "contraindications": {
        ...
        "pregnancy_lactation": {
            "fda_category": "C",
            "pregnancy_details": "Atropine là category C. Có thể đi qua nhau thai nhưng thường an toàn trong thai kỳ khi dùng với liều điều trị. Dùng được trong cấp cứu. Dùng liều thấp nhất hiệu quả.",
            "lactation": {
                "safety": "Compatible",
                "details": "Atropine bài tiết vào sữa mẹ ở nồng độ thấp. An toàn khi cho con bú với liều điều trị. Ít báo cáo về tác dụng phụ ở trẻ.",
        ...
        "hepatic_adjustment": {
            ...
            "notes": "Atropine chủ yếu thải trừ qua thận, không cần điều chỉnh liều ở suy gan."
        },
        "overdose_management": {
            "symptoms": [
                "Kháng cholinergic quá mức: khô miệng nặng, khô da, giảm tiết mồ hôi",
                "Giãn đồng tử, mờ mắt, tăng nhãn áp",
                "Nhịp tim nhanh, loạn nhịp tim",
                "Bí tiểu, táo bón",
                "Lú lẫn, ảo giác, co giật (hiếm)",
                "Sốt (do giảm tiết mồ hôi)",
                "Khó thở (do giảm tiết phế quản)"
            ],
            "antidote": "Physostigmine - chất ức chế cholinesterase, tăng acetylcholine, đối kháng atropine.",
            "treatment": [
                "Ngừng atropine ngay lập tức",
            ...
            "monitoring": "Nhịp tim, huyết áp, nhiệt độ, nhãn áp, ý thức, dấu hiệu kháng cholinergic. Theo dõi ít nhất 4-6 giờ (lâu hơn ở trẻ em)."
        },
        "reversal_agents": {
            "available": True,
            "agents": [
                {
                    "name": "Physostigmine",
                    "mechanism": "Physostigmine ức chế cholinesterase, tăng nồng độ acetylcholine, đối kháng tác dụng kháng cholinergic của atropine.",
                    "indication": "Quá liều atropine gây kháng cholinergic quá mức (lú lẫn, co giật, nhịp tim nhanh nặng)",
                    "dosage": "0.5-2mg IV chậm (có thể lặp lại sau 10-30 phút nếu cần). Thận trọng với liều cao (có thể gây cholinergic crisis).",
                    "notes": "Chỉ dùng khi có triệu chứng nặng. Thận trọng với liều cao physostigmine (có thể gây cholinergic crisis với các triệu chứng: tăng tiết, co thắt phế quản, chậm nhịp tim)."
                }
            ]
        },
        "administration_instructions": {
            "oral": {
                "with_food": "N/A - Không có dạng uống",
                "timing": "N/A"
            },
            "iv": {
                "reconstitution": "Pha với D5W hoặc Normal saline. Có thể dùng trực tiếp nếu đã pha sẵn.",
                "infusion_rate": "Tiêm IV bolus nhanh (trong cấp cứu). Không cần truyền chậm.",
                "compatibility": ["D5W", "Normal saline"],
                "incompatibility": ["Không trộn với các thuốc khác"],
                "notes": "QUAN TRỌNG: Liều tối thiểu người lớn 0.5mg để tránh nhịp tim chậm nghịch lý. Trong quá liều organophosphate: dùng liều cao hơn nhiều (2-5mg), có thể lặp lại nhiều lần."
            }
        },
        "references": {
            "primary_sources": [
