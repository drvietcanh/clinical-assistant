...
TETRACYCLINES_DRUGS = {
    "Doxycycline": {
        ...
        'interactions': ['Antacid/Sắt/Calcium: giảm hấp thu - cách 2 giờ', 'Warfarin: tăng tác dụng chống đông', 'Digoxin: tăng nồng độ digoxin', 'Phenytoin/Carbamazepine: giảm nồng độ doxycycline'],
    ...
    "Minocycline": {
        ...
        'interactions': ['Antacid/Sắt/Calcium: giảm hấp thu', 'Warfarin: tăng tác dụng chống đông', 'Digoxin: tăng nồng độ'],
        'pregnancy': 'D',
    ...
    "Tetracycline": {
        ...
        'interactions': ['Antacid/Sắt/Calcium: giảm hấp thu', 'Warfarin: tăng tác dụng chống đông', 'Digoxin: tăng nồng độ', 'Methoxyflurane: tăng độc thận'],
        'pregnancy': 'D - Chống chỉ định trong 3 tháng cuối',
    ...
    "Tigecycline": {
        ...
        'interactions': ['Warfarin: có thể tăng INR', 'Thuốc tránh thai đường uống: có thể giảm hiệu quả'],
        ...
        'hepatic_adjustment': {'mild': 'Không cần chỉnh liều.', 'moderate': 'Giảm liều khởi đầu 50%.', 'severe': 'CHỐNG CHỈ ĐỊNH hoặc giảm liều mạnh.'},
