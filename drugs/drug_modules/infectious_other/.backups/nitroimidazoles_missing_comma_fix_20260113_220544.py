...
NITROIMIDAZOLES_DRUGS = {
    "Metronidazole": {'group': 'Infectious Disease - Nitroimidazole Antibiotic',vietnamese_name': 'Metronidazole, Flagyl', 'administration': ['PO',
        'IV'],
        'indications': [
        'Giardia', 'Trichomonas',
        ...
        'C. difficile colitis'],
        'contraindications': [
        'Có thai (3 tháng đầu)', 'Dùng disulfiram trong 14 ngày'],
        'dosage': {
        ...
        'TRÁNH RƯỢU (phản ứng disulfiram-like). Uống với thức ăn'},renal_adjustment': {'normal': 'Không đổi', '30_60': 'Không đổi',
        ...
        'Phenytoin: tăng nồng độ phenytoin', 'Disulfiram: chống chỉ định'],pregnancy': 'B - D trong 3 tháng đầu', 'mechanism_of_action':
        ...
        , 'Pha trong NS, D5W, hoặc LR, truyền IV trong 30-60 phút'],pharmacokinetics': {'half_life':
        ...
        'Bệnh nhân đang dùng warfarin - tăng nguy cơ chảy máu',
        'Bệnh nhân đang dùng lithium - tăng nguy cơ độc tính lithium',
        'Nhiễm trùng do vi khuẩn hiếu khí - không hiệu quả']},reversal_agents': {'available': False, 'agents': [],notes':
        'Không có antidote đặc hiệu. Điều trị chủ yếu là hỗ trợ và điều trị triệu chứng. Ngừng thuốc ngay. Theo dõi dấu hiệu thần kinh và Disulfiram-like nếu uống rượu.'},pregnancy_lactation': {'fda_category': 'B (D trong 3 tháng đầu)',
        'pregnancy_details':
        ...
        'Triệu chứng dị ứng: Phát ban, phù mạch, sốc phản vệ (nếu dị ứng)'],antidote':
        ...
        'Không có antidote đặc hiệu. Điều trị chủ yếu là hỗ trợ và điều trị triệu chứng. Ngừng thuốc ngay. Theo dõi dấu hiệu thần kinh và Disulfiram-like nếu uống rượu.'},administration_instructions': {'oral': {
        'with_food':
        ...
        'IDSA Guidelines - Anaerobic Infections, C. difficile Infection'],last_updated': '2025-02-03', 'evidence_level':
