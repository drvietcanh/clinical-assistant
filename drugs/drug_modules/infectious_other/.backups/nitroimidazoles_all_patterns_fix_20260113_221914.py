...
NITROIMIDAZOLES_DRUGS = {
    "Metronidazole": {'group': 'Infectious Disease - Nitroimidazole Antibiotic',
        ...
        'Chủ yếu qua gan (60-80%), cần điều chỉnh ở suy gan nặng'},
        'storage':
        ...
        'Không có antidote đặc hiệu. Điều trị chủ yếu là hỗ trợ và điều trị triệu chứng. Ngừng thuốc ngay. Theo dõi dấu hiệu thần kinh và Disulfiram-like nếu uống rượu.'},
