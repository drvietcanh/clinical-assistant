...
"pregnancy": "B - Không có bằng chứng về nguy cơ ở người",
        ', 'vietnamese_name':
        'Amoxicillin suspension, Amoxicillin sirô', 'administration': ['PO'],indications': ['Nhiễm khuẩn đường hô hấp', 'Nhiễm khuẩn tai mũi họng',
        ...
        'Giảm bạch cầu (hiếm)'],interactions': [
        'Methotrexate: tăng độc tính', 'Allopurinol: tăng nguy cơ phát ban',
        'Thuốc tránh thai: có thể giảm hiệu quả'],mechanism_of_action':
        ...
        'Dùng đúng liều theo cân nặng ở trẻ em (tính theo mg/kg)'],pharmacokinetics': {'half_life': '1-1.5 giờ', 'onset':
        ...
        , 'Dị ứng beta-lactam', 'Sốc phản vệ với penicillin trước đây'],tương_đối': [
        ...
        'Suy thận nặng - giảm liều hoặc tăng khoảng cách',
        'Đang dùng methotrexate - tăng độc tính methotrexate',
        'Đang dùng allopurinol - tăng nguy cơ phát ban']},pregnancy_lactation': {'fda_category': 'B', 'pregnancy_details':
...
"pregnancy": "B - Không có bằng chứng về nguy cơ ở người",
        ...
        'notes':
        'Có dạng suspension cho trẻ em. Uống với thức ăn để giảm tiêu chảy'},renal_adjustment': {'normal': 'Không đổi', '30_60':
        'Giảm liều hoặc tăng khoảng cách', 'under_30':
        'Liều thấp hơn, khoảng cách dài hơn'},side_effects': [
        'Tiêu chảy (phổ biến)', 'Buồn nôn', 'Phát ban',
        'Viêm gan (hiếm nhưng nguy hiểm)', 'Nhiễm trùng nấm Candida'],interactions': ['Warfarin: tăng INR',
        'Methotrexate: tăng độc tính methotrexate',
        'Allopurinol: tăng nguy cơ phát ban',
        'Thuốc tránh thai: có thể giảm hiệu quả'],mechanism_of_action':
        ...
        'Dùng đúng liều và đủ thời gian để tránh kháng thuốc',
        'Không dùng cho nhiễm trùng do Pseudomonas hoặc Enterococcus kháng'],pharmacokinetics': {'half_life': '1 giờ (amoxicillin và clavulanate)',
        ...
        'Triệu chứng nghiêm trọng: Co giật, suy thận cấp, viêm gan nặng'],antidote':
        ...
        'Augmentin', 'Amoxicillin-clavulanate', 'Amoclav'],range': '8,000 - 40,000 VND/viên (tùy hàm lượng và thương hiệu)',
        'note':
