...
"pregnancy": "B - Không có bằng chứng về nguy cơ ở người",
        ', 'vietnamese_name':
        'Azithromycin, Zithromax', 'administration': ['PO', 'IV'],indications': ['Nhiễm trùng đường hô hấp trên (viêm họng, viêm xoang)',
        ...
        'Dị ứng azithromycin/macrolide', 'QT kéo dài', 'Rối loạn nhịp tim'],dosage': {'adult_respiratory':
