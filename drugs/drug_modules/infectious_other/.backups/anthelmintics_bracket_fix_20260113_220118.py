...
ANTHELMINTICS_DRUGS = {
                ...
                },
    {
        ...
        "reversal_agents": {
            "available": False,
            "agents": [],
            "notes": """Không có thuốc giải độc đặc hiệu. Điều trị quá liều chủ yếu là điều trị hỗ trợ: rửa dạ dày nếu sớm, than hoạt tính, theo dõi chức năng gan và công thức máu, điều trị triệu chứng.""",
        },
        ...
        "risk_flags": {
            ...
            "bleeding_risk": None,
            "organ_toxicity": {"hepatic": "Hepatotoxicity (especially with long-term use)", "hematologic": "Bone marrow suppression (leukopenia - especially long-term)", "teratogenic": "Teratogenicity (Category D)"},
            "qt_prolongation": False,
            "hepatotoxicity": True,
            "nephrotoxicity": False,
            "requires_monitoring": ["Black Box Warning - Pregnancy test (teratogenicity, Category D)", "Hepatic function (ALT, AST, bilirubin - critical for long-term use)", "CBC (leukopenia risk - especially long-term)", "Take with fatty meal (increases absorption 5-fold)", "Dexamethasone/praziquantel interactions (increases albendazole levels)"],
            "look_alike_sound_alike": ["Albendazole", "Mebendazole"]
        },
        "guideline_tags": [
    ...
    "Ivermectin":     {
        ...
        "contraindications": {
            ...
            "tương_đối": [
                "Trẻ <15kg",
                "Đồng nhiễm Loa loa (nguy cơ biến chứng thần kinh)"
    ],
        },
        "dosage": {
            "adult_strongyloides": "200 mcg/kg PO x 1, lặp lại sau 2 tuần nếu cần",
            "adult_onchocerciasis": "150 mcg/kg PO mỗi 3-12 tháng",
            "adult_scabies": "200 mcg/kg PO, lặp lại sau 7-14 ngày (off-label)",
            "notes": "Uống lúc bụng đói với nước; cân nặng để tính liều",
        },
        "renal_adjustment": {
            "normal": "Không đổi",
            "30_60": "Không đổi",
        ...
        "side_effects": [
            "Chóng mặt, mệt mỏi",
            "Buồn nôn, tiêu chảy",
            "Phản ứng Mazzotti (ngứa, ban, sốt) khi điều trị onchocerciasis"
    ],
        "interactions": [
            "Warfarin: tăng INR hiếm gặp",
            "Thuốc ức chế P-gp: thận trọng (nguy cơ độc thần kinh)"
    ],
        "pregnancy": "C - tránh nếu có thể",
        "mechanism_of_action": """Gắn kênh chloride glutamate-gated của ký sinh trùng, tăng dòng chloride, gây liệt và chết ký sinh trùng; không qua hàng máu não người nên an toàn với người.""",
        "monitoring": [
        ...
        "precautions": [
            ...
            "Tránh lái xe nếu chóng mặt/mệt",
            "Không dùng cho trẻ <15kg do thiếu dữ liệu"
    ],
        "pharmacokinetics": {
            "half_life": "12-36 giờ",
            "onset": "4-6 giờ",
            "duration": "Cao nhất trong 1-2 ngày",
            "protein_binding": "93%",
            "clearance": "Chuyển hóa gan (CYP3A4), thải trừ chủ yếu qua phân",
        },
        "storage": "Bảo quản nhiệt độ phòng, tránh ẩm",
    ...
    {
                    "drug": "Warfarin",
                    "mechanism": "Tăng INR chưa rõ cơ chế",
        ...
        "pregnancy_lactation": {
            "fda_category": "C",
            "pregnancy_details": "Tránh nếu có thể; dùng khi lợi ích vượt trội nguy cơ",
            "lactation": {
                "safety": "Thấp",
                "details": "Bài tiết ít vào sữa; WHO cho phép dùng liều đơn ở phụ nữ cho con bú >1 tuần tuổi",
        ...
        "hepatic_adjustment": {
            "mild": "Không đổi",
            "moderate": "Thận trọng",
            "severe": "Thiếu dữ liệu, thận trọng tối đa",
            "notes": "",
        },
        "overdose_management": {
            "symptoms": [
            ...
            "antidote": "Không có",
            "treatment": [
                "Hỗ trợ, than hoạt nếu sớm",
                "Theo dõi huyết áp, hô hấp",
        ...
        "reversal_agents": {
            "available": False,
            "agents": [],
            "notes": """Không có thuốc giải độc đặc hiệu. Điều trị quá liều chủ yếu là điều trị hỗ trợ, than hoạt nếu sớm, theo dõi huyết áp, hô hấp, và điều trị triệu chứng.""",
        },
        "administration_instructions": {
            "oral": {
                "with_food": "Uống lúc đói với nước (tăng hấp thu nhẹ)",
                "timing": "Uống 1 lần; lặp lại theo chỉ định",
                "notes": "Tính liều theo cân nặng, làm tròn theo viên 3mg/6mg nếu cần",
            },
        },
        "references": {
            "primary_sources": [
            ...
            "evidence_level": "High - WHO/CDC/UpToDate",
        },
        "risk_flags": {
            "high_alert": False,
            "narrow_therapeutic_index": False,
            ...
            "organ_toxicity": {"dermatologic": "Mazzotti reaction (itching, rash, fever - when treating onchocerciasis)", "neurological": "Neurological toxicity (rare, with P-gp inhibitors or Loa loa co-infection)"},
            "qt_prolongation": False,
            "hepatotoxicity": False,
            "nephrotoxicity": False,
            "requires_monitoring": ["Clinical symptoms and stool examination (for strongyloidiasis)", "Mazzotti reaction signs (itching, rash, fever - when treating onchocerciasis)", "PT/INR (if used with warfarin - bleeding risk)", "CBC and hepatic function (if multiple courses)", "Loa loa co-infection (neurological complications risk)"],
            "look_alike_sound_alike": ["Ivermectin", "Ivermectin"]
        },
        "guideline_tags": [
    ...
    "Levamisole":     {
        "group": "Infectious Disease - Anthelmintic",
        "vietnamese_name": "Levamisole",
        "administration": [
            "PO"
    ],
        "indications": [
            "Tẩy giun (giun đũa, giun móc) - ít dùng hiện nay"
    ],
        "contraindications": {
            "tuyệt_đối": [
                "Dị ứng levamisole",
            ...
            "tương_đối": [
                "Suy gan, suy thận - thận trọng"
    ],
        },
        "dosage": {
            "adult_roundworm": "150mg x 1 lần (đơn liều) sau ăn tối",
        ...
        "side_effects": [
            ...
            "Nhức đầu, chóng mặt",
            "Vị kim loại",
            "Giảm bạch cầu hạt hiếm nhưng nghiêm trọng"
    ],
        "interactions": [
            "Clozapine: tăng nguy cơ giảm bạch cầu hạt",
            "Warfarin: có thể tăng INR"
    ],
        "pregnancy": "C - tránh dùng",
        "mechanism_of_action": """Kích thích hạch thần kinh cơ của giun, gây liệt cơ và tống xuất giun; có tác dụng điều hòa miễn dịch nhẹ.""",
        "monitoring": [
        ...
        "pharmacokinetics": {
            ...
            "duration": "12-24 giờ",
            "protein_binding": "~20%",
            "clearance": "Chuyển hóa gan, thải trừ qua thận",
        },
        "storage": "Bảo quản nhiệt độ phòng, tránh ẩm",
        "black_box_warnings": None,
        "drug_interactions": {
    ...
    {
                    "drug": "Clozapine",
                    "mechanism": "Tăng nguy cơ giảm bạch cầu hạt",
                    "effect": "Tăng nguy cơ nhiễm trùng",
                    "management": "Tránh phối hợp",
                },
    {
                    "drug": "Warfarin",
                    "mechanism": "Chưa rõ, có thể tăng INR",
                    "effect": "Tăng nguy cơ chảy máu",
                    "management": "Theo dõi INR nếu phối hợp",
                }
                ],
            "minor": [],
        },
        ...
        "pregnancy_lactation": {
            "fda_category": "C",
            "pregnancy_details": "Tránh dùng; cân nhắc thuốc khác an toàn hơn",
            "lactation": {
                "safety": "Unknown",
                "details": "Không có dữ liệu; tránh dùng nếu có thể",
        ...
        "overdose_management": {
            ...
            "antidote": "Không có",
            "treatment": [
                "Điều trị hỗ trợ, than hoạt nếu sớm",
                "Theo dõi CBC, dấu hiệu nhiễm trùng"
    ],
            "monitoring": "",
        },
        "reversal_agents": {
            "available": False,
            "agents": [],
            "notes": """Không có thuốc giải độc đặc hiệu. Điều trị quá liều chủ yếu là điều trị hỗ trợ, than hoạt nếu sớm, theo dõi CBC và dấu hiệu nhiễm trùng.""",
        },
        "administration_instructions": {
            "oral": {
                "with_food": "Uống sau ăn tối để giảm kích ứng dạ dày",
                "timing": "Liều đơn",
        ...
        "references": {
            "primary_sources": [
                "WHO deworming guideline (historical use)",
                "UpToDate - Levamisole"
    ],
            "last_updated": "2025-02-06",
            "evidence_level": "Moderate - dữ liệu hạn chế hiện nay",
        },
        "risk_flags": {
            "high_alert": True,
            "narrow_therapeutic_index": False,
            "icu_critical_care_only": False,
            "bleeding_risk": "High (with warfarin)",
            "organ_toxicity": {"hematologic": "Agranulocytosis (rare but serious, contraindicated if history)", "teratogenic": "Teratogenicity (Category C)"},
            "qt_prolongation": False,
            "hepatotoxicity": False,
            "nephrotoxicity": False,
            "requires_monitoring": ["CBC (agranulocytosis risk - stop immediately if fever/sore throat)", "PT/INR (if used with warfarin - bleeding risk)", "Clinical response"],
            "look_alike_sound_alike": ["Levamisole", "Levetiracetam"]
        },
        "guideline_tags": [
            "WHO Guidelines - Soil-Transmitted Helminthiasis (historical use)",
            "WHO Essential Medicines List"
        ],
        "last_updated": "2025-02-18"
    },
...
"pregnancy": "D - Chống chỉ định",
        ...
        "reversal_agents": {
            "available": False,
            "agents": [],
            "notes": """Không có thuốc giải độc đặc hiệu. Điều trị quá liều chủ yếu là điều trị hỗ trợ: rửa dạ dày nếu sớm, than hoạt tính, điều trị triệu chứng, theo dõi công thức máu và chức năng gan nếu cần."""
        },
        "administration_instructions": {
            "oral": {
        ...
        "risk_flags": {
            ...
            "icu_critical_care_only": False,
            "bleeding_risk": None,
            "organ_toxicity": {"teratogenic": "Teratogenicity (Category D)", "hematologic": "Bone marrow suppression (with long-term/high-dose use)", "hepatic": "Hepatotoxicity (rare)"},
            "qt_prolongation": False,
            "hepatotoxicity": "Rare",
            "nephrotoxicity": False,
            "requires_monitoring": ["CBC (if long-term/high-dose use - bone marrow suppression risk)", "Hepatic function (if long-term/high-dose use - hepatotoxicity risk)", "Clinical response (stool exam after 2-3 weeks)"],
            "look_alike_sound_alike": ["Mebendazole", "Albendazole"]
        },
        "guideline_tags": [
            "FDA Black Box Warning - Teratogenicity (Category D)",
            "WHO Guidelines - Soil-Transmitted Helminthiasis",
            "WHO Essential Medicines List"
        ],
        "last_updated": "2025-02-18"
    },
    "Praziquantel": {
        "group": "Infectious Disease - Anthelmintic",
        "vietnamese_name": "Praziquantel",
        "administration": [
            "PO"
        ],
        "indications": [
                "Schistosomiasis (sán máng)",
                "Cestodes: Taenia spp., Diphyllobothrium",
        ...
        "contraindications": {
            "tuyệt_đối": [
                ...
                "Dùng rifampin đồng thời"
            ],
            "tương_đối": [
                "Suy gan (tăng nồng độ, thận trọng)"
            ]
        },
        "dosage": {
                "adult_schisto": "20mg/kg x 3 lần/ngày x 1 ngày (cách 4-6 giờ)",
        ...
        "renal_adjustment": {
            "normal": "Không đổi",
            "30_60": "Không đổi",
            "under_30": "Thận trọng do thiếu dữ liệu"
        },
        "side_effects": [
            ...
            "Co giật/loạn cảm hiếm gặp (neurocysticercosis)"
        ],
        "interactions": [
            "Rifampin: giảm mạnh nồng độ praziquantel (tránh phối hợp)",
            "Cimetidine, azole: tăng nồng độ praziquantel",
            "Phenytoin/carbamazepine: giảm nồng độ praziquantel"
        ],
        "pregnancy": "B - Tránh trong 3 tháng đầu, dùng được từ tam cá nguyệt 2-3 nếu cần",
        "mechanism_of_action": """Tăng tính thấm màng tế bào ký sinh trùng với ion Ca2+, gây co cứng cơ, liệt và chết ký sinh trùng; hiệu quả trên sán dây, sán lá, schistosoma.""",
        "monitoring": [
            "Triệu chứng lâm sàng, xét nghiệm phân/nước tiểu sau điều trị",
            "Chức năng gan nếu dùng liều cao/kéo dài",
            "Theo dõi thần kinh ở bệnh nhân neurocysticercosis"
        ],
        "precautions": [
            "Tránh dùng đồng thời rifampin (giảm nồng độ, thất bại điều trị)",
            "Thận trọng suy gan (tăng nồng độ)",
            "Có thể gây ngủ gà/chóng mặt: tránh lái xe 24 giờ",
            "Neurocysticercosis: dùng kèm corticosteroid để giảm phản ứng viêm",
            "Không nhai viên do vị rất đắng"
        ],
        "pharmacokinetics": {
            "half_life": "1-2.5 giờ",
            "onset": "1-3 giờ",
            "duration": "6-8 giờ",
            "protein_binding": "80%",
            "clearance": "Chuyển hóa gan (CYP3A4), thải trừ qua thận và mật"
        },
        "storage": "Bảo quản nhiệt độ phòng, tránh ẩm, tránh ánh sáng",
        "black_box_warnings": None,
        "drug_interactions": {
            "major": [
                {
                    "drug": "Rifampin",
                    "mechanism": "Cảm ứng CYP3A4 mạnh, giảm nồng độ praziquantel",
            ...
            "moderate": [
                {
                    "drug": "Cimetidine, Azole",
                    "mechanism": "Ức chế CYP3A4",
                    "effect": "Tăng nồng độ praziquantel",
                    "management": "Theo dõi tác dụng phụ"
                },
                {
                    "drug": "Phenytoin, Carbamazepine",
                    "mechanism": "Cảm ứng CYP",
                    "effect": "Giảm nồng độ praziquantel",
                    "management": "Cân nhắc tăng liều hoặc chọn thuốc khác"
                }
            ]
        },
        "contraindications_detail": {
        ...
        "pregnancy_lactation": {
            "fda_category": "B",
            "pregnancy_details": "Tránh tam cá nguyệt 1; có thể dùng tam cá nguyệt 2-3 nếu lợi ích vượt nguy cơ",
            "lactation": {
                "safety": "Compatible",
                "details": "Bài tiết ít vào sữa; có thể cho bú sau 72 giờ nếu muốn giảm phơi nhiễm",
                "recommendation": "Cân nhắc tạm ngừng cho bú 72 giờ sau liều cuối trong trường hợp liều cao"
            }
        },
        "hepatic_adjustment": {
            "mild": "Không đổi, nhưng theo dõi",
            "moderate": "Thận trọng, có thể cần giảm liều",
            "severe": "Tránh hoặc dùng dưới giám sát chặt"
        },
        "overdose_management": {
            "symptoms": [
                "Chóng mặt, buồn ngủ",
                "Buồn nôn, nôn",
                "Loạn cảm, ảo giác hiếm"
            ],
            "antidote": "Không có",
            "treatment": [
                "Hỗ trợ, than hoạt nếu sớm",
                "Theo dõi huyết động, thần kinh"
            ]
        },
        "reversal_agents": {
            "available": False,
        ...
        "administration_instructions": {
            "oral": {
                ...
                "timing": "Chia liều cách nhau 4-6 giờ trong ngày điều trị",
                "notes": "Nuốt nguyên viên, không nhai do vị rất đắng"
            }
        },
        "references": {
            "primary_sources": [
                "WHO schistosomiasis treatment guideline",
                "UpToDate - Praziquantel",
                "FDA label"
            ],
            "last_updated": "2025-02-06",
        ...
        "risk_flags": {
            ...
            "icu_critical_care_only": False,
            "bleeding_risk": None,
            "organ_toxicity": {"hepatic": "Transient liver enzyme elevation", "neurological": "Seizures/parasthesia (rare, neurocysticercosis)"},
            "qt_prolongation": False,
            "hepatotoxicity": "Transient",
            "nephrotoxicity": False,
            "requires_monitoring": ["Hepatic function (if high-dose/prolonged use - transient elevation)", "Neurological status (if neurocysticercosis - seizures risk)", "Clinical response (stool/urine exam after treatment)", "CYP3A4 interactions (rifampin contraindicated, cimetidine/azole increase levels)"],
            "look_alike_sound_alike": ["Praziquantel", "Prazosin"]
        },
        "guideline_tags": [
            "WHO Guidelines - Schistosomiasis Treatment",
            "WHO Essential Medicines List"
        ],
        "last_updated": "2025-02-18"
    }
