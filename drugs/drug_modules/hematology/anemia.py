...
ANEMIA_DRUGS = {
    ...
    "Iron Sucrose":     {
        ...
        "storage": "",
        "black_box_warnings": "Phản ứng quá mẫn có thể xảy ra (hiếm). Truyền chậm để giảm nguy cơ.",
        "risk_flags": {
            "high_alert": True,
            "narrow_therapeutic_index": False,
            "bleeding_risk": False,
            "organ_toxicity": ["cardiovascular", "immunologic"],
            "qt_prolongation": False,
            "hepatotoxicity": False,
            "nephrotoxicity": False,
            "requires_monitoring": ["Blood pressure during infusion (hypotension risk)", "Signs of hypersensitivity reaction", "Hemoglobin", "Ferritin"]
        },
        "guideline_tags": [
    ...
    "Erythropoietin (EPO)":     {
        ...
        "risk_flags": {
            ...
            "hepatotoxicity": False,
            "nephrotoxicity": False,
            "requires_monitoring": ["Hemoglobin (CRITICAL - target 10-12 g/dL, avoid >12 g/dL - Black Box Warning)", "Blood pressure (hypertension common)", "Ferritin, TSAT (iron stores)", "Signs of thrombosis (Black Box Warning)", "Tumor progression (cancer patients - Black Box Warning)"]
        },
        "guideline_tags": [
            "FDA Black Box Warning - Increased Mortality/Cardiovascular Events (Hb >12 g/dL)",
            "FDA Black Box Warning - Tumor Progression (cancer patients)",
            "KDIGO Guidelines - Anemia in CKD",
