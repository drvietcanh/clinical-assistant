...
LOCAL_ANESTHETICS = {
    ...
    "Bupivacaine": {
        ...
        "brand_names": {
            "common": ["Marcaine", "Sensorcaine"],
            "vietnam": ["Bupivacaine", "Marcaine"]
        },
        "administration": ["Injection (Infiltration, Epidural, Spinal, Nerve block)"],
        "indications": [
    ...
    "Levobupivacaine": {
        ...
        "brand_names": {
            "common": ["Chirocaine"],
            "vietnam": ["Levobupivacaine", "Chirocaine"]
        },
        "administration": ["Injection"],
        "indications": ["Tương tự Bupivacaine nhưng ít độc tính trên tim và thần kinh hơn."],
        "dosage": {
