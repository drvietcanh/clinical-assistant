...
ANALGESIC_ANTIPYRETIC_NSAID_DRUGS = {
    "Ibuprofen": {'group': 'Analgesic/Antipyretic/NSAID',vietnamese_name':
        'Ibuprofen, Brufen, Advil', 'administration': ['PO', 'IV'],indications': ['Sốt', 'Đau nhẹ đến trung bình', 'Viêm khớp',
        'Đau bụng kinh', 'Đau đầu'],contraindications': [
        ...
        'Phát ban'],interactions': [
        'Warfarin: tăng nguy cơ chảy máu', 'Lithium: tăng nồng độ lithium',
        'Methotrexate: tăng độc tính', 'ACE inhibitors: giảm hiệu quả'],pregnancy': 'C - Tránh dùng trong 3 tháng cuối (D)',
        'mechanism_of_action':
        ...
        'Không dùng quá 10 ngày cho đau hoặc sốt mà không có chỉ định rõ ràng'],pharmacokinetics': {'half_life': '2-4 giờ', 'onset':
