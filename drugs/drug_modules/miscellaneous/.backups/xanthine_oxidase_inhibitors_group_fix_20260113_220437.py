...
XANTHINE_OXIDASE_INHIBITORS_DRUGS = {
    "Allopurinol": {'group': 'Metabolism - Xanthine Oxidase Inhibitor',vietnamese_name':
        ...
        'Hóa trị (phòng ngừa tăng acid uric)'],contraindications': [
        ...
        'Warfarin: tăng tác dụng chống đông'],mechanism_of_action':
        ...
        'Uống với nhiều nước để tránh sỏi thận'],pharmacokinetics': {
        'half_life':
        ...
        'Phản ứng da nghiêm trọng trước đây với allopurinol (SJS, TEN)'],tương_đối': ['Suy thận (giảm liều theo CrCl)',
        ...
        'Suy gan (thận trọng, theo dõi chức năng gan)',
        'Đang dùng azathioprine/6-mercaptopurine (cần giảm liều 75%)',
        'Đang dùng ampicillin/amoxicillin (tăng nguy cơ ban da)']},renal_adjustment': {
        ...
        , 'recommendation':
        'KHÔNG dùng khi cho con bú. Ngừng cho con bú hoặc ngừng allopurinol.'}},hepatic_adjustment': {'mild':
        ...
        'Nếu SJS/TEN: điều trị tại ICU, có thể cần corticosteroid, IVIG'],monitoring':
