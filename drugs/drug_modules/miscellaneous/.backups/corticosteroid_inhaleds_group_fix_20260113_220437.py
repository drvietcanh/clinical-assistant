...
CORTICOSTEROID_INHALED_DRUGS = {
    "Budesonide": {'group': 'Respiratory - Corticosteroid (Inhaled)',vietnamese_name':
        'Budesonide inhaled, Pulmicort', 'administration': ['INH', 'NEB'],indications': ['Hen phế quản (duy trì)', 'COPD', 'Viêm mũi dị ứng',
        'Hen phế quản (Trẻ em)'],contraindications': [
        ...
        'Ho', 'Kích ứng họng', 'Tác dụng toàn thân (hiếm với liều thường)'],interactions': ['Ketoconazole/Itraconazole: tăng nồng độ budesonide',
        'Ritonavir: tăng nồng độ budesonide'],mechanism_of_action':
        ...
        'Đang dùng ritonavir - tăng nguy cơ ức chế HPA']},pregnancy_lactation': {'fda_category': 'C', 'pregnancy_details':
        ...
        , 'recommendation':
        'Có thể dùng khi cho con bú. Dùng liều thấp nhất hiệu quả.'}},hepatic_adjustment': {'mild':
        ...
        'Theo dõi chức năng thượng thận nếu có dấu hiệu ức chế HPA'],monitoring':
        'Đường huyết, huyết áp, dấu hiệu ức chế HPA, dấu hiệu nhiễm trùng, nấm miệng'
        },reversal_agents': {'available': False, 'agents': [],notes':
        'Không có antidote đặc hiệu. Điều trị chủ yếu là hỗ trợ và điều trị triệu chứng. Ngừng thuốc ngay hoặc giảm liều đáng kể. Có thể cần bổ sung corticosteroid nếu có suy thượng thận.'},administration_instructions': {'oral': {'with_food': 'N/A - dạng hít',
        'timing': 'N/A - dạng hít'},iv': {'reconstitution':
        'N/A - chỉ có dạng hít', 'infusion_rate': 'N/A', 'compatibility': [],incompatibility': [],notes':
        ...
        , 'after_use':
        'Súc miệng và súc họng sau khi dùng. Rửa sạch thiết bị nebulizer.'}},references': {'primary_sources': [
        'FDA Drug Label - Budesonide (Pulmicort)',
        'UpToDate - Budesonide: Drug Information',
        "Goodman & Gilman's The Pharmacological Basis of Therapeutics (14th ed)"
        ],evidence_level': 'A - Dựa trên FDA drug labels và dữ liệu lâm sàng'},risk_flags': {
            'high_alert': False,
