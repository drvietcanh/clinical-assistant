...
GOUT_MEDICATIONS_DRUGS = {
    ...
    "Febuxostat": {
        ...
        "pregnancy": "C - Nguy cơ không thể loại trừ. Không khuyến nghị trong thai kỳ""mechanism_of_action": "Febuxostat là xanthine oxidase inhibitor không purine, ức chế enzyme xanthine oxidase (cả dạng oxy hóa và khử), ngăn chặn sự chuyển đổi hypoxanthine thành xanthine và xanthine thành acid uric. Khác với allopurinol (purine analog), febuxostat không phải purine analog nên ít tương tác với các enzyme khác. Febuxostat có hiệu quả mạnh hơn allopurinol trong việc giảm acid uric máu và có thể dùng ở bệnh nhân suy thận mà không cần điều chỉnh liều. Tuy nhiên, febuxostat có thể tăng nguy cơ tim mạch so với allopurinol.",
        "monitoring": [
