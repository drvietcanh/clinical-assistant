...
BETA_2_AGONIST_SHORT_ACTING_DRUGS = {
    "Salbutamol": {'group': 'Respiratory - Beta-2 Agonist (Short-acting)',vietnamese_name':
        ...
        'Có dạng syrup và nebulizer cho trẻ em. Dùng khi cần cho cơn cấp'},renal_adjustment': {'normal': 'Không đổi', '30_60': 'Không đổi',
        'under_30': 'Không đổi'},side_effects': ['Run tay (phổ biến)',
        'Tim đập nhanh', 'Đánh trống ngực', 'Đau đầu', 'Chóng mặt',
        'Hạ kali máu (với liều cao)', 'Kích động'],interactions': [
        'Beta-blockers: đối kháng tác dụng',
        'Digoxin: có thể tăng nguy cơ loạn nhịp',
        'Diuretics: tăng nguy cơ hạ kali máu', 'MAOIs: thận trọng'],pregnancy': 'C - An toàn', 'mechanism_of_action':
        ...
        'Dùng liều cao có thể gây hạ kali máu - thận trọng với diuretics'],pharmacokinetics': {'half_life':
        ...
        'Cường giáp không điều trị (tăng nhạy cảm với catecholamine)'],tương_đối': [
        ...
        'Dùng với MAOIs - tăng tác dụng tim mạch']},pregnancy_lactation': {
        ...
        , 'Hỗ trợ hô hấp: Thở oxy, nếu cần hỗ trợ thông khí cơ học'],monitoring':
