...
ANALGESIC_ANTIPYRETIC_DRUGS = {
    "Paracetamol": {'group': 'Analgesic/Antipyretic',vietnamese_name':
        ...
        , 'Đường huyết (hạ đường huyết có thể xảy ra trong quá liều)'],precautions': [
        ...
        'management': 'Thận trọng, giảm liều paracetamol'}],minor': [{'drug':
        ...
        'Quá liều paracetamol (đang trong quá trình điều trị)'],tương_đối': [
        ...
        'Thiếu hụt G6PD (hiếm gây thiếu máu tan máu)']},pregnancy_lactation':
        ...
        , 'Giai đoạn 4 (4-14 ngày): Hồi phục (nếu sống sót) hoặc tử vong'],antidote':
        ...
        'NS', 'LR'],incompatibility': ['Không pha trộn với các thuốc khác'],notes':
        ...
        ],evidence_level': 'High - RCTs và guidelines dựa trên chứng cứ'},risk_flags': {
            'high_alert': True,
