...
ANTIDOTES = {
    "Acetylcysteine": {
        ...
        "brand_names": {
            "common": ["Acetadote", "Mucomyst"],
            "vietnam": ["Acetylcysteine", "Mitux", "Acemuc (dạng uống)"]
        },
        "administration": ["IV (Truyền tĩnh mạch)", "PO (Uống)"],
        "indications": [
        ...
        "monitoring": ["Men gan (ALT/AST)", "PT/INR", "Dấu hiệu phản vệ"]
    },
    ...
    "Atropine": {
        ...
        "monitoring": ["Nhịp tim", "Nghe phổi (Ran ẩm)", "Đồng tử"]
    },
    ...
    "Pralidoxime": {
        ...
        "brand_names": {
            "common": ["Protopam"],
            "vietnam": ["Pralidoxime", "PAM"]
        },
        "administration": ["IV (Truyền tĩnh mạch chậm)"],
        "indications": [
    ...
    "Vitamin K1": {
        ...
        "brand_names": {
            "common": ["Mephyton"],
            "vietnam": ["Vitamin K1", "Vinphytton"]
        },
        "administration": ["IV (Rất chậm)", "PO", "SC (Ít dùng)"],
        "indications": [
        ...
        "side_effects": ["Phản vệ (IV nhanh)", "Đau tại chỗ tiêm"],
        "monitoring": ["INR (thường xuyên)"]
    },
    ...
    "Ethanol": {
        ...
        "brand_names": {
             "vietnam": ["Rượu trắng (nếu cấp cứu không có Ethanol y tế)", "Ethanol 20% pha chế"]
        },
        "administration": ["PO (Uống/SND)", "IV (ít có chế phẩm sẵn)"],
        "indications": ["Ngộ độc Methanol (Cồn công nghiệp) hoặc Ethylene Glycol"],
        "dosage": {
        ...
        "monitoring": ["Nồng độ Ethanol máu", "Khí máu (Toan chuyển hóa)", "Khoảng trống Anion/Osmol"]
    }
}
