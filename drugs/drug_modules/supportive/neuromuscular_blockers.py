...
NEUROMUSCULAR_BLOCKERS_DRUGS = {
            ...
            "major": [
    {
        ...
        "contraindications_detail": {
            "tuyệt_đối": [
                "Dị ứng benzylisoquinolinium NMBA."
    ],
            "tương_đối": [
                "Tiền sử phản vệ NMBA, hạ thân nhiệt (kéo dài tác dụng)."
    ],
        },
        "pregnancy_lactation": {
            "fda_category": "B/C",
            ...
            "major": [
    {
        ...
        "contraindications_detail": {
            "tuyệt_đối": [
                "Dị ứng NMBA aminosteroid."
    ],
            "tương_đối": [
                "Nhược cơ, suy gan, suy thận, béo phì (tính liều theo cân nặng điều chỉnh)."
    ],
        },
        "pregnancy_lactation": {
            "fda_category": "C",
    ...
    "Succinylcholine":     {
        ...
        "mechanism_of_action": """Chủ vận nicotinic gây khử cực kéo dài tại bản vận động, dẫn đến giãn cơ ngắn; bị thủy phân bởi pseudocholinesterase huyết tương.""",
        "monitoring": [
        ...
        "black_box_warnings": """Nguy cơ tăng K+ gây ngừng tim ở trẻ có bệnh cơ ẩn; chỉ dùng cho cấp cứu khi cân nhắc lợi ích/nguy cơ.""",
        "drug_interactions": {
            "major": [
    {
            ...
            "moderate": [
    {
        ...
        "overdose_management": {
            "symptoms": [
                "Liệt cơ kéo dài, ngừng thở, loạn nhịp do tăng K+."
    ],
            ...
            "major": [
    {
        ...
        "contraindications_detail": {
            ...
            "tương_đối": [
                "Suy gan/thận, nhược cơ, béo phì (điều chỉnh liều)."
    ],
        },
        "pregnancy_lactation": {
            "fda_category": "C",
