...
VITAMIN_B12S_DRUGS = {
    "Vitamin B12": {'group': 'Vitamins/Supplements - Vitamin B12',
        'vietnamese_name':
        ...
        'IM cho thiếu máu nặng. PO cho thiếu nhẹ hoặc dự phòng'},
        'renal_adjustment': {'normal': 'Không đổi', '30_60': 'Không đổi',
        'under_30': 'Không đổi'},
        'side_effects': ['Phản ứng tại chỗ tiêm (IM)',
        ...
        'pharmacokinetics': {'half_life': '6 ngày (dự trữ trong gan)', 'onset':
        ...
        'Dự trữ trong gan, thải trừ qua mật và nước tiểu'},
        'storage':
        ...
        'contraindications': {'tuyệt_đối': ['Dị ứng vitamin B12 hoặc cobalt',
        "Leber's disease (thoái hóa thần kinh thị giác di truyền) - B12 có thể làm nặng bệnh"
        ],
        'tương_đối': [
        'Thiếu B12 do thiếu intrinsic factor (pernicious anemia) - cần dùng IM, không dùng PO'
        ...
        'injection_rate': 'Tiêm chậm, đều', 'notes':
        'SC có thể dùng thay cho IM. Tiêm dưới da, xoay vị trí tiêm.'},
        'iv': {
        'reconstitution': 'Không khuyến cáo dùng IV thường quy',
        'infusion_rate': 'N/A', 'compatibility': ['N/A'],
        'incompatibility': [
        'N/A'],
        'notes':
