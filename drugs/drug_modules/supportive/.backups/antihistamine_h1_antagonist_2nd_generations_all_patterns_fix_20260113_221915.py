...
ANTIHISTAMINE_H1_ANTAGONIST_2ND_GENERATIONS_DRUGS = {
    "Cetirizine": {'group': 'Allergy - Antihistamine (H1 Antagonist, 2nd generation)',
        ...
        'pharmacokinetics': {'half_life': '8-10 giờ', 'onset': '1 giờ',
        ...
        'Điều trị hỗ trợ: truyền dịch nếu cần', 'Theo dõi ít nhất 4-6 giờ'],
        'monitoring': 'Ý thức, huyết áp, nhịp tim'},reversal_agents': {
    ...
    "Desloratadine": {'group': 'Allergy - Antihistamine (H1 Antagonist, 2nd generation)',
        ...
        'Thận trọng. Thường không cần điều chỉnh liều.'}]},
        'contraindications':
        {'tuyệt_đối': ['Dị ứng desloratadine hoặc loratadine'],
        'tương_đối': [
        ...
        'monitoring': 'Dấu hiệu sinh tồn, mức độ ý thức, dấu hiệu buồn ngủ'},reversal_agents': {'available': False, 'agents': [],notes':
    ...
    "Fexofenadine": {'group': 'Allergy - Antihistamine (H1 Antagonist, 2nd generation)',
        ...
        'pharmacokinetics': {'half_life': '14.4 giờ', 'onset': '1-2 giờ',
        ...
        , 'black_box_warnings': None, 'drug_interactions': {'major': [],
        'moderate': [{'drug': 'Fruit juices (apple, orange, grapefruit)',
        ...
        'Giảm nồng độ fexofenadine, giảm hiệu quả', 'management':
        'Cách xa ít nhất 2 giờ. Uống với nước lọc.'}],
        'minor': []},
        'contraindications': {'tuyệt_đối': [
    ...
    "Levocetirizine": {'group': 'Allergy - Antihistamine (H1 Antagonist, 2nd generation)',
        ...
        'interactions': ['Ít tương tác', 'Alcohol: có thể tăng buồn ngủ'],
        ...
        '91%', 'clearance':
        'Thận (thải trừ chủ yếu - 85%), gan (chuyển hóa - 15%)'},
        'storage':
        'Bảo quản ở nhiệt độ phòng (15-30°C), tránh ẩm', 'black_box_warnings':
        ...
        'Tránh rượu khi dùng levocetirizine.'}],
        'minor': []},
        'contraindications': {'tuyệt_đối': [
        'Dị ứng levocetirizine hoặc cetirizine',
        'Suy thận nặng (CrCl <10) - chống chỉ định'],
        ...
        , 'recommendation':
        'Có thể dùng khi cho con bú. An toàn cho trẻ bú mẹ.'}},
        'hepatic_adjustment': {'mild':
        ...
        'Hỗ trợ hô hấp nếu cần', 'Theo dõi trong 24-48 giờ'],
        'monitoring':
    ...
    "Loratadine": {'group': 'Allergy - Antihistamine (H1 Antagonist, 2nd generation)',
        ...
        'Bảo quản ở nhiệt độ phòng (15-30°C), tránh ẩm, tránh ánh sáng. Viên nén: bảo quản trong bao bì kín. Dạng syrup: bảo quản ở nhiệt độ phòng, đậy kín sau khi dùng.'
        , 'black_box_warnings': None, 'drug_interactions': {'major': [],
        'moderate': [{'drug': 'Erythromycin, Ketoconazole, Itraconazole',
