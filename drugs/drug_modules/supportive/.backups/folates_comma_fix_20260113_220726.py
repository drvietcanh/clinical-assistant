...
FOLATES_DRUGS = {
    "Folic acid": {
        'group': 'Vitamins/Supplements - Folate',vietnamese_name': 'Folic acid, Folate, Vitamin B9',
        'administration': ['PO'],
        'indications': [
            'Thiếu acid folic',
        ...
        'contraindications_detail': {
            ...
            'available': False,
            'agents': [],notes': 'Không có antidote đặc hiệu. Điều trị chủ yếu là hỗ trợ và điều trị triệu chứng. Ngừng thuốc ngay nếu có phản ứng dị ứng nghiêm trọng.'
            ...
            'oral': {
                ...
                'compatibility': ['N/A'],incompatibility': ['N/A'],notes': 'Folic acid chủ yếu dùng đường uống. IV chỉ dùng trong trường hợp đặc biệt.'
            }
        },references': {
            'primary_sources': [
            ...
            'bleeding_risk': False,
            'organ_toxicity': ['May mask vitamin B12 deficiency (high doses >1mg/day)'],qt_prolongation': False,
