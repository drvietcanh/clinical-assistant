...
VITAMIN_DS_DRUGS = {
    "Vitamin D": {'group': 'Vitamins/Supplements - Vitamin D',vietnamese_name':
        ...
        'administration': ['PO'],indications': ['Còi xương', 'Loãng xương (kết hợp với calcium)',
        ...
        'Quá liều vitamin D'],dosage': {'adult_deficiency':
        ...
        'Dùng calcitriol (dạng hoạt hóa) thay vì vitamin D thường'},side_effects': ['Tăng calci máu (quá liều)', 'Tăng calci niệu',
        'Sỏi thận', 'Buồn nôn, nôn (liều cao)', 'Táo bón'],interactions': [
        'Calcium: tăng hấp thu calcium',
        'Thiazide diuretics: tăng nguy cơ tăng calci máu',
        'Corticosteroid: giảm hấp thu vitamin D',
        'Cholestyramine: giảm hấp thu vitamin D'],pregnancy':
        ...
        'Bệnh sarcoidosis - tăng nhạy cảm với vitamin D, tăng nguy cơ tăng calci máu'
        'Bệnh cường cận giáp (hyperparathyroidism) - có thể làm nặng tăng calci máu'
        , 'Dùng thiazide diuretics - tăng nguy cơ tăng calci máu']},pregnancy_lactation': {'fda_category': 'A', 'pregnancy_details':
        ...
        'Theo dõi ít nhất 1-2 tuần sau khi ngừng vitamin D (do tích lũy)'],monitoring':
