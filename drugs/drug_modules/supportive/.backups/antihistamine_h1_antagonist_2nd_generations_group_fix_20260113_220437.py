...
ANTIHISTAMINE_H1_ANTAGONIST_2ND_GENERATIONS_DRUGS = {
    "Cetirizine": {'group': 'Allergy - Antihistamine (H1 Antagonist, 2nd generation)',vietnamese_name': 'Cetirizine, Zyrtec', 'administration': ['PO'],indications': ['Dị ứng (allergic rhinitis)', 'Mề đay (urticaria)',
        ...
        'Không đổi', '30_60': '5mg x 1 lần/ngày', 'under_30': '5mg cách ngày'},side_effects': ['Buồn ngủ (ít, 10-15% người)', 'Khô miệng', 'Nhức đầu',
    ...
    "Desloratadine": {'group': 'Allergy - Antihistamine (H1 Antagonist, 2nd generation)',vietnamese_name': 'Desloratadine, Aerius', 'administration': ['PO'],indications': ['Dị ứng (allergic rhinitis)', 'Mề đay (urticaria)',
        'Dị ứng da'],contraindications': ['Dị ứng'],dosage': {
        'adult_standard': '5mg x 1 lần/ngày', 'adult_max': '5mg x 2 lần/ngày',
        'pediatric': '2.5mg x 1 lần/ngày (6-11 tuổi)', 'notes':
        'Là metabolite của loratadine, mạnh hơn và tác dụng dài hơn'},side_effects': ['Buồn ngủ (rất hiếm)', 'Khô miệng', 'Nhức đầu',
        'Ít tác dụng phụ'],interactions': ['Ít tương tác'],mechanism_of_action':
    ...
    "Fexofenadine": {'group': 'Allergy - Antihistamine (H1 Antagonist, 2nd generation)',vietnamese_name': 'Fexofenadine, Allegra', 'administration': ['PO'],indications': ['Dị ứng (allergic rhinitis)', 'Mề đay (urticaria)',
        'Dị ứng da'],contraindications': ['Dị ứng'],dosage': {
        ...
        'Non-sedating, ít buồn ngủ nhất'},side_effects': [
    ...
    "Levocetirizine": {'group': 'Allergy - Antihistamine (H1 Antagonist, 2nd generation)',vietnamese_name': 'Levocetirizine, Xyzal', 'administration': ['PO'],indications': ['Dị ứng (allergic rhinitis)', 'Mề đay (urticaria)',
        ...
        'notes': 'Là R-enantiomer của cetirizine, mạnh hơn cetirizine'},renal_adjustment': {'normal': 'Không đổi', '30_60': '5mg cách ngày',
        'under_30': '5mg mỗi 3 ngày'},side_effects': [
        'Buồn ngủ (ít hơn cetirizine)', 'Nhức đầu', 'Mệt mỏi', 'Khô miệng'],interactions': ['Ít tương tác', 'Alcohol: có thể tăng buồn ngủ'],pregnancy': 'B', 'mechanism_of_action':
    ...
    "Loratadine": {'group': 'Allergy - Antihistamine (H1 Antagonist, 2nd generation)',vietnamese_name': 'Loratadine, Clarityne', 'administration': ['PO'],indications': ['Dị ứng (allergic rhinitis)', 'Mề đay (urticaria)',
        'Dị ứng thức ăn', 'Dị ứng da'],contraindications': ['Dị ứng'],dosage': {'adult_standard': '10mg x 1 lần/ngày', 'adult_max':
        '10mg x 2 lần/ngày', 'pediatric': '5mg x 1 lần/ngày (2-12 tuổi)',
        'notes': 'Non-sedating, ít tác dụng phụ'},side_effects': [
        'Buồn ngủ (ít hơn 1st generation)', 'Khô miệng (hiếm)',
        'Nhức đầu (hiếm)', 'Ít tác dụng phụ hơn antihistamine 1st generation'],interactions': ['Ít tương tác',
