...
CALCIUMS_DRUGS = {
    "Calcium": {'group': 'Vitamins/Supplements - Calcium',vietnamese_name':
        'Calcium, Calcium carbonate, Calcium citrate', 'administration': ['PO'],indications': ['Thiếu calci', 'Loãng xương (kết hợp với vitamin D)',
        'Hạ calci máu', 'Dự phòng loãng xương', 'Có thai, cho con bú'],contraindications': ['Tăng calci máu', 'Tăng calci niệu',
        'Sỏi thận calci', 'Suy thận nặng', 'Suy tim (calcium carbonate)'],dosage': {'adult_daily_requirement':
        ...
        'Tránh dùng hoặc giảm liều (tăng nguy cơ tăng calci máu)'},side_effects': ['Táo bón', 'Đầy hơi', 'Buồn nôn',
        ...
        'Vitamin D: tăng hấp thu calci'],mechanism_of_action':
        ...
        'Sỏi thận (siêu âm) nếu có triệu chứng hoặc dùng liều cao'],precautions': ['Uống với thức ăn để tăng hấp thu và giảm tác dụng phụ',
        ...
        'Theo dõi triệu chứng tăng calci máu: buồn nôn, nôn, táo bón, yếu cơ'],pharmacokinetics': {'half_life':
        ...
        'Bệnh cường cận giáp (hyperparathyroidism) - có thể làm nặng tăng calci máu'
        , 'Dùng thiazide diuretics - tăng nguy cơ tăng calci máu',
        'Suy tim - calcium carbonate có thể gây đầy hơi, táo bón']},pregnancy_lactation': {'fda_category': 'A', 'pregnancy_details':
        ...
        , 'compatibility': ['Normal saline (0.9% NaCl), D5W'],incompatibility': [
