...
ANTIHISTAMINE_H1_ANTAGONIST_1ST_GENERATIONS_DRUGS = {
    "Chlorpheniramine": {
        'group': 'Allergy - Antihistamine (H1 Antagonist, 1st generation)',vietnamese_name': 'Chlorpheniramine, Chlor-Trimeton',
        ...
        'drug_interactions': {
            ...
            'oral': {
                ...
                'compatibility': ['NS', 'D5W'],incompatibility': [],notes': 'Dùng cho phản ứng dị ứng cấp tính. Theo dõi huyết áp.'
            },im': {
            ...
            'bleeding_risk': False,
            'organ_toxicity': ['CNS depression (sedation, drowsiness)', 'Anticholinergic effects (dry mouth, blurred vision, urinary retention)'],qt_prolongation': False,
    ...
    "Diphenhydramine": {
        'group': 'Allergy - Antihistamine (H1 Antagonist, 1st generation)',vietnamese_name': 'Diphenhydramine, Benadryl',
        'administration': ['PO', 'IV', 'IM'],indications': [
            'Dị ứng (allergic rhinitis)',
            'Mề đay (urticaria)',
            'Dị ứng da',
        ...
        'drug_interactions': {
            ...
            'oral': {
                ...
                'compatibility': ['NS', 'D5W'],incompatibility': [],notes': 'Dùng cho phản ứng dị ứng cấp tính. Theo dõi huyết áp trong khi tiêm.'
            },im': {
                'reconstitution': 'Dùng trực tiếp từ lọ',
                'injection_site': 'Tiêm bắp sâu',
                'notes': 'Dùng cho phản ứng dị ứng cấp tính nếu không có đường IV.'
    ...
    "Hydroxyzine": {
        'group': 'Allergy - Antihistamine (H1 Antagonist, 1st generation)',vietnamese_name': 'Hydroxyzine, Atarax, Vistaril',
