...
MIGRAINE_TRIPTANS = {
    "Sumatriptan": {
        ...
        "brand_names": {
            "common": ["Imitrex", "Imigran"],
            "vietnam": ["Sumatriptan", "Imigran", "Sumagran"]
        },
        "administration": ["PO", "SC", "Nasal Spray"],
        "indications": [
        ...
        "monitoring": ["Huyết áp", "Dấu hiệu thiếu máu cơ tim (nếu có nguy cơ cao)"]
    },
    ...
    "Rizatriptan": {
        ...
        "brand_names": {
             "common": ["Maxalt", "Maxalt-MLT"],
             "vietnam": ["Rizatriptan", "Maxalt"]
        },
        "administration": ["PO", "ODT (Viên phân tán)"],
        "indications": ["Migraine cấp tính"],
        "dosage": {
        ...
        "side_effects": ["Buồn ngủ, chóng mặt", "Khô miệng"],
        "pregnancy_lactation": {
            "pregnancy_details": "Kém an toàn hơn Sumatriptan (ít dữ liệu hơn).",
            "lactation": "Thận trọng."
        }
    },
    ...
    "Zolmitriptan": {
        ...
        "brand_names": {
             "common": ["Zomig"],
             "vietnam": ["Zolmitriptan", "Zomig"]
        },
        "administration": ["PO", "Nasal Spray"],
        "indications": ["Migraine cấp tính", "Cluster Headache (Nasal Spray - ít dùng hơn Sumatriptan SC)"],
        "dosage": {
