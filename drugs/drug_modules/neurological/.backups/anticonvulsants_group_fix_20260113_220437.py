...
ANTICONVULSANTS_DRUGS = {
    "Carbamazepine": {'group': 'Neurology - Anticonvulsant',vietnamese_name':
        ...
        'Rối loạn nhân cách'],contraindications': [
        ...
        'Theo dõi nồng độ trong máu, công thức máu, chức năng gan'},side_effects': ['Chóng mặt', 'Buồn nôn', 'Giảm bạch cầu',
        ...
        'Oral contraceptives: giảm hiệu quả'],mechanism_of_action':
        ...
        'Nồng độ natri (hạ natri máu - thường gặp)', 'Chức năng thận'],precautions': ['Tuân thủ chặt chẽ liều và lịch dùng',
        ...
        , 'Uống với thức ăn để giảm kích ứng dạ dày', 'Thận trọng ở suy gan'],pharmacokinetics': {'half_life':
        ...
        'clearance': 'Gan, bị ảnh hưởng bởi tự cảm ứng và các thuốc tương tác'},storage':
        ...
        'Tránh uống nhiều, hoặc tránh hoàn toàn nếu có thể.'}]},contraindications': {'tuyệt_đối': [
        ...
        , 'Giảm bạch cầu hoặc giảm tiểu cầu trước đó do carbamazepine'],tương_đối': [
        ...
        'Glaucoma góc đóng',
        'Bệnh nhân lớn tuổi (tăng nguy cơ hạ natri máu, độc tính)']},pregnancy_lactation': {'fda_category': 'D', 'pregnancy_details':
        ...
        'Tegretol', 'Carbamazepine'],range': '8,000 - 30,000 VND/viên (tùy hàm lượng và thương hiệu)',
        'note':
    ...
    "Lamotrigine": {'group': 'Neurology - Anticonvulsant',vietnamese_name':
        ...
        'Rối loạn lưỡng cực (phòng ngừa tái phát trầm cảm)'],contraindications': ['Dị ứng', 'Ban da nặng trước đây (SJS/TEN)'],dosage': {'adult_epilepsy':
        ...
        'Nhức đầu', 'Chóng mặt', 'Buồn nôn', 'Mất ngủ', 'Rối loạn thị giác'],interactions': [
        'Valproate: tăng nồng độ lamotrigine (giảm liều lamotrigine 50%)',
        'Carbamazepine: giảm nồng độ lamotrigine',
        'Oral contraceptives: giảm nồng độ lamotrigine (tăng liều)'],pregnancy': 'C', 'mechanism_of_action':
        ...
        'Giáo dục bệnh nhân về dấu hiệu ban da và cần báo ngay'],pharmacokinetics': {'half_life':
        ...
        'Tăng liều lamotrigine. Theo dõi nồng độ và điều chỉnh liều.'}],minor': []},contraindications': {'tuyệt_đối': [
        ...
        'Dùng với oral contraceptives - tăng liều lamotrigine']},pregnancy_lactation': {'fda_category': 'C', 'pregnancy_details':
        ...
        'Chóng mặt, nhức đầu', 'Lú lẫn, co giật', 'Rung nhĩ', 'Hôn mê (hiếm)'],antidote': 'Không có antidote đặc hiệu. Điều trị hỗ trợ', 'treatment':
        ...
        'Dấu hiệu ban da (SJS/TEN), ECG, ý thức, dấu hiệu co giật, điện giải'},reversal_agents': {'available': False, 'agents': [],notes':
        'Không có antidote đặc hiệu. Điều trị chủ yếu là hỗ trợ và điều trị triệu chứng. Ngừng thuốc ngay nếu có SJS/TEN. Điều trị SJS/TEN tại ICU nếu có.'},administration_instructions': {'oral': {'with_food':
    ...
    "Levetiracetam": {'group': 'Neurology - Anticonvulsant',vietnamese_name':
        ...
        ['Động kinh cục bộ', 'Động kinh tổng quát', 'Status epilepticus (IV)'],contraindications': ['Dị ứng'],dosage': {'adult_po':
        '500-1000mg x 2 lần/ngày, tăng đến 1000-3000mg/ngày', 'adult_iv':
        '500-1000mg IV mỗi 12 giờ', 'adult_max': '3000mg/ngày', 'notes':
        'Ít tương tác thuốc, an toàn cho trẻ em và người già'},renal_adjustment': {'normal': 'Không đổi', '50_80': 'Giảm liều 25%',
        '30_50': 'Giảm liều 50%', 'under_30': 'Giảm liều 75%'},side_effects':
        ['Buồn ngủ', 'Chóng mặt', 'Kích động, hành vi bất thường', 'Nhức đầu',
        'Mệt mỏi', 'Ít tác dụng phụ hơn các anticonvulsants khác'],interactions': ['Ít tương tác - không cảm ứng hoặc ức chế CYP450'],pregnancy': 'C', 'mechanism_of_action':
        ...
        'clearance':
        'Chủ yếu qua thận (66% bài tiết nguyên dạng), cần điều chỉnh thận'},storage':
        ...
        {'tuyệt_đối': ['Dị ứng levetiracetam hoặc các thành phần khác'],tương_đối': [
        ...
        'Mang thai (chứng cứ hạn chế) - chỉ dùng nếu lợi ích > nguy cơ']},pregnancy_lactation': {'fda_category': 'C', 'pregnancy_details':
        ...
        'A - Evidence from well-designed randomized controlled trials and systematic reviews'
            ...
            'narrow_therapeutic_index': False,
            'bleeding_risk': False,
            'organ_toxicity': ['neurological', 'psychiatric'],qt_prolongation': False,
            'hepatotoxicity': False,
            'nephrotoxicity': False,
    ...
    "Oxcarbazepine": {'group': 'Neurology - Anticonvulsant',vietnamese_name':
        ...
        'Động kinh cục bộ', 'Động kinh tổng quát',
        'Đau dây thần kinh sinh ba'],contraindications': [
        ...
        'Ban da nặng trước đây (SJS/TEN) với oxcarbazepine hoặc carbamazepine'],tương_đối': [
        ...
        'Trileptal', 'Oxcarbazepine'],range': '15,000 - 50,000 VND/viên (tùy hàm lượng và thương hiệu)',
        'note':
    ...
    "Phenobarbital": {'group': 'Neurology - Anticonvulsant',vietnamese_name':
        'Phenobarbital, Luminal', 'administration': ['PO', 'IV', 'IM'],indications': ['Động kinh (nhiều loại)', 'Status epilepticus',
        'An thần', 'Cai nghiện rượu', 'Cai nghiện benzodiazepine'],contraindications': ['Porphyria', 'Suy hô hấp nặng',
        ...
        '300mg/ngày', 'notes':
        'Theo dõi nồng độ trong máu (mục tiêu 15-40 mcg/mL). Half-life rất dài (80-120 giờ)'},renal_adjustment': {'normal': 'Không đổi', '30_60': 'Giảm liều 25%',
        ...
        'Alcohol, benzodiazepines: tăng ức chế hô hấp'],pregnancy': 'D - Nguy cơ dị tật thai nhi', 'mechanism_of_action':
        ...
        'clearance':
        'Gan (chuyển hóa), thận (thải trừ một phần). Cảm ứng enzyme CYP450 mạnh, tăng chuyển hóa của chính nó và nhiều thuốc khác.'},storage':
        ...
        'Tránh dùng cùng. Nếu cần, giảm liều cả hai thuốc và theo dõi hô hấp chặt chẽ.'}],moderate': [{'drug': 'Phenytoin, Carbamazepine', 'mechanism':
        ...
        'Tăng liều theophylline nếu cần. Theo dõi nồng độ và điều chỉnh liều.'}],minor': [{'drug': 'Acetaminophen', 'mechanism':
        'Phenobarbital cảm ứng enzyme, tăng chuyển hóa thành chất độc', 'effect':
        'Tăng nguy cơ độc gan với acetaminophen', 'management':
        'Thận trọng khi dùng cùng, giảm liều acetaminophen nếu cần.'}]},contraindications': {'tuyệt_đối': ['Porphyria (có thể gây cơn porphyria cấp)',
        ...
        'Tránh dùng hoặc dùng liều rất thấp dưới sự giám sát chặt chẽ. Theo dõi nồng độ trong máu và ALT/AST thường xuyên. Nguy cơ tích lũy và độc tính cao.'
        , 'notes':
        'Phenobarbital chuyển hóa ở gan qua nhiều enzyme CYP450. Suy gan làm giảm chuyển hóa, tăng nguy cơ tích lũy và độc tính. Đặc biệt thận trọng vì phenobarbital có thể gây viêm gan (hiếm).'},overdose_management': {'symptoms': [
        ...
        'Truyền qua đường tĩnh mạch lớn. Theo dõi hô hấp, huyết áp, nhịp tim, điện tâm đồ trong khi truyền. Có thể gây kích ứng tĩnh mạch. Ức chế hô hấp là nguy cơ chính - sẵn sàng hỗ trợ hô hấp.'}},pediatric_dosing': {'neonates':
        ...
        , 'notes':
        'Theo dõi nồng độ trong máu chặt chẽ (therapeutic range: 15-40 mcg/mL). Half-life rất dài (80-120 giờ) → tích lũy nếu dùng lâu dài. Theo dõi hô hấp chặt chẽ (đặc biệt ở trẻ nhỏ). KHÔNG ngừng đột ngột - giảm liều dần dần. Theo dõi dấu hiệu phụ thuộc/nghiện.'},geriatric_dosing': {'considerations':
        ...
        'A - Evidence from well-designed randomized controlled trials and systematic reviews'
            ...
            'narrow_therapeutic_index': True,
            'bleeding_risk': False,
            'organ_toxicity': ['hepatic', 'respiratory', 'bone'],qt_prolongation': False,
            'hepatotoxicity': True,
            'nephrotoxicity': False,
    ...
    "Phenytoin": {'group': 'Neurology - Anticonvulsant',vietnamese_name':
        ...
        'Đau dây thần kinh sinh ba', 'Rối loạn nhịp tim (hiếm)'],contraindications': ['Dị ứng', 'Suy gan nặng', 'Block nhĩ thất',
        ...
        'Gan, có thể bị ảnh hưởng bởi tình trạng dinh dưỡng, tuổi tác'},storage':
        ...
        'Giảm nhẹ nồng độ phenytoin', 'management': 'Uống cách nhau 2-3 giờ.'}]},contraindications': {'tuyệt_đối': [
        ...
        'Dilantin', 'Phenytoin'],range': '5,000 - 20,000 VND/viên (tùy hàm lượng và thương hiệu)',
        'note':
        ...
        'last_updated': '2025-02-18'
            ...
            'narrow_therapeutic_index': True,
            'bleeding_risk': False,
            'organ_toxicity': ['hepatic', 'hematologic', 'dermatologic', 'bone'],qt_prolongation': False,
            'hepatotoxicity': True,
            'nephrotoxicity': False,
...
"pregnancy": "D - Có bằng chứng về nguy cơ dị tật bẩm sinh",
        ...
        'Digoxin: có thể giảm nồng độ digoxin'],mechanism_of_action':
        ...
        'Theo dõi bicarbonate, pH. Thận trọng khi dùng chung.'}]},contraindications': {'tuyệt_đối': [
        ...
        'Dùng với valproate - tăng nguy cơ tăng amoniac máu']},pregnancy_lactation': {'fda_category': 'D', 'pregnancy_details':
        ...
        , 'recommendation':
        'Có thể dùng khi cho con bú với theo dõi chặt chẽ trẻ. Theo dõi dấu hiệu buồn ngủ, chậm tăng cân, bú kém ở trẻ. Nếu trẻ có dấu hiệu bất thường, cân nhắc ngừng cho con bú hoặc giảm liều.'}},hepatic_adjustment': {'mild': 'Không đổi hoặc giảm liều nhẹ',
        'moderate': 'Giảm liều 25-50%. Theo dõi chức năng gan', 'severe':
        'Giảm liều 50% hoặc tránh dùng. Theo dõi chức năng gan chặt chẽ', 'notes':
        'Topiramate chuyển hóa một phần ở gan (không phụ thuộc CYP450 chính). Suy gan làm giảm chuyển hóa, tăng nguy cơ tích lũy. Tuy nhiên, 70% bài tiết qua thận nguyên dạng, nên suy thận quan trọng hơn.'},overdose_management': {'symptoms': [
        ...
        'Theo dõi ý thức, hô hấp, tim mạch, điện giải (bicarbonate, anion gap), chức năng thận'},reversal_agents': {'available': False, 'agents': [],notes':
        'Không có antidote đặc hiệu. Điều trị chủ yếu là hỗ trợ và điều trị triệu chứng. Ngừng thuốc ngay. Lọc máu có thể hiệu quả (70% bài tiết qua thận nguyên dạng) ở trường hợp nặng.'},administration_instructions': {'oral': {'with_food':
    ...
    "Valproate": {'group': 'Neurology - Anticonvulsant',vietnamese_name':
        'Valproate, Valproic Acid, Depakote', 'administration': ['PO', 'IV'],indications': ['Động kinh (nhiều loại)', 'Rối loạn lưỡng cực',
        ...
        'Theo dõi nồng độ (mục tiêu 50-100 mcg/mL), chức năng gan, tiểu cầu'},side_effects': ['Buồn nôn, nôn', 'Tăng cân', 'Rụng tóc',
        ...
        'Aspirin: tăng nồng độ valproate', 'Warfarin: có thể tăng tác dụng'],pregnancy': 'D - Nguy cơ dị tật thai nhi cao (neural tube defects)',
        'mechanism_of_action':
        ...
        'Tránh dùng với aspirin liều cao (tăng nguy cơ độc tính)'],pharmacokinetics': {'half_life':
        ...
        'Theo dõi INR thường xuyên. Điều chỉnh liều warfarin nếu cần.'}],moderate': [{'drug': 'Phenytoin, Carbamazepine', 'mechanism':
        ...
        'Dùng nhiều thuốc chống động kinh - tăng nguy cơ độc tính']},pregnancy_lactation': {'fda_category': 'D', 'pregnancy_details':
        ...
        'Độc gan (tăng ALT/AST, vàng da)', 'Giảm tiểu cầu, chảy máu'],antidote': 'Không có antidote đặc hiệu. Điều trị hỗ trợ', 'treatment':
        ...
        'Điều trị hỗ trợ: chống nôn, truyền dịch, theo dõi điện giải'],monitoring':
        ...
        'Không có antidote đặc hiệu. Điều trị chủ yếu là hỗ trợ và điều trị triệu chứng. Ngừng thuốc ngay. Điều trị độc tính gan và hạ tiểu cầu nếu có. Có thể cần lọc máu để loại bỏ thuốc.'},administration_instructions': {'oral': {'with_food':
        ...
        'Depakote', 'Valproate', 'Valproic Acid'],range': '10,000 - 40,000 VND/viên (tùy hàm lượng và thương hiệu)',
        'note':
