...
"pregnancy": "C - Nguy cơ không thể loại trừ. Thận trọng trong thai kỳ",
        'vietnamese_name': 'Fluoxetine, Prozac', 'administration': ['PO'],indications': ['Trầm cảm', 'Rối loạn lo âu',
        ...
        'notes':
        'Tác dụng kéo dài (half-life dài), ngừng 5 tuần trước MAO inhibitor'},side_effects': ['Buồn nôn', 'Mất ngủ hoặc buồn ngủ',
        ...
        'Triptans: tăng nguy cơ hội chứng serotonin'],mechanism_of_action':
        ...
        'Dấu hiệu rút thuốc khi ngừng (chóng mặt, buồn nôn, kích động)'],precautions': [
        ...
        'Tác dụng kéo dài do half-life dài (cả thuốc và norfluoxetine)'],pharmacokinetics': {'half_life':
        ...
        'Có ý định tự tử - chỉ kê đơn số lượng ít', 'Bệnh tim - thận trọng',
        'Rối loạn đông máu - tăng nguy cơ chảy máu',
        'Dùng với tramadol, triptans - tăng nguy cơ hội chứng serotonin']},renal_adjustment': {'normal': 'Không cần chỉnh liều', '30_60': 'Thận trọng, có thể cần giảm liều',
        'under_30': 'Giảm liều 25-50%', 'dialysis': 'Thận trọng, giảm liều. Fluoxetine không được lọc sạch hiệu quả qua thẩm phân máu.',
        'notes': 'Fluoxetine chuyển hóa chủ yếu ở gan. Suy thận có thể ảnh hưởng nhẹ đến thải trừ. Giảm liều ở suy thận nặng.'},pregnancy_lactation': {'fda_category': 'C', 'pregnancy_details':
        ...
        'Co giật', 'Hôn mê', 'Hội chứng serotonin (nếu dùng với thuốc khác)'],antidote': 'Không có antidote đặc hiệu. Điều trị hỗ trợ', 'treatment':
        ...
        'Truyền dịch', 'Theo dõi ít nhất 24-48 giờ (do half-life dài)'],monitoring':
        'ECG, huyết áp, nhịp tim, nhiệt độ, ý thức, dấu hiệu co giật, điện giải'
        },reversal_agents': {'available': False, 'agents': [],notes':
        'Không có antidote đặc hiệu. Điều trị chủ yếu là hỗ trợ và điều trị triệu chứng. Ngừng thuốc ngay. Theo dõi ít nhất 24-48 giờ do half-life dài.'},administration_instructions': {'oral': {'with_food':
