...
"pregnancy": "C - Nguy cơ không thể loại trừ. Không khuyến nghị trong thai kỳ",
        'vietnamese_name': 'Donepezil, Aricept', 'administration': ['PO'],indications': [
        'Bệnh Alzheimer (mild to moderate dementia)',
        'Bệnh Alzheimer (moderate to severe dementia)'],contraindications': [
        'Dị ứng', 'Bệnh tim nặng (block nhĩ thất, rối loạn nhịp nặng)'],dosage': {'adult_mild_moderate': '5mg/ngày, tăng đến 10mg/ngày sau 4-6 tuần',
        ...
        'Beta-blockers: tăng nguy cơ chậm nhịp tim'],mechanism_of_action':
        ...
        'management': 'Thận trọng. Có thể cần giảm liều donepezil.'}]},contraindications': {'tuyệt_đối': [
        ...
        'Suy thận nặng (CrCl <30) - giảm thải trừ, tăng nguy cơ tích lũy',
        'Dùng với beta-blockers - tăng nguy cơ chậm nhịp tim',
        'Bệnh nhân lớn tuổi - tăng nguy cơ tác dụng phụ']},renal_adjustment': {'normal': 'Không cần chỉnh liều', '30_60': 'Thận trọng, có thể cần giảm liều',
        ...
        'Donepezil chuyển hóa ở gan qua CYP2D6, CYP3A4. Suy gan làm giảm chuyển hóa, tăng nguy cơ tích lũy và tác dụng phụ.'},overdose_management': {'symptoms': [
        ...
        'Theo dõi ý thức, hô hấp, tim mạch (nhịp tim), dấu hiệu cholinergic quá mức'},reversal_agents': {'available': True, 'agents': [{'agent': 'Atropine',
        ...
        'Atropine là antidote cho quá liều donepezil. Dùng để đối kháng tác dụng cholinergic quá mức.'},administration_instructions': {'oral': {'with_food':
        ...
        'compatibility': [],incompatibility': []}},references': {'primary_sources': ['Lexicomp - Donepezil',
...
"pregnancy": "B - Không có bằng chứng về nguy cơ ở người",
        'vietnamese_name': 'Memantine, Namenda', 'administration': ['PO'],indications': [
        ...
        'Cimetidine, ranitidine: có thể tăng nồng độ memantine nhẹ'],mechanism_of_action':
        ...
        'Giảm liều memantine 50% khi dùng với urine alkalinizers. Theo dõi tác dụng phụ.'}],moderate': [{'drug': 'Cimetidine, Ranitidine', 'mechanism':
        'Có thể giảm thải trừ memantine nhẹ', 'effect': 'Tăng nhẹ nồng độ memantine',
        'management': 'Thận trọng. Có thể cần giảm liều memantine nhẹ.'}],minor': []},contraindications': {'tuyệt_đối': [
        ...
        , 'recommendation':
        'Tránh dùng khi cho con bú nếu có thể. Nếu phải dùng, theo dõi trẻ sát.'}},hepatic_adjustment': {'mild': 'Không đổi hoặc giảm liều nhẹ',
        'moderate': 'Giảm liều 25-50%. Theo dõi chức năng gan', 'severe':
        'Giảm liều 50% hoặc tránh dùng. Theo dõi chức năng gan chặt chẽ', 'notes':
        'Memantine chuyển hóa một phần ở gan. Suy gan làm giảm chuyển hóa, tăng nguy cơ tích lũy. Tuy nhiên, thải trừ chủ yếu qua thận, nên suy thận quan trọng hơn.'},overdose_management': {'symptoms': [
        ...
        'Theo dõi ý thức, hô hấp, tim mạch, dấu hiệu co giật'},reversal_agents': {'available': False, 'agents': [],notes':
        'Không có antidote đặc hiệu. Điều trị chủ yếu là hỗ trợ và điều trị triệu chứng. Ngừng thuốc ngay. Acid hóa nước tiểu có thể tăng thải trừ.'},administration_instructions': {'oral': {'with_food':
        ...
        'compatibility': [],incompatibility': []}},references': {'primary_sources': ['Lexicomp - Memantine',
...
"pregnancy": "B - Không có bằng chứng về nguy cơ ở người",
        ...
        'Dị ứng', 'Bệnh tim nặng (block nhĩ thất, rối loạn nhịp nặng)'],dosage': {'adult_po': '1.5mg x 2 lần/ngày, tăng dần đến 6-12mg/ngày (chia 2 lần)',
        ...
        'Dùng với beta-blockers - tăng nguy cơ chậm nhịp tim']},pregnancy_lactation': {'fda_category': 'B', 'pregnancy_details':
        ...
        'moderate': 'Giảm liều 25-50%. Theo dõi chức năng gan', 'severe':
        'Giảm liều 50% hoặc tránh dùng. Theo dõi chức năng gan chặt chẽ', 'notes':
        'Rivastigmine chuyển hóa ở gan qua esterase (không phụ thuộc CYP450). Suy gan làm giảm chuyển hóa, tăng nguy cơ tích lũy.'},overdose_management': {'symptoms': [
        ...
        'Xử trí chậm nhịp tim: atropine, pacemaker nếu cần',
        'Hỗ trợ hô hấp nếu cần'],monitoring':
        'Theo dõi ý thức, hô hấp, tim mạch, dấu hiệu cholinergic quá mức'},reversal_agents': {'available': True, 'agents': [{'agent': 'Atropine',
        'mechanism': 'Anticholinergic', 'indication': 'Quá liều gây triệu chứng cholinergic quá mức',
        'caution': 'Dùng thận trọng'}]},administration_instructions': {'oral': {'with_food':
        ...
        'compatibility': [],incompatibility': []}},references': {'primary_sources': ['Lexicomp - Rivastigmine',
