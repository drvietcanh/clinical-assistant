...
ANTICONVULSANT_ALPHA_2_DELTA_LIGANDS_DRUGS = {
    "Gabapentin": {'group': 'Neurology - Anticonvulsant (Alpha-2-delta ligand)',vietnamese_name': 'Gabapentin, Neurontin', 'administration': ['PO'],indications': ['Động kinh cục bộ',
        'Đau thần kinh (postherpetic neuralgia, diabetic neuropathy)',
        'Rối loạn lo âu', 'Hội chứng chân không yên'],contraindications': [
        'Dị ứng'],dosage': {'adult_epilepsy':
        ...
        'Hấp thu giảm khi tăng liều. Uống cách xa antacids 2 giờ'},renal_adjustment': {'normal': 'Không đổi', '30_60':
        '300mg x 2 lần/ngày', '15_30': '300mg x 1 lần/ngày', 'under_15':
        '300mg cách ngày'},side_effects': ['Buồn ngủ', 'Chóng mặt', 'Mệt mỏi',
        'Phù ngoại biên', 'Tăng cân', 'Nhìn mờ', 'Suy giảm trí nhớ'],interactions': ['Antacids: giảm hấp thu (cách xa 2 giờ)',
        'Morphine: tăng tác dụng an thần', 'Ít tương tác khác'],pregnancy':
        ...
        , 'Có thể gây suy giảm trí nhớ, nhìn mờ - thận trọng ở người cao tuổi'],pharmacokinetics': {'half_life':
        ...
        'Tăng tác dụng ức chế hệ thần kinh trung ương', 'effect':
        'Tăng buồn ngủ, chóng mặt, suy hô hấp', 'management':
        'Tránh hoặc giảm rượu. Cảnh báo bệnh nhân.'}],minor': [{'drug':
        ...
        'Tiền sử lệ thuộc thuốc (có thể gây lệ thuộc)',
        'Bệnh hô hấp (COPD, sleep apnea) - tăng nguy cơ suy hô hấp khi dùng với opioids/benzodiazepines'
        ]},reversal_agents': {'available': False, 'agents': [],notes': 'Không có antidote đặc hiệu. Điều trị quá liều gabapentin chủ yếu là hỗ trợ. Lọc máu có thể hiệu quả (không gắn protein, bài tiết qua thận).'},pregnancy_lactation': {'fda_category': 'C', 'pregnancy_details':
        ...
        'Triệu chứng khác: nhìn mờ, phù ngoại biên'],antidote':
    ...
    "Pregabalin": {'group': 'Neurology - Anticonvulsant (Alpha-2-delta ligand)',vietnamese_name': 'Pregabalin, Lyrica', 'administration': ['PO'],indications': [
        'Đau thần kinh (postherpetic neuralgia, diabetic neuropathy)',
        'Đau cơ xơ hóa', 'Động kinh cục bộ', 'Rối loạn lo âu tổng quát'],contraindications': ['Dị ứng'],dosage': {'adult_neuropathic':
        ...
        'notes': 'Mạnh hơn gabapentin, hấp thu tốt hơn'},renal_adjustment': {
        'normal': 'Không đổi', '30_60': 'Giảm liều 50%', '15_30':
        'Giảm liều 75%', 'under_15': 'Giảm liều 90%'},side_effects': [
        'Buồn ngủ', 'Chóng mặt', 'Phù ngoại biên', 'Tăng cân', 'Nhìn mờ',
        'Suy giảm trí nhớ', 'Nguy cơ lạm dụng (controlled substance)'],interactions': ['Morphine: tăng tác dụng an thần',
        'Alcohol: tăng tác dụng an thần', 'Ít tương tác khác'],pregnancy':
        'C', 'mechanism_of_action':
        ...
        'management': 'Theo dõi tác dụng phụ. Có thể cần giảm liều.'}]},contraindications': {'tuyệt_đối': [
        'Dị ứng pregabalin hoặc các thành phần khác'],tương_đối': [
        'Suy thận (CrCl <30) - giảm liều đáng kể, tăng khoảng cách liều',
        ...
        'Bệnh hô hấp (COPD, sleep apnea) - tăng nguy cơ suy hô hấp khi dùng với opioids/benzodiazepines'
        , 'Congestive heart failure - tăng nguy cơ phù ngoại biên']},pregnancy_lactation': {'fda_category': 'C', 'pregnancy_details':
        'Chứng cứ về an toàn trong thai kỳ còn hạn chế. Một số nghiên cứu gợi ý tăng nhẹ nguy cơ dị tật bẩm sinh và kết quả thai kỳ kém, nhưng chứng cứ không rõ ràng. Chỉ dùng nếu lợi ích điều trị vượt trội nguy cơ. Nếu dùng trong thai kỳ, cần tư vấn di truyền và theo dõi chặt chẽ.'
        , 'lactation': {'safety': 'Compatible', 'details':
