...
ANTICONVULSANT_ALPHA_2_DELTA_LIGANDS_DRUGS = {
    "Gabapentin": {'group': 'Neurology - Anticonvulsant (Alpha-2-delta ligand)',vietnamese_name': 'Gabapentin, Neurontin', 'administration': ['PO'],
    ...
    "Pregabalin": {'group': 'Neurology - Anticonvulsant (Alpha-2-delta ligand)',vietnamese_name': 'Pregabalin, Lyrica', 'administration': ['PO'],
        'indications': [
        'Đau thần kinh (postherpetic neuralgia, diabetic neuropathy)',
