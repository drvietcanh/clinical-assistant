...
FLUIDS_DRUGS = {
    "Sodium Chloride 0.9%": {
        ...
        "brand_names": {
            "common": ["Normal Saline"],
            "vietnam": ["Natri Clorid 0.9% (nhiều hãng)"]
        },
        "administration": ["IV (Truyền tĩnh mạch)"],
        "indications": [
        ...
        "monitoring": ["Điện giải (Na, Cl)", "Cân bằng dịch", "Dấu hiệu quá tải dịch"]
    },
    ...
    "Ringer Lactate": {
        ...
        "brand_names": {
            "common": ["Lactated Ringer's", "Hartmann's Solution"],
            "vietnam": ["Ringer Lactate"]
        },
        "administration": ["IV"],
        "indications": [
        ...
        "monitoring": ["Điện giải", "Lactate (không ảnh hưởng đáng kể lactate máu trừ khi suy gan nặng)"]
    },
    ...
    "Albumin (Human)": {
        ...
        "brand_names": {
            "common": ["Albuminar", "Albuked"],
            "vietnam": ["Human Albumin (Baxalta/Grifols/Biotest)"]
        },
        "administration": ["IV"],
        "indications": [
        ...
        "side_effects": ["Quá tải dịch (Pulmonary edema)", "Phản ứng dị ứng (hiếm)"],
    ...
    "HES 130/0.4": {
        ...
        "brand_names": {
            "common": ["Voluven", "Tetraspan"],
            "vietnam": ["Voluven 6%", "Tetraspan 6%"]
        },
        "administration": ["IV"],
        "indications": [
        ...
        "monitoring": ["Chức năng thận (Creatinine)", "Đông máu"]
    }
}
