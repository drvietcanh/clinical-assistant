...
LOCAL_ANESTHETIC_ANTIARRHYTHMIC_CLASS_IB_DRUGS = {
    "Lidocaine": {'group': 'Emergency - Local Anesthetic / Antiarrhythmic (Class IB)',vietnamese_name': 'Lidocaine, Xylocaine', 'administration': ['IV',
        'IO', 'IT'],indications': [
        'Rung thất / Nhịp nhanh thất không có mạch (khi không có amiodarone)',
        'Rối loạn nhịp thất', 'Gây tê tại chỗ', 'Gây tê vùng'],contraindications': ['Dị ứng lidocaine',
        'Block nhĩ thất độ 2-3 (không có máy tạo nhịp)',
        'Hội chứng Adams-Stokes', 'Rối loạn nhịp nặng'],dosage': {
        ...
        'Rối loạn nhịp tim', 'Hạ huyết áp', 'Phản ứng dị ứng (hiếm)'],interactions': ['Beta-blockers: giảm chuyển hóa lidocaine',
        ...
        'Dấu hiệu phản ứng dị ứng (hiếm)'],precautions': [
        ...
        'Giảm liều ở người cao tuổi (giảm chuyển hóa)'],pharmacokinetics': {
        ...
        'management':
        'Thận trọng, theo dõi ECG chặt chẽ. Có thể cần giảm liều lidocaine.'}],minor': [{'drug': 'Quinidine, Procainamide', 'mechanism':
        ...
        , 'Hội chứng Adams-Stokes - nguy cơ nhịp chậm nặng, ngừng tim'],tương_đối': [
