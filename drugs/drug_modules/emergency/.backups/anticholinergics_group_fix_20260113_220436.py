...
ANTICHOLINERGICS_DRUGS = {
    "Atropine": {'group': 'Emergency - Anticholinergic',vietnamese_name': 'Atropine',
        ...
        'Glaucoma góc đóng', 'Tắc nghẽn đường tiểu', 'Nhịp tim nhanh', 'Sốt'],dosage': {'adult_bradycardia': '0.5-1mg IV mỗi 3-5 phút (tối đa 3mg)',
        ...
        'notes':
        'Liều tối thiểu người lớn 0.5mg để tránh nhịp tim chậm nghịch lý'},renal_adjustment': {'normal': 'Không đổi', '30_60': 'Không đổi',
        ...
        'Nhịp tim nhanh (có thể làm tăng nhịp tim hơn nữa)', 'Dị ứng atropine'],tương_đối': ['Sốt (có thể làm tăng nhiệt độ do giảm tiết mồ hôi)',
        ...
        'Người già (tăng nguy cơ lú lẫn, bí tiểu)',
        'Bệnh mạch vành (tăng nhịp tim có thể làm nặng thêm)',
        'Bệnh phổi tắc nghẽn mạn tính (COPD) - có thể làm tăng độ nhớt đờm']},black_box_warnings': None,
        ...
        'Sốt (do giảm tiết mồ hôi)', 'Khó thở (do giảm tiết phế quản)'],antidote':
        ...
        'Lexicomp Online - Atropine Monograph'],evidence_level':
