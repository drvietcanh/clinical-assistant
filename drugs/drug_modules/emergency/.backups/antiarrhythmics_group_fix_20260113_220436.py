...
ANTIARRHYTHMICS_DRUGS = {
    "Adenosine": {'group': 'Emergency - Antiarrhythmic',vietnamese_name': 'Adenosine',
        'administration': ['IV', 'IO'],indications': [
        'Nhịp nhanh trên thất (SVT) - cấp cứu', 'Chẩn đoán rối loạn nhịp',
        'Cuồng nhĩ'],contraindications': [
        'Block nhĩ thất độ 2-3 (không có máy tạo nhịp)', 'Hội chứng sick sinus',
        'Hen phế quản nặng', 'Dị ứng adenosine'],dosage': {'adult_svt_first':
        ...
        'Loạn nhịp (thoáng qua)'],interactions': [
        ...
        'Đáp ứng điều trị (chuyển về nhịp xoang)'],precautions': [
        ...
        'Tránh dùng với theophylline hoặc caffeine (đối kháng tác dụng)'],pharmacokinetics': {'half_life': '<10 giây (cực ngắn)', 'onset':
        ...
        'Thận trọng, theo dõi ECG chặt chẽ. Có thể cần giảm liều adenosine.'}],minor': [{'drug': 'Beta-blockers', 'mechanism':
