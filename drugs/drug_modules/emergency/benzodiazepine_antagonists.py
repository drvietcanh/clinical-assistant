...
BENZODIAZEPINE_ANTAGONISTS_DRUGS = {
    "Flumazenil": {'group': 'Emergency - Benzodiazepine Antagonist',
        'vietnamese_name':
        'Flumazenil, Anexate', 'administration': ['IV'],
        'indications': [
        ...
        'pregnancy_lactation': {
            ...
            'lactation_details': 'Flumazenil có thời gian bán thải ngắn (41-79 phút) và bị chuyển hóa nhanh. Không có khả năng bài tiết vào sữa mẹ ở nồng độ đáng kể. Không có báo cáo về tác dụng phụ ở trẻ bú mẹ. Có thể dùng khi cho con bú.'
        },
        'mechanism_of_action':
        ...
        'Gan, thời gian bán thải ngắn hơn nhiều so với hầu hết benzodiazepine'},
        'storage':
