...
OPIOID_ANTAGONISTS_DRUGS = {
    "Naloxone": {
        ...
        "pregnancy": "C - Thận trọng. Naloxone có thể qua nhau thai. Trong quá liều opioid, lợi ích cứu sống mẹ (và thai nhi) vượt quá nguy cơ.",
        ...
        "risk_flags": {
            ...
            "requires_monitoring": ["Respiratory rate", "SpO2", "GCS", "Vital Signs"]
        },
        "guideline_tags": [
            "ACLS Guidelines 2020 - American Heart Association",
            "FDA Drug Label - Naloxone",
    ...
    "Naltrexone": {
        ...
        "pregnancy": "C - Thận trọng. Không có nghiên cứu đầy đủ ở phụ nữ có thai. Có thể dùng nếu lợi ích > nguy cơ.",
