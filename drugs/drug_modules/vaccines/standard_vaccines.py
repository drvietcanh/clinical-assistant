...
STANDARD_VACCINES = {
    "VAT (Tetanus Vaccine)":     {
        ...
        "dosage": {
            ...
            "pregnancy": "C - Nguy cơ không thể loại trừ. Khuyến nghị trong thai kỳ",
    ...
    "Verorab (Rabies Vaccine)":     {
        ...
        "interactions": [],
        "pregnancy": "C - Nguy cơ không thể loại trừ. Khuyến nghị khi có chỉ định",
        "mechanism_of_action": "",
        "monitoring": [],
        "precautions": [],
        "pharmacokinetics": {
    ...
    "Influenza Vaccine":     {
        ...
        "storage": "2-8 độ C.",
        "interactions": [],
        "pregnancy": "B - Không có bằng chứng về nguy cơ ở người. Khuyến nghị trong thai kỳ",
        "mechanism_of_action": "",
        "monitoring": [],
        "precautions": [],
        "pharmacokinetics": {
