...
STANDARD_VACCINES = {
    "VAT (Tetanus Vaccine)": {
        ...
        "brand_names": {
            "common": ["VAT", "Tetavax"],
            "vietnam": ["VAT (IVAC)", "Tetavax (Pháp)"]
        },
        "administration": ["IM (Cơ Delta)"],
        "indications": [
    ...
    "Verorab (Rabies Vaccine)": {
        ...
        "brand_names": {
            "common": ["Verorab", "Abhayrab", "Indirab"],
            "vietnam": ["Verorab (Pháp)", "Abhayrab (Ấn Độ)"]
        },
        "administration": ["IM (Cơ Delta) - KHÔNG tiêm mông", "Tiêm trong da (ID)"],
        "indications": [
    ...
    "Influenza Vaccine": {
        ...
        "brand_names": {
            "common": ["Vaxigrip Tetra", "Influvac Tetra", "GC Flu"],
            "vietnam": ["Vaxigrip Tetra (Pháp)", "Influvac Tetra (Hà Lan)", "Ivacflu-S (Việt Nam)"]
        },
        "administration": ["IM (Cơ Delta) hoặc SC sâu"],
        "indications": ["Phòng ngừa cúm mùa (người lớn và trẻ em >6 tháng)"],
        "contraindications": [
        ...
        "side_effects": ["Đau tại chỗ, sốt nhẹ, đau cơ."],
        "storage": "2-8 độ C."
    },
    ...
    "Hepatitis B Vaccine": {
        ...
        "brand_names": {
            "common": ["Engerix B", "Euvax B", "Heberbiovac HB"],
            "vietnam": ["Gene-HBvax (Việt Nam)", "Engerix B (Bỉ)", "Euvax B (Hàn Quốc)"]
        },
        "administration": ["IM (Cơ Delta - người lớn; Đùi - trẻ em)"],
        "indications": ["Phòng ngừa viêm gan B (Sơ sinh, người lớn chưa có miễn dịch)"],
        "dosage": {
            "adult": "Lịch 0-1-6 tháng (3 mũi). 1 ml (20mcg).",
            "newborn": "Tiêm trong 24h đầu sau sinh. Nếu mẹ HBsAg(+), tiêm cùng kháng huyết thanh (HBIg)."
        },
        "side_effects": ["Đau tại chỗ, sốt nhẹ."],
