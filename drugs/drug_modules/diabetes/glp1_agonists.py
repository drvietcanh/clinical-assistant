...
GLP1_AGONISTS_DRUGS = {
    "Liraglutide": {
        ...
        "brand_names": {
            "common": ["Victoza (ĐTĐ)", "Saxenda (Giảm cân)"],
            "vietnam": ["Victoza 6mg/ml"]
        },
    ...
    "Semaglutide": {
        ...
        "brand_names": {
            "common": ["Ozempic (ĐTĐ - tiêm)", "Wegovy (Giảm cân - tiêm)", "Rybelsus (ĐTĐ - uống)"],
            "vietnam": ["Ozempic 0.25/0.5/1mg", "Rybelsus 3/7/14mg"]
        },
        "administration": ["SC (Tiêm dưới da - Ozempic, Wegovy)", "PO (Uống - Rybelsus)"],
        "indications": [
            "Đái tháo đường type 2",
    ...
    "Exenatide": {
        ...
        "brand_names": {
            "common": ["Byetta (2 lần/ngày)", "Bydureon (1 lần/tuần)"],
            "vietnam": ["Byetta 5/10mcg"]
        },
        "administration": ["SC"],
        "indications": [
            "Đái tháo đường type 2"
