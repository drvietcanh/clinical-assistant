...
BIGUANIDES_DRUGS = {
    "Metformin": {'group': 'Diabetes - Biguanide',
        "pregnancy": "B - Không có bằng chứng về nguy cơ ở người. Có thể sử dụng trong thai kỳ cho đái tháo đường thai kỳ",
        'vietnamese_name':
        'Metformin, Glucophage', 'administration': ['PO'],
        'indications': [
        ...
        'Khởi đầu với liều thấp, tăng dần. Tạm ngừng khi dùng thuốc cản quang'},renal_adjustment': {'normal': 'Không đổi', '30_60':
        ...
        'Furosemide: có thể tăng nồng độ metformin'],mechanism_of_action':
        ...
        'Lactate nếu nghi ngờ nhiễm toan lactic (đau cơ, khó thở, đau bụng)'],precautions': ['Ngừng 48h trước và sau khi dùng thuốc cản quang',
        ...
        'Thận trọng. Theo dõi lactate. Có thể cần giảm liều metformin.'}],minor': [{'drug': 'Warfarin', 'mechanism':
        'Metformin có thể tăng nhẹ tác dụng chống đông', 'effect':
        'Tăng nhẹ INR', 'management':
        'Theo dõi INR. Điều chỉnh liều warfarin nếu cần.'}]},contraindications': {'tuyệt_đối': [
        ...
        'Phẫu thuật lớn - tạm ngừng trước và sau phẫu thuật']},pregnancy_lactation': {'fda_category': 'B', 'pregnancy_details':
        ...
        'Không có antidote đặc hiệu. Điều trị chủ yếu là hỗ trợ và điều trị triệu chứng. Ngừng thuốc ngay. Điều trị nhiễm toan lactic nếu có (bicarbonate IV, lọc máu nếu cần). Điều trị hạ đường huyết nếu có.'},administration_instructions': {'oral': {'with_food':
        ...
        'vietnam': ['Glucophage', 'Metformin Stada', 'Metformin', 'Diaformin', 'Metforal'],common': ['Glucophage', 'Metformin', 'Fortamet', 'Riomet']
    },cost_estimate': {
        'unit': 'VND',
        ...
        'High - Multiple large RCTs (UKPDS) and extensive clinical experience'},risk_flags': {
            'high_alert': False,
            'narrow_therapeutic_index': False,
            'bleeding_risk': False,
            'organ_toxicity': ['Lactic acidosis (rare but serious)', 'Renal toxicity (contraindicated if CrCl <30)'],qt_prolongation': False,
