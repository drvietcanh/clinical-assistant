...
"pregnancy": "B",
    ...
    "Sitagliptin": {'group': 'Diabetes - DPP-4 Inhibitor',vietnamese_name':
        ...
        'Nhiễm toan ceton', 'Dị ứng sitagliptin', 'Suy thận nặng (CrCl <30)'],dosage': {'adult_normal_renal': '100mg x 1 lần/ngày',
        ...
        'Đau khớp nghiêm trọng (hiếm)', 'Suy tim (tăng nhẹ nguy cơ)'],interactions': [
        'Insulin/Sulfonylurea: có thể tăng nguy cơ hạ đường huyết',
        ...
        'Triệu chứng suy tim (khó thở, phù) - tăng nhẹ nguy cơ suy tim',
        'Dấu hiệu phản ứng dị ứng (phát ban, phù mạch) - hiếm',
        'Tác dụng phụ (nhức đầu, nhiễm trùng đường hô hấp trên)'],precautions': ['Không dùng cho đái tháo đường type 1 (không hiệu quả)',
        ...
        'Có thể dùng bất kỳ lúc nào, không cần ăn',
        'An toàn trong thai kỳ (category B)',
        'Tương tác nhẹ với digoxin - có thể tăng nồng độ digoxin'],pharmacokinetics': {'half_life': '12.4 giờ', 'onset': '1-2 giờ',
        ...
        , 'black_box_warnings': None, 'drug_interactions': {'major': [],moderate': [{'drug': 'Digoxin', 'mechanism':
        ...
        'Tương tác tối thiểu', 'management': 'Không cần điều chỉnh liều'}]},contraindications': {'tuyệt_đối': ['Đái tháo đường type 1',
        ...
        'Đau khớp nghiêm trọng - ngừng thuốc nếu xảy ra']},pregnancy_lactation': {'fda_category': 'B', 'pregnancy_details':
        ...
        'Hạ đường huyết (nếu dùng với insulin hoặc sulfonylurea)',
        'Đau bụng, buồn nôn, nôn (dấu hiệu viêm tụy)', 'Nhức đầu', 'Đau khớp'],antidote': 'Không có antidote đặc hiệu', 'treatment': [
        ...
        'Không có antidote đặc hiệu. Điều trị chủ yếu là hỗ trợ và điều trị triệu chứng. Ngừng thuốc ngay nếu có viêm tụy cấp. Điều trị viêm tụy hỗ trợ nếu có.'},administration_instructions': {'oral': {'with_food':
        ...
        'notes':
        'Dữ liệu hạn chế ở trẻ em. Đái tháo đường type 2 ở trẻ em thường hiếm. Cần điều chỉnh liều theo chức năng thận. Theo dõi đường huyết, dấu hiệu viêm tụy cấp.'},geriatric_dosing': {'considerations':
        ...
        'monitoring':
        'Theo dõi đường huyết (HbA1c, glucose máu). Theo dõi chức năng thận (creatinine, CrCl) định kỳ. Theo dõi dấu hiệu viêm tụy cấp (đau bụng nặng, buồn nôn, nôn). Theo dõi triệu chứng suy tim (khó thở, phù).'},brand_names': {'vietnam': [
        'Sitagliptin', 'Januvia', 'Sitagliptin Stada', 'Sitaglu'],common': [
        ...
        'High - Multiple RCTs and systematic reviews (TECOS study)'},risk_flags': {
            'high_alert': False,
            'narrow_therapeutic_index': False,
            'bleeding_risk': False,
            'organ_toxicity': ['Pancreatitis (rare)', 'Heart failure (slight increased risk)'],qt_prolongation': False,
            'hepatotoxicity': False,
            'nephrotoxicity': False,
    ...
    "Vildagliptin": {'group': 'Diabetes - DPP-4 Inhibitor',vietnamese_name':
        ...
        '50mg x 2 lần/ngày', 'notes': 'Uống với bữa ăn. Ít gây hạ đường huyết'},renal_adjustment': {'normal': '50mg x 2 lần/ngày', '30_60':
        ...
        'Insulin/Sulfonylurea: có thể tăng nguy cơ hạ đường huyết'],pregnancy': 'C', 'mechanism_of_action':
        ...
        'Có thể tăng nguy cơ hạ đường huyết khi dùng với insulin/sulfonylurea'],pharmacokinetics': {'half_life': '2-3 giờ (ngắn)', 'onset':
        '2-4 tuần (giảm HbA1c)', 'duration': '12-24 giờ', 'protein_binding':
        '9%', 'clearance': 'Thận (thải trừ chủ yếu), gan (chuyển hóa)'},storage': 'Bảo quản ở nhiệt độ phòng (15-30°C), tránh ẩm',
        'black_box_warnings':
        ...
        'Viêm tụy trước đây - tăng nguy cơ viêm tụy cấp']},pregnancy_lactation': {'fda_category': 'C', 'pregnancy_details':
        ...
        'Đường huyết, dấu hiệu viêm tụy cấp, chức năng gan, dấu hiệu sinh tồn'},reversal_agents': {'available': False, 'agents': [],notes':
        'Không có antidote đặc hiệu. Điều trị chủ yếu là hỗ trợ và điều trị triệu chứng. Ngừng thuốc ngay nếu có viêm tụy cấp. Điều trị viêm tụy hỗ trợ nếu có.'},administration_instructions': {'oral': {'with_food':
        ...
        'A - Dựa trên FDA drug labels và dữ liệu lâm sàng'},risk_flags': {
            'high_alert': False,
            'narrow_therapeutic_index': False,
            'bleeding_risk': False,
            'organ_toxicity': ['Pancreatitis (rare)', 'Hepatotoxicity (contraindicated in severe hepatic impairment)'],qt_prolongation': False,
            'hepatotoxicity': True,
            'nephrotoxicity': False,
