...
"pregnancy": "C - Nguy cơ không thể loại trừ. Không khuyến nghị trong thai kỳ",
        ...
        'Uống bất kỳ lúc nào. Tác dụng chậm (2-4 tuần). Gây giữ nước'},renal_adjustment': {'normal': 'Không đổi', '30_60': 'Không đổi',
        'under_30': 'Thận trọng'},side_effects': [
        'Giữ nước, phù (tăng nguy cơ suy tim)', 'Tăng cân',
        'Gãy xương (phụ nữ có nguy cơ tăng)', 'Thiếu máu',
        'Tăng LDL cholesterol', 'Ung thư bàng quang (tăng nhẹ nguy cơ)'],interactions': ['Insulin: tăng nguy cơ suy tim, phù',
        'Digoxin: có thể tăng nồng độ digoxin'],mechanism_of_action':
        ...
        'management': 'Thận trọng. Có thể cần giảm liều pioglitazone.'}],minor': []},contraindications': {'tuyệt_đối': [
        ...
        'Theo dõi dấu hiệu sinh tồn, chức năng gan, chức năng tim'],monitoring':
        ...
        'Không có antidote đặc hiệu. Điều trị chủ yếu là hỗ trợ và điều trị triệu chứng. Ngừng thuốc ngay nếu có suy tim, độc tính gan, hoặc phản ứng dị ứng nghiêm trọng.'},administration_instructions': {'oral': {'with_food':
