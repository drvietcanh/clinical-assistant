...
SULFONYLUREAS_DRUGS = {
    "Glibenclamide": {'group': 'Diabetes - Sulfonylurea',vietnamese_name':
        ...
        'Đái tháo đường type 2'],contraindications': [
        ...
        'Nguy cơ hạ đường huyết cao, đặc biệt ở người già, suy thận'},side_effects': ['Hạ đường huyết (thường gặp, có thể nặng)', 'Tăng cân',
        ...
        'Suy thận nặng (CrCl <30) - tăng nguy cơ hạ đường huyết nghiêm trọng'],tương_đối': ['Suy gan nặng - tăng nguy cơ hạ đường huyết',
        ...
        'Dùng beta-blocker - che dấu triệu chứng hạ đường huyết']},pregnancy_lactation': {'fda_category': 'C', 'pregnancy_details':
        ...
        'Hỗ trợ hô hấp và tuần hoàn nếu cần', 'Theo dõi ý thức, dấu hiệu sống'],monitoring':
        ...
        'Nếu không thể truyền IV, dùng glucagon để tăng đường huyết'}]},administration_instructions': {'oral': {'with_food':
        ...
        'Daonil', 'Glibenclamide', 'Glyburide'],range': '2,000 - 10,000 VND/viên (tùy hàm lượng và thương hiệu)',
        'note':
...
"pregnancy": "C - Nguy cơ không thể loại trừ. Thận trọng trong thai kỳ",
        ...
        'Diamicron', 'Gliclazide'],range': '3,000 - 15,000 VND/viên (tùy hàm lượng và thương hiệu)',
        'note':
