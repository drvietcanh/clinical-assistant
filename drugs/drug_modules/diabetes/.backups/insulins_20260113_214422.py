    ...
    "Insulin": {
        ...
        "administration_instructions": {
            ...
            "iv": {
                ...
                "compatibility": ["Normal saline (0.9% NaCl)", "Dextrose 5% (D5W)", "Dextrose 10% (D10W)", "Ringer's lactate"],
                "incompatibility": [
        ...
        "risk_flags": {
            ...
            "requires_monitoring": ["Blood glucose", "HbA1c", "Weight", "Renal function"],
        },
        "guideline_tags": [
            ...
            "FDA Black Box Warning - Hypoglycemia",
        ],
        "renal_adjustment": {
            "normal": "Không đổi",
            "30_60": "Không đổi",
