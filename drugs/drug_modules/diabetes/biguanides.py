...
BIGUANIDES_DRUGS = {
    "Metformin": {
        ...
        'notes': 'Không có antidote đặc hiệu. Điều trị chủ yếu là hỗ trợ và điều trị triệu chứng. Ngừng thuốc ngay. Điều trị nhiễm toan lactic nếu có (bicarbonate IV, lọc máu nếu cần). Điều trị hạ đường huyết nếu có.',
        ...
        'image_url': 'https://www.drugs.com/images/pills/fio/MET01.JPG',
