...
OBSTETRICS_GYNECOLOGY_DRUGS = {
    ...
    "Carboprost": {
        ...
        "administration": ["IM", "Intramyometrial (off-label)"],
        "indications": [
        ...
        "interaction": {
             "tăng_nguy_cơ": ["Oxytocin (tăng nguy cơ vỡ tử cung nếu dùng đồng thời liều cao gây cơn co cường tính - cần theo dõi sát)"]
        },
        "analysis": {
    ...
    "Dinoprostone": {
        ...
        "administration": ["Vaginal Insert", "Endocervical Gel"],
        "indications": [
