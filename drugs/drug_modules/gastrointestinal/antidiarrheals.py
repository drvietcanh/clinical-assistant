...
ANTIDIARRHEALS_DRUGS = {
    "Bismuth subsalicylate": {'group': 'Gastrointestinal - Antidiarrheal',
        ...
        , 'clearance':
        'Bismuth: không hấp thu, thải trừ qua phân. Salicylate: thận (thải trừ, giống aspirin).'},
        'storage':
        ...
        , 'Suy thận nặng - tích lũy bismuth và salicylate'],
        'tương_đối': [
        ...
        'Hội chứng Reye (nếu dùng ở trẻ em): sốt, nôn, lú lẫn, co giật, hôn mê'],
        'antidote':
    ...
    "Loperamide": {'group': 'Gastrointestinal - Antidiarrheal',
        ...
        'infusion_rate': 'N/A', 'compatibility': [],
        'incompatibility': [],
