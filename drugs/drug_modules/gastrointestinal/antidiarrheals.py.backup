...
ANTIDIARRHEALS_DRUGS = {
    "Bismuth subsalicylate": {'group': 'Gastrointestinal - Antidiarrheal',
        ...
        'Tránh dùng cùng. Nếu phải dùng, tăng liều probenecid.'}], 'minor': []},
        ...
        'Dùng với tetracycline, quinolone - giảm hấp thu, cần cách xa 2 giờ']},
        ...
        , 'recommendation':
        'Có thể dùng khi cho con bú với thận trọng. Theo dõi trẻ về dấu hiệu tác dụng phụ.'}},
        'hepatic_adjustment': {'mild': 'Không đổi', 'moderate': 'Thận trọng',
        'severe': 'Thận trọng - salicylate chuyển hóa ở gan, có thể tích lũy', 'notes':
        'Salicylate chuyển hóa ở gan. Suy gan có thể làm giảm chuyển hóa, tăng nguy cơ tích lũy. Thận trọng ở suy gan nặng.'},
        ...
        'Theo dõi: nồng độ salicylate trong máu, pH máu, bicarbonate, dấu hiệu nhiễm toan chuyển hóa, ý thức, dấu hiệu hội chứng Reye (nếu trẻ em)'},
        'reversal_agents': {'available': False, 'agents': [], 'notes':
        'Không có antidote đặc hiệu. Điều trị salicylate quá liều: bicarbonate để kiềm hóa nước tiểu và tăng thải trừ.'},
