...
PROKINETIC_ANTIEMETICS_DRUGS = {
    "Domperidone": {'group': 'Gastrointestinal - Prokinetic, Antiemetic',,
        ...
        'Thận trọng, giảm liều', 'under_30': 'Thận trọng, giảm liều 50%'},side_effects': ['Rối loạn kinh nguyệt', 'Tăng prolactin', 'Đau vú',
        'Chảy sữa (galactorrhea)', 'QT kéo dài (liều cao)', 'Nhức đầu'],interactions': [
        'QT kéo dài: tránh dùng với thuốc QT kéo dài (amiodarone, quinolone)',
        'Ketoconazole: tăng nồng độ domperidone',
        'Erythromycin: tăng nồng độ domperidone'],mechanism_of_action':
        ...
        'QT kéo dài (QTc >450ms ở nam, >470ms ở nữ) - CHỐNG CHỈ ĐỊNH'],tương_đối': ['Suy thận nặng (CrCl <30) - giảm liều 50%',
        'Suy gan nặng - giảm liều, tăng nguy cơ QT kéo dài',
        'Hạ kali, hạ magie - tăng nguy cơ QT kéo dài',
        'Người già - thận trọng, giảm liều', 'Rối loạn nhịp tim - thận trọng']},pregnancy_lactation': {'fda_category': 'C', 'pregnancy_details':
        ...
        'Theo dõi ECG liên tục (QT interval), dấu hiệu sinh tồn, điện giải'},reversal_agents': None, 'administration_instructions': {'oral': {
        ...
        'infusion_rate': 'N/A', 'compatibility': [],incompatibility': [],notes': 'Domperidone chỉ có dạng uống, không có dạng IV'}},risk_flags': {
            'high_alert': True,
    ...
    "Metoclopramide": {'group': 'Gastrointestinal - Prokinetic, Antiemetic',vietnamese_name':
        'Metoclopramide, Primperan', 'administration': ['PO', 'IV', 'IM'],indications': ['Buồn nôn, nôn', 'Liệt dạ dày',
        'Trào ngược dạ dày thực quản', 'Đau nửa đầu (kết hợp)'],contraindications': ['Tắc ruột', 'Xuất huyết tiêu hóa',
        ...
        , 'Đáp ứng lâm sàng: giảm buồn nôn, nôn; tăng nhu động dạ dày'],precautions': [
        ...
        'Có thể gây buồn ngủ - tránh lái xe, vận hành máy móc'],pharmacokinetics': {'half_life': '5-6 giờ', 'onset':
        ...
        'Rối loạn vận động (Parkinson, dystonia, tardive dyskinesia)'],tương_đối': ['Suy thận (CrCl <30) - giảm liều 50-75%',
        ...
        'Đang dùng antipsychotics - tăng nguy cơ rối loạn vận động']},pregnancy_lactation': {'fda_category': 'B', 'pregnancy_details':
