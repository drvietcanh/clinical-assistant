...
"pregnancy": "B - Không có bằng chứng về nguy cơ ở người",
        ...
        'Yếu hơn PPI, nhưng rẻ hơn. Một số sản phẩm đã bị thu hồi do NDMA'},side_effects': ['Nhức đầu', 'Rối loạn tiêu hóa', 'Tăng men gan (hiếm)'
        ],interactions': [
        'Warfarin: có thể tăng tác dụng (ít hơn cimetidine)'],mechanism_of_action':
        ...
        , 'INR nếu dùng với warfarin (tăng nguy cơ chảy máu nhẹ)'],precautions': ['Uống với thức ăn hoặc trước bữa ăn (tăng hiệu quả)',
        'Yếu hơn PPI - cân nhắc dùng PPI nếu không đáp ứng',
        ...
        'Giảm hấp thu sắt', 'management': 'Cách thời gian ít nhất 2 giờ.'}],minor': [{'drug': 'Phenytoin, Theophylline', 'mechanism':
        ...
        , 'notes':
        'Giảm liều ở suy gan trung bình và nặng. Thận trọng theo dõi.'},renal_adjustment': {'normal': 'Không cần chỉnh liều',
        ...
        'Chỉ dùng IV khi không uống được. Chuyển sang PO sớm nhất có thể.'}},references': {'primary_sources': [
