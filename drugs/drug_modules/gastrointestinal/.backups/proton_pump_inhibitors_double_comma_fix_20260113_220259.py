...
"pregnancy": "B - Không có bằng chứng về nguy cơ ở người. Có thể sử dụng trong thai kỳ",
        ...
        ['Loét dạ dày tá tràng', 'GERD', 'Phòng ngừa loét do stress', 'Zollinger-Ellison syndrome'],contraindications': ['Dị ứng esomeprazole hoặc PPI'],dosage': {'adult_standard':
        ...
        'Ketoconazole: giảm hấp thu (cách xa 2 giờ)'],mechanism_of_action':
        ...
        'Loãng xương: PPI dùng kéo dài có thể tăng nguy cơ gãy xương (cần monitor nếu >1 năm)'],precautions': [
        ...
        'Thận trọng với clopidogrel (ức chế CYP2C19, có thể giảm hiệu quả clopidogrel)'],pharmacokinetics': {'half_life':
        ...
        'CHỐNG CHỈ ĐỊNH dùng cùng. Không dùng esomeprazole với atazanavir. Dùng H2 blocker hoặc cách thời gian 12 giờ.'}],moderate': [{'drug': 'Warfarin', 'mechanism':
        ...
        'Cách thời gian ít nhất 2 giờ. Hoặc dùng dạng lỏng posaconazole.'}],minor': []},contraindications': {'tuyệt_đối': [
        ...
        'Thiếu vitamin B12 - bổ sung nếu dùng lâu dài',
        'Thiếu magnesium - bổ sung nếu dùng lâu dài',
        'Dùng với clopidogrel - thận trọng (có thể giảm hiệu quả clopidogrel)'],pregnancy_details':
        ...
        'recommendation': 'Có thể dùng khi cho con bú. Dùng liều thường dùng (20-40mg/ngày).'}},hepatic_adjustment': {'mild': 'Không cần chỉnh liều', 'moderate':
        ...
        'notes':
        'Esomeprazole chuyển hóa ở gan nhưng ít phụ thuộc CYP2C19 hơn omeprazole. Thận trọng ở suy gan nặng.'},overdose_management': {'symptoms': [
        ...
        'timing':
        'Uống vào buổi sáng trước bữa sáng (hoặc trước bữa tối nếu dùng 2 lần/ngày). KHÔNG được nhai hoặc nghiền viên bao tan trong ruột - phải nuốt nguyên viên.'},iv': {'reconstitution':
        'Esomeprazole IV: 20-40mg pha với 100ml NaCl 0.9% hoặc dextrose 5%',
        'infusion_rate':
        'Truyền trong 10-30 phút', 'compatibility': ['NaCl 0.9%', 'Dextrose 5%'],incompatibility': [
        'Không pha với các thuốc khác trong cùng đường truyền'],notes':
        'Chỉ dùng IV khi không uống được. Chuyển sang PO sớm nhất có thể.'}},references': {'primary_sources': ['FDA Drug Label - Esomeprazole',
...
"pregnancy": "B - Không có bằng chứng về nguy cơ ở người. Có thể sử dụng trong thai kỳ",
        ...
        ['Loét dạ dày tá tràng', 'GERD', 'Phòng ngừa loét do stress', 'Zollinger-Ellison syndrome'],contraindications': ['Dị ứng lansoprazole hoặc PPI'],dosage': {'adult_standard':
        ...
        'Thận trọng ở bệnh nhân loãng xương (PPI dùng kéo dài có thể tăng nguy cơ gãy xương)',
        'Thận trọng ở bệnh nhân suy thận (không cần chỉnh liều nhưng monitor)',
        'Tăng nguy cơ viêm phổi, C. difficile colitis (đặc biệt ở người già, suy giảm miễn dịch)'],pharmacokinetics': {'half_life':
        ...
        'PPI làm tăng pH dạ dày, giảm hấp thu atazanavir (cần môi trường acid)',
        'effect': 'Giảm nồng độ atazanavir, giảm hiệu quả điều trị HIV', 'management':
        'CHỐNG CHỈ ĐỊNH dùng cùng. Không dùng lansoprazole với atazanavir. Dùng H2 blocker hoặc cách thời gian 12 giờ.'}],moderate': [{'drug': 'Warfarin', 'mechanism':
        ...
        'Theo dõi nồng độ theophylline và điều chỉnh liều nếu cần.'}],minor': []},contraindications': {'tuyệt_đối': [
        ...
        'Nhiễm C. difficile - tăng nguy cơ',
        'Thiếu vitamin B12 - bổ sung nếu dùng lâu dài',
        'Thiếu magnesium - bổ sung nếu dùng lâu dài'],pregnancy_details':
        ...
        'recommendation': 'Có thể dùng khi cho con bú. Dùng liều thường dùng (15-30mg/ngày).'}},hepatic_adjustment': {'mild': 'Không cần chỉnh liều', 'moderate':
        'Không cần chỉnh liều, nhưng thận trọng', 'severe':
        'Thận trọng ở suy gan nặng (Child-Pugh C). Có thể giảm liều. Lansoprazole chuyển hóa ở gan qua CYP2C19 và CYP3A4.',
        'notes':
        'Lansoprazole chuyển hóa ở gan. Suy gan có thể làm giảm chuyển hóa, tăng nồng độ. Thận trọng ở suy gan nặng.'},overdose_management': {'symptoms': [
        'PPI ít gây quá liều nghiêm trọng',
        'Triệu chứng nhẹ: nhức đầu, buồn nôn, tiêu chảy, chóng mặt'],antidote':
        'Không có antidote đặc hiệu', 'treatment': [
        'Hỗ trợ triệu chứng', 'Theo dõi dấu hiệu sinh tồn',
        ...
        'timing':
        'Uống vào buổi sáng trước bữa sáng. KHÔNG được nhai hoặc nghiền viên bao tan trong ruột - phải nuốt nguyên viên. Có thể mở viên nang và trộn với nước táo nếu bệnh nhân không nuốt được viên.'},iv': {'reconstitution': 'Không có dạng IV', 'infusion_rate': 'N/A',
        'compatibility': [],incompatibility': []}},references': {'primary_sources': ['FDA Drug Label - Lansoprazole',
        'UpToDate - Proton pump inhibitors: Overview of use and adverse effects',
...
"pregnancy": "B - Không có bằng chứng về nguy cơ ở người. Có thể sử dụng trong thai kỳ",
        ...
        ['Loét dạ dày tá tràng', 'GERD', 'Phòng ngừa loét do stress'],contraindications': ['Dị ứng'],dosage': {'adult_po':
        ...
        , 'recommendation':
        'Có thể dùng khi cho con bú. Dùng liều thường dùng (40mg/ngày).'}},hepatic_adjustment': {'mild': 'Không cần chỉnh liều', 'moderate':
        'Không cần chỉnh liều, nhưng thận trọng', 'severe':
        ...
        'PPI ít gây quá liều nghiêm trọng',
        'Triệu chứng nhẹ: nhức đầu, buồn nôn, tiêu chảy, chóng mặt'],antidote': 'Không có antidote đặc hiệu', 'treatment': [
        'Hỗ trợ triệu chứng', 'Theo dõi dấu hiệu sinh tồn',
        'Hầu hết trường hợp tự khỏi'],monitoring':
        'Theo dõi dấu hiệu sinh tồn, triệu chứng nhẹ'},reversal_agents': {'available': False, 'agents': [],notes': 'Không có antidote đặc hiệu. Điều trị quá liều chủ yếu là hỗ trợ triệu chứng.'},administration_instructions': {'oral': {'with_food':
        'Uống 30-60 phút TRƯỚC bữa ăn (quan trọng - để PPI hoạt động khi proton pump được kích hoạt)'
        , 'timing':
        ...
        'Không pha với các thuốc khác trong cùng đường truyền'],notes':
        'Chỉ dùng IV khi không uống được. Chuyển sang PO sớm nhất có thể.'}},pediatric_dosing': {
        ...
        'vietnam': ['Pantoloc', 'Pantoprazole Stada', 'Pantoprazole', 'Controloc'],common': ['Pantoloc', 'Protonix', 'Pantoprazole']
    },cost_estimate': {
        'unit': 'VND',
        ...
        'JAMA - Pantoprazole vs omeprazole and clopidogrel interaction (2010)'],last_updated': '2024-12-19', 'evidence_level':
