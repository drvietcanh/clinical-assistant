...
"pregnancy": "B - Không có bằng chứng về nguy cơ ở người",
        ...
        'Loét do stress'],contraindications': [
        ...
        'Khô miệng', 'Buồn nôn', 'Đầy hơi', 'Tích tụ nhôm (suy thận)'],interactions': ['PPI/H2 blocker/Antacid: giảm hiệu quả - cách 2 giờ',
        ...
        'Thyroxine: giảm hấp thu thyroxine'],mechanism_of_action':
        ...
        'Suy thận nặng (CrCl <30) - CHỐNG CHỈ ĐỊNH do tích tụ nhôm'],tương_đối': [
        'Suy thận trung bình (CrCl 30-60) - thận trọng, giảm liều, theo dõi chức năng thận'
        , 'Táo bón nặng - có thể làm nặng thêm',
        'Đang dùng nhiều thuốc - tăng nguy cơ tương tác hấp thu']},pregnancy_lactation': {'fda_category': 'B', 'pregnancy_details':
        ...
        'infusion_rate': 'N/A', 'compatibility': [],incompatibility': [],notes': 'Sucralfate chỉ có dạng uống, không có dạng IV'}},references': {'primary_sources': ['FDA Drug Label - Sucralfate',
