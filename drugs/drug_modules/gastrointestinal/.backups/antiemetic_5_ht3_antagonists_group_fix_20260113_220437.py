...
"pregnancy": "B - Không có bằng chứng về nguy cơ ở người. Sử dụng phổ biến trong thai kỳ",
        ...
        'Rất hiệu quả cho buồn nôn do hóa trị và phẫu thuật'},renal_adjustment': {'normal': 'Không đổi', '30_60': 'Không đổi',
        ...
        'CYP2D6 inhibitors: tăng nồng độ ondansetron'],mechanism_of_action':
        ...
        'management':
        'CHỐNG CHỈ ĐỊNH dùng cùng. Không dùng ondansetron với apomorphine.'}],moderate': [{'drug':
        ...
        'Thận trọng, giảm liều ondansetron nếu cần'}],minor': []},contraindications': {'tuyệt_đối': ['Dị ứng ondansetron',
        'Dùng với apomorphine - CHỐNG CHỈ ĐỊNH tuyệt đối',
        'QT kéo dài (QTc >450ms ở nam, >470ms ở nữ) - CHỐNG CHỈ ĐỊNH'],tương_đối': ['Suy gan nặng - giảm liều 50% (tối đa 8mg/ngày)',
        'Hạ kali, hạ magie - tăng nguy cơ QT kéo dài, bổ sung trước khi dùng',
        'Đang dùng thuốc kéo dài QT - thận trọng, giảm liều',
        'Người già - thận trọng, giảm liều', 'Rối loạn nhịp tim - thận trọng']},pregnancy_lactation': {'fda_category': 'B', 'pregnancy_details':
        ...
        'FDA Safety Communication - Ondansetron QT prolongation (2012)'],last_updated': '2024-12-19', 'evidence_level':
