...
"pregnancy": "C - Chứa salicylate, tránh trong thai kỳ",
        ...
        'Khó tiêu, đau bụng', 'Buồn nôn', 'Ợ chua'],contraindications': [
        'Dị ứng aspirin hoặc salicylates', 'Trẻ em <12 tuổi (nguy cơ hội chứng Reye)',
        'Dùng aspirin hoặc thuốc chống đông', 'Suy thận nặng'],dosage': {
        'adult_po': '524mg (2 viên hoặc 30ml) mỗi 30-60 phút (tối đa 8 liều/ngày)',
        'adult_max': '4.2g/ngày (8 liều)', 'notes':
        'Không dùng quá 2 ngày. Có thể làm phân đen (bình thường)'},side_effects': [
        ...
        'Nguy cơ chảy máu (nếu dùng với aspirin hoặc thuốc chống đông)'],interactions': [
        ...
        'Probenecid: giảm tác dụng probenecid'],mechanism_of_action':
        ...
        , 'Tương tác với tetracycline, quinolone (giảm hấp thu) - cần cách xa 2 giờ'],precautions': [
        ...
        , 'Nếu dùng với probenecid - giảm tác dụng probenecid'],pharmacokinetics': {
        ...
        'CHỐNG CHỈ ĐỊNH - không dùng cùng warfarin. Theo dõi INR nếu phải dùng.'}],moderate': [{'drug': 'Tetracycline, Quinolone (Ciprofloxacin, Levofloxacin)',
        ...
        'Tránh dùng cùng. Nếu phải dùng, tăng liều probenecid.'}],minor': []},contraindications': {'tuyệt_đối': [
        ...
        'Điều trị hội chứng Reye nếu có (hỗ trợ, điều trị triệu chứng)'],monitoring':
    ...
    "Loperamide": {'group': 'Gastrointestinal - Antidiarrheal',vietnamese_name':
        ...
        'Opioids: tăng tác dụng (ít dùng chung)'],mechanism_of_action':
        ...
        'Nếu dùng với kháng sinh → tăng nguy cơ viêm đại tràng giả mạc'],pharmacokinetics': {'half_life': '7-14 giờ', 'onset': '1-2 giờ',
        ...
        'management':
        'Tránh dùng cùng. Thận trọng nếu phải dùng cùng (giảm liều cả hai).'}],moderate': [{'drug':
        ...
        'management': 'Thận trọng, giảm liều loperamide'}],minor': []},contraindications': {'tuyệt_đối': ['Dị ứng loperamide',
