...
H2_RECEPTOR_ANTAGONISTS_DRUGS = {
    ...
    "Ranitidine": {'group': 'Gastrointestinal - H2 Receptor Antagonist',
        ...
        'Thận trọng, theo dõi nồng độ nếu cần'}]},
        'contraindications': {
        ...
        'notes': 'Ranitidine thải trừ một phần qua thận (30-50% thải nguyên dạng). Suy thận làm giảm thải trừ, tăng nồng độ thuốc. Cần giảm liều ở suy thận.'},
