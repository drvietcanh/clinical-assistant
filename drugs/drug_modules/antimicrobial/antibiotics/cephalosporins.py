...
CEPHALOSPORIN_ANTIBIOTICS = {
                ...
                },
    {
        ...
        "risk_flags": {
            ...
            "organ_toxicity": {
                "hepatic": "Low",
                "renal": "Low",
                "neurological": "High (co giật ở suy thận nặng)",
            },
        },
        "guideline_tags": [
            "IDSA Guidelines - Hospital-Acquired Pneumonia",
            ...
            "moderate": [
    {
        ...
        "risk_flags": {
            ...
            "organ_toxicity": {
                "hepatic": "Low",
                "renal": "Low",
                "neurological": "High (kernicterus ở trẻ sơ sinh)",
            },
        },
        "guideline_tags": [
                ...
                },
    {
        ...
        "pregnancy_lactation": {
            "fda_category": "B",
            "pregnancy_details": """An toàn. Được sử dụng rộng rãi trong thai kỳ để điều trị nhiễm trùng tiểu và hô hấp. Không có bằng chứng gây hại.""",
            "lactation": {
                "safety": "Compatible",
