...
SHORT_ACTING_BETA_2_AGONISTS_DRUGS = {
    "Salbutamol":     {
        ...
        "pharmacokinetics": {
            ...
            "bioavailability": "Thấp với dạng hít (tác dụng tại chỗ), cao với dạng uống/IV",
            "metabolism": "Gan - sulfation, glucuronidation, một phần qua CYP450",
                ...
                },
    {
        ...
        "reversal_agents": {
            "available": False,
            "agents": [],
            "notes": """Không có antidote đặc hiệu. Beta-blocker chọn lọc có thể đối kháng tác dụng nhưng thận trọng vì có thể gây co thắt phế quản.""",
        },
        "administration_instructions": {
            ...
            "iv": {
                ...
                "incompatibility": [
                    "Không trộn với các thuốc khác trong cùng một ống truyền"
    ],
        ...
        "pediatric_dosing": {
            ...
            "infants": "0.5-1 puffs (50-100mcg) mỗi 4-6 giờ khi cần. Nebulizer: 1.25-2.5mg mỗi 4-6 giờ",
            "children": "1-2 puffs (100-200mcg) mỗi 4-6 giờ khi cần. Nebulizer: 2.5-5mg mỗi 4-6 giờ",
            "adolescents": "1-2 puffs (100-200mcg) mỗi 4-6 giờ khi cần. Nebulizer: 2.5-5mg mỗi 4-6 giờ",
            "notes": """Chỉ dùng khi cần (PRN) cho cắt cơn. Nếu cần >4 lần/ngày → đánh giá lại điều trị. Dạng hít được ưu tiên.""",
        },
        "geriatric_dosing": {
            "considerations": "Người cao tuổi có thể nhạy cảm hơn với tác dụng tim mạch (nhịp tim nhanh, loạn nhịp)",
            "dose_adjustment": "Bắt đầu với liều thấp (1 puff). Theo dõi chặt chẽ nhịp tim, huyết áp",
            "monitoring": """Theo dõi nhịp tim, huyết áp, ECG nếu có bệnh tim mạch. Thận trọng với bệnh nhân có bệnh tim mạch, tăng huyết áp""",
        },
        "brand_names": {
            "vietnam": [
                "Salbutamol",
        ...
        "cost_estimate": {
            "unit": "VND",
            "range": "15,000 - 50,000 VND/ống (MDI 200 liều), 5,000 - 15,000 VND/ống nebulizer",
            "note": "Giá thay đổi theo thương hiệu. Ventolin (GSK) thường đắt hơn generic. Nebulizer solution rẻ hơn MDI.",
        },
        "references": {
            "primary_sources": [
