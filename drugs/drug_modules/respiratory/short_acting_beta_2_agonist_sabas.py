...
SHORT_ACTING_BETA_2_AGONIST_(SABA)S_DRUGS = {
    ...
    "Terbutaline": {'group': 'Respiratory - Short-acting Beta-2 Agonist (SABA)',
        ...
        'Dự phòng co thắt do vận động'], 'contraindications': ['Dị ứng',
        'Nhịp tim nhanh nặng'], 'dosage': {'adult_inhalation':
        '250-500mcg (1-2 puffs) mỗi 4-6 giờ khi cần', 'adult_nebulizer':
        '5mg mỗi 4-6 giờ', 'adult_sc':
        '0.25-0.5mg SC (đợt cấp nặng, không có khí dung)', 'adult_po':
        '2.5-5mg x 3 lần/ngày', 'notes':
        'Dùng khi cần (PRN) cho cắt cơn. Dạng SC dùng trong cấp cứu khi không có khí dung.'},
        'side_effects': ['Tim đập nhanh', 'Run cơ', 'Đau đầu',
        'Hạ kali máu (liều cao)', 'Loạn nhịp tim (hiếm)'], 'interactions': [
        'Beta-blocker: đối kháng tác dụng (tránh dùng)'], 'pregnancy': 'C',
        'mechanism_of_action':
        'Kích thích beta-2 adrenergic receptors ở cơ trơn phế quản, kích hoạt adenylate cyclase → tăng cAMP → giãn cơ trơn phế quản. Tác dụng nhanh, ngắn (4-6 giờ). Tương tự salbutamol nhưng có thể dùng dạng SC trong cấp cứu. Chọn lọc beta-2 hơn beta-1 nhưng vẫn có tác dụng tim mạch ở liều cao. Giảm phóng thích chất trung gian gây viêm từ mast cells.'
        , 'monitoring': [
        ...
        'Rửa miệng sau khi dùng dạng hít để giảm kích ứng và nấm miệng',
        'Nếu không đáp ứng → cần đánh giá lại chẩn đoán và điều trị'],
        'pharmacokinetics': {'half_life': '3-4 giờ (hít), 2-3 giờ (SC)',
        'onset': '5-15 phút (hít), 5-10 phút (SC)', 'duration': '4-6 giờ',
        'protein_binding': '25%', 'clearance':
        'Gan (chuyển hóa qua sulfation, một phần qua CYP450), thận (thải trừ)'},
        'storage':
        'Bảo quản ở nhiệt độ phòng (15-30°C), tránh nhiệt độ cao, tránh ánh sáng trực tiếp. Không làm lạnh. Kiểm tra hạn sử dụng định kỳ.'
        , 'black_box_warnings':
