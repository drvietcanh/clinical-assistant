...
"pregnancy": "B - Không có bằng chứng về nguy cơ ở người",
        'vietnamese_name': 'Montelukast, Singulair', 'administration': ['PO'],indications': ['Hen phế quản (phòng ngừa)', 'Viêm mũi dị ứng',
        ...
        'Thay đổi tâm trạng (hiếm)', 'Phản ứng tâm thần (rất hiếm)'],interactions': ['Phenobarbital: giảm nồng độ montelukast',
        'Rifampin: giảm nồng độ montelukast'],mechanism_of_action':
        ...
        'Tương tác với phenobarbital, rifampin (giảm nồng độ montelukast)'],precautions': [
        ...
        'Theo dõi chặt chẽ ở trẻ em và thanh thiếu niên về rối loạn tâm thần'],pharmacokinetics': {'half_life': '2.7-5.5 giờ', 'onset':
        ...
        'Rối loạn tâm thần (trầm cảm, lo âu, rối loạn hành vi) - thận trọng, theo dõi chặt chẽ'
        , 'Tiền sử tự sát - thận trọng, theo dõi chặt chẽ',
        'Dùng với phenobarbital, rifampin - có thể giảm hiệu quả']},renal_adjustment': {'normal': 'Không cần chỉnh liều', '30_60': 'Không cần chỉnh liều',
        'under_30': 'Không cần chỉnh liều', 'dialysis': 'Không cần chỉnh liều',
        'notes': 'Montelukast chuyển hóa qua gan, thải trừ một phần qua thận. Không cần điều chỉnh liều ở suy thận.'},pregnancy_lactation': {'fda_category': 'B', 'pregnancy_details':
        ...
        , 'recommendation': 'Có thể dùng an toàn khi cho con bú.'}},hepatic_adjustment': {'mild': 'Không đổi', 'moderate': 'Không đổi',
        ...
        'Rối loạn tâm thần (hiếm)'],treatment': ['Ngừng ngay montelukast',
        'Hỗ trợ và điều trị triệu chứng',
        ...
        'Micromedex: Montelukast'],evidence_level':
        'High - FDA approved, multiple RCTs, clinical guidelines'}},
    "Nedocromil": {'group': 'Respiratory - Mast Cell Stabilizer',,
"pregnancy": "B - Không có bằng chứng về nguy cơ ở người",
        'vietnamese_name': 'Nedocromil, Tilade', 'administration': ['Inhalation'],indications': ['Hen phế quản (phòng ngừa)', 'Viêm mũi dị ứng'],contraindications': ['Dị ứng nedocromil'],dosage': {
        ...
        'Buồn nôn (hiếm)'],interactions': ['Ít tương tác'],mechanism_of_action':
        ...
        ,         'black_box_warnings': None, 'drug_interactions': {'major': [],moderate': [],minor': []},contraindications': {'tuyệt_đối': [
        ...
        'Dị ứng với nedocromil hoặc các thành phần khác'],tương_đối': [
        'Trẻ em <6 tuổi - an toàn từ 6 tuổi trở lên']},pregnancy_lactation': {'fda_category': 'B', 'pregnancy_details':
        ...
        , 'recommendation': 'Có thể dùng an toàn khi cho con bú.'}},hepatic_adjustment': {'mild': 'Không đổi', 'moderate': 'Không đổi',
        'severe': 'Không đổi', 'notes':
        'Hấp thu toàn thân ít từ dạng hít. Không cần điều chỉnh liều ở suy gan.'},overdose_management': {'symptoms': [
        ...
        'Theo dõi: vị đắng, ho, kích ứng họng. Theo dõi ít nhất vài giờ.'},reversal_agents': {'available': False, 'agents': [],notes':
        'Không có antidote đặc hiệu. Điều trị chủ yếu là hỗ trợ và điều trị triệu chứng.'},administration_instructions': {'oral': None, 'iv': None, 'inhalation': {
        'technique':
        ...
        'notes':
        'Không dùng cho cắt cơn cấp - cần SABA (salbutamol) cho cơn cấp. Tác dụng phát huy sau vài ngày đến vài tuần.'}},references': {'primary_sources': [
        'FDA Label: Tilade (Nedocromil)',
        'UpToDate: Mast cell stabilizers in asthma'],evidence_level': 'High - FDA approved'},
