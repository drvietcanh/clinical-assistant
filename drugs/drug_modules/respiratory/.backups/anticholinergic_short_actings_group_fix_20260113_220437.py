...
"pregnancy": "B - Không có bằng chứng về nguy cơ ở người",
        ', 'vietnamese_name':
        'Ipratropium, Atrovent', 'administration': ['Inhalation', 'Nebulizer'],indications': ['COPD (cắt cơn và phòng ngừa)',
        'Hen phế quản (kết hợp với SABA)', 'Co thắt phế quản',
        'Chảy nước mũi (dạng xịt mũi)'],contraindications': [
        'Dị ứng atropine/ipratropium', 'Glaucoma góc đóng', 'Tăng nhãn áp'],dosage': {'adult_inhalation': '1-2 puffs (20-40mcg) mỗi 6-8 giờ',
        ...
        'under_30': 'Không đổi'},side_effects': ['Khô miệng', 'Đắng miệng',
        ...
        'Dùng với anticholinergic khác - tăng tác dụng phụ']},pregnancy_lactation': {'fda_category': 'B', 'pregnancy_details':
