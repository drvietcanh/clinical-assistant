...
"pregnancy": "C - Corticosteroid, thận trọng trong thai kỳ",
        ...
        'Ketoconazole/Itraconazole: tăng nồng độ'],mechanism_of_action':
        ...
        'Tương tác với ritonavir, ketoconazole, itraconazole (tăng nồng độ beclomethasone)'],precautions': [
        ...
        'management':
        'TRÁNH DÙNG với ritonavir. Nếu cần dùng, giảm liều beclomethasone đáng kể và theo dõi chặt chẽ.'}],moderate': [{'drug': 'Ketoconazole, Itraconazole', 'mechanism':
        'Ức chế CYP3A4, tăng nồng độ beclomethasone', 'effect':
        'Tăng nguy cơ tác dụng toàn thân, ức chế HPA', 'management':
        'Thận trọng, theo dõi tác dụng toàn thân. Có thể cần giảm liều beclomethasone.'}],minor': []},contraindications': {'tuyệt_đối': [
        ...
        'Điều trị tăng đường huyết nếu cần', 'Theo dõi và điều trị triệu chứng'],monitoring':
...
"pregnancy": "B - Corticosteroid, có thể sử dụng trong thai kỳ",
        ', 'vietnamese_name':
        'Budesonide, Pulmicort', 'administration': ['Inhalation', 'Nebulizer'],indications': ['Hen phế quản (kiểm soát, phòng ngừa)',
        'COPD (nếu có nhiều đợt cấp)', 'Viêm phế quản co thắt'],contraindications': ['Nhiễm trùng đường hô hấp nặng chưa điều trị',
        ...
        'Nhiễm trùng đường hô hấp nặng chưa điều trị (lao phổi, nấm)'],tương_đối': ['Lao phổi - cần điều trị lao trước, thận trọng',
        'Nhiễm trùng đường hô hấp - cần điều trị nhiễm trùng trước',
        'Dùng với ritonavir - tránh dùng',
        'Dùng với ketoconazole, itraconazole - thận trọng']},contraindications_detail': {'tuyệt_đối': [
        'Dị ứng với budesonide hoặc các thành phần khác',
...
"pregnancy": "C - Corticosteroid, thận trọng trong thai kỳ",
        ...
        'under_30': 'Không đổi'},side_effects': ['Nấm miệng (candidiasis)',
        'Khàn tiếng', 'Ho', 'Khô miệng', 'Tác dụng toàn thân (liều cao)'],interactions': [
...
"pregnancy": "C - Corticosteroid, thận trọng trong thai kỳ",
        ', 'vietnamese_name':
        'Fluticasone, Flixotide', 'administration': ['Inhalation'],indications': ['Hen phế quản (kiểm soát, phòng ngừa)',
        'COPD (kết hợp với LABA nếu nhiều đợt cấp)'],contraindications': [
        'Nhiễm trùng đường hô hấp nặng', 'Dị ứng'],dosage': {
        ...
        'Súc miệng sau khi dùng. Thường dùng kết hợp với LABA (Salmeterol)'},renal_adjustment': {'normal': 'Không đổi', '30_60': 'Không đổi',
        'under_30': 'Không đổi'},side_effects': ['Nấm miệng', 'Khàn tiếng',
