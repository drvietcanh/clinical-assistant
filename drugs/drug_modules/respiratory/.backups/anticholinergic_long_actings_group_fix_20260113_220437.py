...
ANTICHOLINERGIC_LONG_ACTINGS_DRUGS = {
    "Aclidinium": {'group': 'Respiratory - Anticholinergic (Long-acting)',vietnamese_name': 'Aclidinium, Tudorza Pressair', 'administration': [
        'Inhalation (DPI)'],indications': [
        'COPD (phòng ngừa, đơn trị hoặc kết hợp với formoterol)'],contraindications': ['Dị ứng atropine/aclidinium', 'Glaucoma góc đóng',
        ...
        , 'Dấu hiệu khô miệng nặng (có thể ảnh hưởng sức khỏe răng miệng)'],precautions': [
        ...
        'Có thể dùng kết hợp với formoterol (LABA) trong fixed-dose combination'],pharmacokinetics': {'half_life': '5-8 giờ', 'onset': '15-30 phút',
        ...
        'Có thể dùng kết hợp để tăng hiệu quả. Không cần điều chỉnh liều.'}]},contraindications': {'tuyệt_đối': [
        'Dị ứng với aclidinium, atropine hoặc các thành phần khác',
        'Glaucoma góc đóng (chống chỉ định tuyệt đối)',
        'Tăng nhãn áp nặng không kiểm soát'],tương_đối': [
    ...
    "Glycopyrronium": {'group': 'Respiratory - Anticholinergic (Long-acting)',vietnamese_name': 'Glycopyrronium, Glycopyrrolate, Seebri Breezhaler',
        'administration': ['Inhalation (DPI)'],indications': [
        'COPD (phòng ngừa, kết hợp với indacaterol)'],contraindications': ['Dị ứng atropine/glycopyrronium', 'Glaucoma góc đóng',
        'Tăng nhãn áp', 'Phì đại tuyến tiền liệt nặng'],dosage': {
        ...
        'Dạng hít: sử dụng đúng kỹ thuật để đạt hiệu quả tối đa',
        'An toàn hơn beta-agonist cho bệnh nhân tim mạch (không kích thích tim)',
        'Không dùng để cắt cơn (tác dụng chậm) - cần có SABA để cắt cơn'],pharmacokinetics': {'half_life': '2-3 giờ (ngắn hơn tiotropium)',
    ...
    "Tiotropium": {'group': 'Respiratory - Anticholinergic (Long-acting)',vietnamese_name':
        ...
        'COPD (phòng ngừa)',
        'Hen phế quản (kết hợp với ICS, nếu không kiểm soát)'],contraindications': ['Dị ứng atropine/tiotropium', 'Glaucoma góc đóng',
        'Tăng nhãn áp', 'Phì đại tuyến tiền liệt nặng'],dosage': {
        'adult_handihaler': '18mcg x 1 lần/ngày', 'adult_respimat':
        '5mcg x 2 lần/ngày (sáng và tối)', 'notes':
        'Tác dụng kéo dài 24 giờ. Dùng 1 lần/ngày với HandiHaler'},renal_adjustment': {'normal': 'Không đổi', '30_60': 'Thận trọng',
        ...
        'Dạng hít: sử dụng đúng kỹ thuật để đạt hiệu quả tối đa',
        'An toàn hơn beta-agonist cho bệnh nhân tim mạch (không kích thích tim)',
        'Không dùng để cắt cơn (tác dụng chậm) - cần có SABA để cắt cơn'],pharmacokinetics': {'half_life':
        ...
        'Suy thận nặng (CrCl <30 ml/min) - tích lũy, tăng tác dụng phụ'],tương_đối': ['Glaucoma góc mở - thận trọng, theo dõi nhãn áp',
        'Tăng nhãn áp nhẹ - thận trọng, tránh để thuốc vào mắt',
        'Phì đại tuyến tiền liệt nặng - có thể gây bí tiểu',
        'Bí tiểu - có thể làm nặng', 'Táo bón nặng - có thể làm nặng',
        'Suy thận trung bình (CrCl 30-60 ml/min) - thận trọng, theo dõi tác dụng phụ'
        ...
        'Hỗ trợ hô hấp nếu cần (hiếm)',
        'Physostigmine chỉ dùng trong trường hợp quá liều nghiêm trọng với tác dụng toàn thân (thận trọng, có hỗ trợ hô hấp)'
        , 'Lưu ý: Thời gian bán thải rất dài (5-6 ngày) → theo dõi kéo dài'],monitoring':
...
"pregnancy": "C - Nguy cơ không thể loại trừ. Thận trọng trong thai kỳ",
        ...
        'administration': ['Inhalation (DPI)'],indications': [
        'COPD (phòng ngừa, kết hợp với vilanterol hoặc vilanterol/fluticasone)'],contraindications': ['Dị ứng atropine/umeclidinium', 'Glaucoma góc đóng',
        'Tăng nhãn áp', 'Phì đại tuyến tiền liệt nặng'],dosage': {
        ...
        'Dấu hiệu bí tiểu (khó tiểu, đầy bụng) - đặc biệt ở bệnh nhân phì đại tuyến tiền liệt'
        , 'Dấu hiệu khô miệng nặng (có thể ảnh hưởng sức khỏe răng miệng)',
        'Nấm miệng (nếu dùng với fluticasone) - súc miệng sau khi dùng'],precautions': [
        'Rửa miệng sau khi dùng để giảm kích ứng và tránh thuốc vào mắt',
        'Tránh để thuốc vào mắt (có thể gây tăng nhãn áp, đặc biệt ở bệnh nhân glaucoma)'
        'Thận trọng ở bệnh nhân glaucoma góc đóng (chống chỉ định) hoặc tăng nhãn áp'
        'Thận trọng ở bệnh nhân phì đại tuyến tiền liệt nặng (có thể gây bí tiểu)',
        ...
        'Súc miệng sau khi dùng để tránh nấm miệng (nếu dùng Trelegy)'],pharmacokinetics': {'half_life': '11 giờ', 'onset': '5-15 phút',
        ...
        'Glaucoma góc đóng (chống chỉ định tuyệt đối)',
        'Tăng nhãn áp nặng không kiểm soát',
        'Dùng với ritonavir (nếu dùng Trelegy) - chống chỉ định tuyệt đối'],tương_đối': [
        'Glaucoma góc mở - thận trọng, theo dõi nhãn áp',
        'Tăng nhãn áp nhẹ - thận trọng, tránh để thuốc vào mắt',
        'Phì đại tuyến tiền liệt nặng - có thể gây bí tiểu',
        'Bí tiểu - có thể làm nặng', 'Táo bón nặng - có thể làm nặng',
