...
"pregnancy": "C - Nguy cơ không thể loại trừ. Thận trọng trong thai kỳ",
        ...
        'Co thắt phế quản ban đêm', 'Dự phòng co thắt do vận động'],contraindications': ['Dị ứng', 'Nhịp tim nhanh nặng',
        ...
        'Đau đầu', 'Co thắt phế quản nghịch lý (hiếm)', 'Loạn nhịp tim (hiếm)'],interactions': ['Beta-blocker: đối kháng tác dụng',
        'Theophylline: tăng tác dụng phụ'],mechanism_of_action':
        ...
        , 'notes':
        'Formoterol chuyển hóa qua CYP2D6, CYP2C19, và glucuronidation ở gan. Ở suy gan nặng, có thể tích lũy và tăng tác dụng phụ. Theo dõi chặt chẽ nhịp tim và tác dụng phụ. Có thể cần giảm liều hoặc tăng khoảng cách giữa các liều.'},overdose_management': {'symptoms': [
        ...
        'caution':
        'Thận trọng vì có thể làm nặng co thắt phế quản. Chỉ dùng khi tác dụng tim mạch nghiêm trọng và có hỗ trợ hô hấp sẵn sàng.'}],notes':
        'Không có antidote đặc hiệu. Điều trị chủ yếu là hỗ trợ và điều trị triệu chứng. Beta-blocker chọn lọc beta-1 có thể được dùng để đối kháng tác dụng tim mạch nhưng thận trọng.'},administration_instructions': {'oral': None, 'iv': None, 'inhalation': {
        'technique':
        ...
        , 'notes':
        'Tác dụng nhanh hơn salmeterol (5 phút vs 15-30 phút) - có thể dùng để cắt cơn nhẹ, nhưng vẫn nên dùng SABA (salbutamol) cho cơn cấp. Nếu cần dùng SABA thường xuyên → cần đánh giá lại điều trị.'}},references': {'primary_sources': ['FDA Label: Foradil (Formoterol)',
        'UpToDate: Long-acting beta-2 agonists in asthma',
        'GINA Guidelines 2024: Asthma Management',
        "Goodman & Gilman's The Pharmacological Basis of Therapeutics",
        'Micromedex: Formoterol'],evidence_level':
        'High - FDA approved, multiple RCTs, clinical guidelines'},risk_flags': {
            'high_alert': True,
            'narrow_therapeutic_index': False,
            'icu_critical_care_only': False,
            'bleeding_risk': False,
            'organ_toxicity': ['cardiac'],qt_prolongation': True,
    ...
    "Indacaterol": {'group': 'Respiratory - Long-acting Beta-2 Agonist (LABA)',vietnamese_name': 'Indacaterol, Onbrez Breezhaler, Arcapta Neohaler',
        'administration': ['Inhalation (DPI)'],indications': [
        'COPD (phòng ngừa, đơn trị hoặc kết hợp với LAMA)',
        'Hen phế quản (phòng ngừa, phải dùng với ICS)'],contraindications': ['Dị ứng indacaterol',
        'Nhịp tim nhanh nặng', 'Hen phế quản cấp (không dùng đơn độc)'],dosage': {'adult_inhalation': '75-150mcg x 1 lần/ngày', 'notes':
        ...
        'Beta-blocker: đối kháng tác dụng', 'Theophylline: tăng tác dụng phụ'],pregnancy': 'C', 'mechanism_of_action':
        ...
        'Rửa miệng sau khi dùng dạng hít để giảm kích ứng và nấm miệng',
        'Nếu cần dùng SABA thường xuyên → cần đánh giá lại điều trị và tăng ICS',
        'Nếu không đáp ứng → cần đánh giá lại chẩn đoán và điều trị'],pharmacokinetics': {'half_life': '45.5-126 giờ (rất dài)',
        ...
        'Đái tháo đường - có thể tăng đường huyết',
        'Hạ kali máu - có thể làm nặng',
        'Cường giáp - tăng nhạy cảm với catecholamine']},pregnancy_lactation': {'fda_category': 'C', 'pregnancy_details':
        ...
        'GINA Guidelines 2024: Asthma Management',
        "Goodman & Gilman's The Pharmacological Basis of Therapeutics",
        'Micromedex: Indacaterol'],evidence_level': 'High - FDA approved, multiple RCTs, clinical guidelines'},risk_flags': {
            'high_alert': True,
            'narrow_therapeutic_index': False,
            'icu_critical_care_only': False,
            'bleeding_risk': False,
...
"pregnancy": "C - Nguy cơ không thể loại trừ. Thận trọng trong thai kỳ",
        ...
        'Inhalation'],indications': [
        'COPD (phòng ngừa)', 'Hen phế quản (phải dùng với ICS)'],contraindications': ['Dị ứng', 'Nhịp tim nhanh nặng',
        'Hen phế quản cấp (không dùng đơn độc)'],dosage': {'adult_inhalation':
        ...
        'Theo dõi nồng độ theophylline và nhịp tim.'}],minor': []},contraindications': {'tuyệt_đối': [
        ...
        , 'notes': 'Theo dõi chặt chẽ nhịp tim và tác dụng phụ ở suy gan nặng.'},overdose_management': {'symptoms': [
        ...
        'Theo dõi nhịp tim, huyết áp, ECG liên tục',
        'Điều trị loạn nhịp tim nếu có', 'Bổ sung kali nếu hạ kali máu'],monitoring':
        ...
        'Không có antidote đặc hiệu. Điều trị chủ yếu là hỗ trợ.'},administration_instructions': {'oral': None, 'iv': None, 'inhalation': {
        'technique':
        ...
        'notes': 'Không dùng để cắt cơn. Luôn có SABA sẵn sàng.'}},references': {'primary_sources': [
        'FDA Label: Striverdi (Olodaterol)',
        'UpToDate: Long-acting beta-2 agonists in COPD',
        'GOLD Guidelines 2024: COPD Management'],evidence_level': 'High - FDA approved, clinical guidelines'},risk_flags': {
            'high_alert': True,
            'narrow_therapeutic_index': False,
            'icu_critical_care_only': False,
            'bleeding_risk': False,
...
"pregnancy": "C - Nguy cơ không thể loại trừ. Thận trọng trong thai kỳ",
        ...
        'Rửa miệng sau khi dùng dạng hít để giảm kích ứng và nấm miệng',
        'Nếu cần dùng SABA thường xuyên → cần đánh giá lại điều trị và tăng ICS',
        'Nếu không đáp ứng → cần đánh giá lại chẩn đoán và điều trị'],pharmacokinetics': {'half_life': '5.5 giờ (dài hơn salbutamol)',
        ...
        'GINA Guidelines 2024: Asthma Management',
        "Goodman & Gilman's The Pharmacological Basis of Therapeutics",
        'Micromedex: Salmeterol'],evidence_level':
        'High - FDA approved, multiple RCTs, clinical guidelines'},risk_flags': {
            'high_alert': True,
            'narrow_therapeutic_index': False,
            'icu_critical_care_only': False,
...
"pregnancy": "C - Nguy cơ không thể loại trừ. Thận trọng trong thai kỳ",
        ...
        'under_30': 'Không đổi'},side_effects': ['Tim đập nhanh', 'Run cơ',
        'Đau đầu', 'Nấm miệng (do ICS)', 'Co thắt phế quản nghịch lý (hiếm)'],interactions': ['Beta-blocker: đối kháng tác dụng',
        'Ritonavir: tăng nồng độ fluticasone (tránh dùng)'],mechanism_of_action':
        ...
        'Đối kháng tác dụng giãn phế quản', 'management':
        'TRÁNH DÙNG với beta-blocker không chọn lọc.'}],moderate': [],minor': []},contraindications': {'tuyệt_đối': [
        ...
        , 'notes': 'Theo dõi chặt chẽ nhịp tim và tác dụng phụ ở suy gan nặng.'},overdose_management': {'symptoms': [
        'Nhịp tim nhanh nghiêm trọng', 'Run cơ nặng', 'Loạn nhịp tim',
        'Co thắt phế quản nghịch lý'],treatment': [
