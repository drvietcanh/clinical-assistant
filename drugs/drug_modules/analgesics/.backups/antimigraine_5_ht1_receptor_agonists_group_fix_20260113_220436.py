...
"pregnancy": "C - Nguy cơ không thể loại trừ. Thận trọng trong thai kỳ",
        ...
        'ODT'],indications': [
        'Migraine có tiền triệu (aura) hoặc không', 'Cluster headache'],contraindications': ['Bệnh mạch vành', 'Nhồi máu cơ tim',
        'Đau thắt ngực không ổn định', 'Đột quỵ, TIA',
        'Bệnh mạch máu ngoại biên', 'Tăng huyết áp không kiểm soát',
        'Dùng MAO inhibitor trong 14 ngày', 'Dùng ergotamine trong 24 giờ'],dosage': {'adult_po': '5-10mg, có thể lặp sau 2 giờ (tối đa 30mg/ngày)',
        'adult_odt': '5-10mg ODT, có thể lặp sau 2 giờ (tối đa 30mg/ngày)',
        'notes':
        'Dùng ngay khi có triệu chứng migraine. Nếu dùng với propranolol: giảm liều 50% (5mg thay vì 10mg)'},renal_adjustment': {'normal': 'Không đổi', '30_60': 'Không đổi',
        'under_30': 'Thận trọng'},side_effects': [
        'Đau ngực, khó thở (tương tự đau thắt ngực)', 'Nhức đầu', 'Chóng mặt',
        'Buồn nôn', 'Yếu, mệt mỏi', 'Nguy cơ đau tim (hiếm nhưng nguy hiểm)'],interactions': [
        ...
        'SSRI/SNRI: tăng nguy cơ hội chứng serotonin'],mechanism_of_action':
        ...
        'GIẢM LIỀU RIZATRIPTAN 50% (5mg thay vì 10mg) khi dùng với propranolol.'}],moderate': [{'drug': 'SSRI/SNRI (Fluoxetine, Sertraline, Venlafaxine)',
        ...
        , 'management':
        'Thận trọng, theo dõi dấu hiệu hội chứng serotonin. Có thể cần tránh dùng cùng.'}],minor': []},contraindications': {'tuyệt_đối': [
...
"pregnancy": "C - Nguy cơ không thể loại trừ. Thận trọng trong thai kỳ",
        ...
        'Đau thắt ngực không ổn định', 'Đột quỵ, TIA',
        'Bệnh mạch máu ngoại biên', 'Tăng huyết áp không kiểm soát',
        'Dùng MAO inhibitor trong 14 ngày', 'Dùng ergotamine trong 24 giờ'],dosage': {'adult_po':
        ...
        'Dùng ngay khi có triệu chứng migraine. Không dùng để phòng ngừa'},renal_adjustment': {'normal': 'Không đổi', '30_60': 'Không đổi',
        'under_30': 'Thận trọng'},side_effects': [
        ...
        'Thuốc ức chế CYP2D6: tăng nồng độ sumatriptan'],mechanism_of_action':
        ...
        'management':
        'CHỐNG CHỈ ĐỊNH - không dùng với MAO inhibitor trong 14 ngày.'}],moderate': [{'drug': 'SSRI/SNRI (Fluoxetine, Sertraline, Venlafaxine)',
        'mechanism':
