...
OPIOID_AGONIST_STRONGS_DRUGS = {
    ...
    "Morphine": {'group': 'Analgesic - Opioid Agonist (Strong)',vietnamese_name':
        ...
        'Đau mạn tính nặng', 'Khó thở do suy tim', 'Cơn đau do hồi sức'],contraindications': ['Ngộ độc cấp tính rượu, thuốc an thần, opioid',
        ...
        'notes': 'Thuốc chuẩn vàng cho đau nặng. Theo dõi hô hấp chặt chẽ'},renal_adjustment': {'normal': 'Không đổi', '30_60': 'Giảm liều 25-50%',
        ...
        'Dấu hiệu táo bón (rất thường gặp, cần dự phòng)',
        'Dấu hiệu nghiện/lệ thuộc (nếu dùng kéo dài)',
        'Chức năng thận (tích lũy ở suy thận do tích tụ active metabolite)'],precautions': [
        ...
        'Không dùng trong tắc ruột cơ học (tăng trương lực cơ thắt)'],pharmacokinetics': {'half_life': '2-4 giờ', 'onset':
        'IV: 5-10 phút; IM: 15-30 phút; PO: 30-60 phút', 'duration':
        '3-7 giờ (IV), 4-7 giờ (IM), 3-6 giờ (PO)', 'protein_binding': '20-35%',
        'clearance':
        'Chủ yếu qua thận (morphine-6-glucuronide tích lũy ở suy thận)'},storage':
        ...
        'management':
        'CHỐNG CHỈ ĐỊNH. Ngừng MAOI ít nhất 14 ngày trước khi dùng morphine'}],moderate': [{'drug': 'Cimetidine', 'mechanism':
        ...
        'Thận trọng. Giảm liều morphine, theo dõi hô hấp'}],minor': []},contraindications': {'tuyệt_đối': ['Dị ứng morphine hoặc opioid',
        'Ngộ độc cấp tính rượu, thuốc an thần, opioid',
        'Suy hô hấp nặng hoặc suy hô hấp cấp tính',
        ...
        'Tiền sử nghiện/lạm dụng chất - nguy cơ tái nghiện',
        'Suy tim - tăng nguy cơ ức chế hô hấp',
        'Bệnh phổi tắc nghẽn mạn tính (COPD) - tăng nguy cơ ức chế hô hấp']},pregnancy_lactation': {'fda_category': 'C - D trong tam cá nguyệt 3',
        'pregnancy_details':
        ...
        'High - FDA-approved, extensive clinical data, gold standard for severe pain'
            ...
            'narrow_therapeutic_index': False,
            'bleeding_risk': False,
            'organ_toxicity': ['Respiratory depression (life-threatening)', 'Accumulation of active metabolite (morphine-6-glucuronide) in renal failure'],qt_prolongation': False,
            'hepatotoxicity': False,
            'nephrotoxicity': False,
