...
NSAIDS_DRUGS = {
    ...
    "Celecoxib": {'group': 'Analgesic - NSAID (COX-2 Selective)',vietnamese_name':
        ...
        'COX-2 selective, ít tác dụng phụ dạ dày nhất. Tăng nguy cơ tim mạch'},renal_adjustment': {'normal': 'Không đổi', '30_60':
        ...
        'Giảm liều celecoxib 50% khi dùng với fluconazole. Theo dõi tác dụng phụ.'}],moderate': [{'drug': 'ACE inhibitor, ARB', 'mechanism':
        ...
        'Người cao tuổi - tăng nguy cơ tác dụng phụ, đặc biệt biến cố tim mạch']},pregnancy_lactation': {'fda_category': 'C - D trong tam cá nguyệt 3',
        'pregnancy_details':
        ...
        'Celecoxib chuyển hóa ở gan qua CYP2C9. Suy gan làm giảm chuyển hóa, tăng nguy cơ tích lũy. Tương tác với fluconazole (ức chế CYP2C9) làm tăng nồng độ celecoxib.'},overdose_management': {'symptoms': ['Buồn nôn, nôn, đau bụng',
        'Chóng mặt, nhức đầu', 'Lú lẫn, buồn ngủ', 'Hạ huyết áp', 'Suy thận cấp',
        'Chảy máu dạ dày', 'Biến cố tim mạch (đau ngực, khó thở)', 'Co giật (hiếm)'],antidote': 'Không có antidote đặc hiệu', 'treatment': [
        'Rửa dạ dày nếu uống trong vòng 1-2 giờ',
        'Than hoạt tính nếu uống trong vòng 1-2 giờ',
        ...
        'Theo dõi dấu hiệu chảy máu dạ dày', 'Điều trị hỗ trợ triệu chứng'],monitoring':
        ...
        'Không có antidote đặc hiệu. Điều trị chủ yếu là hỗ trợ và điều trị triệu chứng. Ngừng thuốc ngay. Điều trị chảy máu dạ dày và biến cố tim mạch nếu có. Bù nước và điện giải nếu cần.'},administration_instructions': {'oral': {'with_food':
        ...
        "Goodman & Gilman's Pharmacological Basis of Therapeutics, 14th ed"],last_updated': '2025-02-05',
    ...
    "Diclofenac": {'group': 'Analgesic - NSAID',vietnamese_name': 'Diclofenac, Voltaren',
        ...
        'Đau nhẹ đến trung bình', 'Viêm khớp dạng thấp', 'Viêm khớp xương khớp',
        'Đau sau phẫu thuật', 'Đau do chấn thương', 'Viêm gân (topical)'],contraindications': ['Loét dạ dày tá tràng đang hoạt động',
        'Suy thận nặng', 'Suy gan nặng', 'Có thai (3 tháng cuối)',
        ...
        'Theo dõi chức năng gan chặt chẽ (nguy cơ tăng men gan)'],pharmacokinetics': {'half_life':
        ...
        'Co giật (hiếm)'],treatment': ['Rửa dạ dày nếu uống trong vòng 1-2 giờ',
        'Than hoạt tính nếu uống trong vòng 1-2 giờ',
        'Theo dõi chức năng thận (creatinine, BUN), điện giải',
        ...
        'Không có antidote đặc hiệu. Điều trị chủ yếu là hỗ trợ và điều trị triệu chứng. Ngừng thuốc ngay. Điều trị chảy máu dạ dày và độc tính gan nếu có. Bù nước và điện giải nếu cần.'},administration_instructions': {'oral': {'with_food':
        ...
        "Goodman & Gilman's Pharmacological Basis of Therapeutics, 14th ed"],last_updated': '2025-01-06', 'evidence_level':
        'High - FDA-approved, extensive clinical data'},risk_flags': {
            'high_alert': False,
            'narrow_therapeutic_index': False,
            'bleeding_risk': True,
            'organ_toxicity': ['GI bleeding/ulceration (less than non-selective NSAIDs)', 'Renal toxicity', 'Cardiovascular events (MI, stroke)'],qt_prolongation': False,
    ...
    "Etoricoxib": {'group': 'Analgesic - NSAID (COX-2 Selective)',vietnamese_name': 'Etoricoxib, Arcoxia', 'administration': ['PO'],indications': ['Đau nhẹ đến trung bình', 'Viêm khớp', 'Đau bụng kinh',
        ...
        'Theo dõi nồng độ lithium. Có thể cần giảm liều lithium.'}],minor': []},contraindications': {'tuyệt_đối': [
        ...
        'Bệnh mạch vành, tiền sử nhồi máu cơ tim - tăng nguy cơ biến cố tim mạch',
        'Tăng huyết áp không kiểm soát - NSAID có thể tăng huyết áp',
        'Dùng warfarin hoặc thuốc chống đông - tăng nguy cơ chảy máu']},pregnancy_lactation': {'fda_category': 'C - D trong tam cá nguyệt 3',
        'pregnancy_details':
        ...
        'Không có antidote đặc hiệu. Điều trị chủ yếu là hỗ trợ và điều trị triệu chứng. Ngừng thuốc ngay. Điều trị chảy máu dạ dày nếu có. Bù nước và điện giải nếu cần.'},administration_instructions': {'oral': {'with_food':
        'Uống với thức ăn hoặc sữa để giảm kích ứng dạ dày', 'timing':
        'Dùng 1 lần/ngày (tiện lợi). Liều tối đa: 120mg/ngày.'},iv': None},references': {'primary_sources': [
    ...
    "Ibuprofen": {'group': 'Analgesic - NSAID',vietnamese_name': 'Ibuprofen, Brufen',
        ...
        'Không dùng trong 3 tháng cuối thai kỳ (đóng ống động mạch sớm)',
        'Ngừng trước phẫu thuật 5-7 ngày (tăng nguy cơ chảy máu)',
        'Dùng liều thấp nhất hiệu quả, thời gian ngắn nhất có thể'],pharmacokinetics': {'half_life': '2-4 giờ', 'onset': '30-60 phút',
        ...
        'management': 'Cân nhắc dùng PPI hoặc misoprostol để bảo vệ dạ dày'}]},contraindications': {'tuyệt_đối': [
        ...
        'vietnam': ['Brufen', 'Ibuprofen Stada', 'Ibuprofen', 'Advil', 'Nurofen'],common': ['Advil', 'Motrin', 'Ibuprofen', 'Brufen', 'Nurofen']
    },cost_estimate': {
        'unit': 'VND',
        ...
        "Goodman & Gilman's Pharmacological Basis of Therapeutics, 14th ed"],last_updated': '2025-02-04', 'evidence_level':
        'High - FDA-approved, extensive clinical data'},risk_flags': {
            'high_alert': False,
            'narrow_therapeutic_index': False,
            'bleeding_risk': True,
            'organ_toxicity': ['GI bleeding/ulceration', 'Renal toxicity (especially with ACE inhibitors)', 'Hepatotoxicity (rare)', 'Cardiovascular events (MI, stroke)'],qt_prolongation': False,
            'hepatotoxicity': False,
            'nephrotoxicity': True,
...
"pregnancy": "C - D trong 3 tháng cuối",
    ...
    "Ketorolac": {'group': 'Analgesic - NSAID',vietnamese_name':
        ...
        'CHỈ dùng ngắn hạn (≤5 ngày). Tác dụng giảm đau mạnh, tương đương opioid nhẹ. Nguy cơ chảy máu cao hơn NSAID khác.'},renal_adjustment': {'normal': 'Không đổi', '30_60':
        ...
        'Giảm liều ketorolac 50% khi dùng với probenecid. Theo dõi tác dụng phụ.'}],moderate': [{'drug': 'ACE inhibitor, ARB', 'mechanism':
        'Giảm tổng hợp prostaglandin ở thận, giảm lưu lượng máu thận', 'effect':
        ...
        'recommendation':
        'Có thể dùng khi cho con bú với liều ngắn hạn (≤5 ngày), nhưng thận trọng. Theo dõi trẻ về dấu hiệu bất thường.'}},hepatic_adjustment': {'mild': 'Không đổi', 'moderate':
        'Thận trọng, giảm liều 25-50%', 'severe':
        'Tránh dùng hoặc giảm liều mạnh', 'notes':
        'Ketorolac chuyển hóa ở gan qua CYP2C9 và glucuronidation. Suy gan làm giảm chuyển hóa, tăng nguy cơ tích lũy. Tuy nhiên, ketorolac ít gây độc gan trực tiếp hơn một số NSAID khác.'},overdose_management': {'symptoms': ['Chảy máu dạ dày nặng (triệu chứng chính)',
        ...
        'Không có antidote đặc hiệu. Điều trị chủ yếu là hỗ trợ và điều trị triệu chứng. Ngừng thuốc ngay. Điều trị chảy máu nghiêm trọng nếu có (truyền máu, điều trị hỗ trợ). Bù nước và điện giải nếu cần.'},administration_instructions': {'oral': {'with_food':
        'Uống với thức ăn hoặc sữa để giảm kích ứng dạ dày', 'timing':
        ...
        'Truyền trong 15-30 phút', 'compatibility': ['NaCl 0.9%', 'Dextrose 5%'],incompatibility': ['Không pha với các thuốc khác trong cùng đường truyền'],notes':
        ...
        'High - FDA-approved, extensive clinical data'},risk_flags': {
            ...
            'narrow_therapeutic_index': False,
            'bleeding_risk': True,
            'organ_toxicity': ['GI bleeding/ulceration', 'Renal toxicity (especially with long-term use)', 'Acute kidney injury (higher risk than other NSAIDs)'],qt_prolongation': False,
            'hepatotoxicity': False,
            'nephrotoxicity': True,
    ...
    "Meloxicam": {'group': 'Analgesic - NSAID',vietnamese_name': 'Meloxicam, Mobic',
        'administration': ['PO'],indications': [
        'Đau nhẹ đến trung bình', 'Viêm khớp dạng thấp', 'Viêm khớp xương khớp', 'Đau bụng kinh'],contraindications': ['Loét dạ dày tá tràng đang hoạt động',
        'Suy thận nặng', 'Suy gan nặng', 'Có thai (3 tháng cuối)',
        'Dị ứng NSAID/aspirin'],dosage': {'adult_po':
        '7.5-15mg x 1 lần/ngày', 'notes':
        'COX-2 selective, ít tác dụng phụ dạ dày hơn NSAID không chọn lọc. Uống với thức ăn'},renal_adjustment': {'normal': 'Không đổi', '30_60':
        'Thận trọng, giảm liều', 'under_30': 'Tránh dùng'},side_effects': [
        'Chảy máu dạ dày (ít hơn NSAID không chọn lọc)', 'Suy thận', 'Tăng huyết áp',
        ...
        'Thận trọng, giảm liều 25-50%', 'severe':
        'Tránh dùng hoặc giảm liều mạnh', 'notes':
        'Meloxicam chuyển hóa ở gan qua CYP2C9 và CYP3A4. Suy gan làm giảm chuyển hóa, tăng nguy cơ tích lũy. Tuy nhiên, meloxicam ít gây độc gan hơn một số NSAID khác.'},overdose_management': {'symptoms': ['Buồn nôn, nôn, đau bụng',
        'Chóng mặt, nhức đầu', 'Lú lẫn, buồn ngủ', 'Hạ huyết áp', 'Suy thận cấp',
        'Chảy máu dạ dày', 'Co giật (hiếm)'],antidote':
        'Không có antidote đặc hiệu', 'treatment': [
        'Rửa dạ dày nếu uống trong vòng 1-2 giờ',
        ...
        'High - FDA-approved, extensive clinical data'},risk_flags': {
            ...
            'narrow_therapeutic_index': False,
            'bleeding_risk': False,
            'organ_toxicity': ['GI bleeding/ulceration (lower risk than non-selective NSAIDs)', 'Renal toxicity', 'Cardiovascular events (MI, stroke - similar to non-selective NSAIDs)', 'Sulfonamide allergy (contraindicated)'],qt_prolongation': False,
            'hepatotoxicity': False,
            'nephrotoxicity': True,
    ...
    "Naproxen": {'group': 'Analgesic - NSAID',vietnamese_name': 'Naproxen, Naprosyn',
        ...
        'Gout cấp'],contraindications': [
        'Loét dạ dày tá tràng đang hoạt động', 'Suy thận nặng', 'Suy gan nặng',
        'Có thai (3 tháng cuối)', 'Dị ứng NSAID/aspirin', 'Suy tim nặng'],dosage': {'adult_pain': '250-500mg x 2 lần/ngày (tối đa 1.25g/ngày)',
        ...
        'Tăng huyết áp', 'Phù', 'Đau đầu', 'Ban da', 'Nhạy cảm với ánh sáng'],interactions': ['Warfarin: tăng nguy cơ chảy máu nặng',
        'ACE inhibitor: giảm hiệu quả, tăng nguy cơ suy thận',
        ...
        'Thời gian bán thải dài → tích lũy ở bệnh nhân suy thận, suy gan'],pharmacokinetics': {'half_life': '12-17 giờ (dài hơn ibuprofen)',
        'onset': '30-60 phút', 'duration': '8-12 giờ', 'protein_binding': '99%',
        'clearance': 'Gan (chuyển hóa qua CYP2C9, CYP1A2), thận (thải trừ)'},storage':
        ...
        'High - FDA-approved, extensive clinical data'},risk_flags': {
            ...
            'narrow_therapeutic_index': False,
            'bleeding_risk': True,
            'organ_toxicity': ['GI bleeding/ulceration', 'Renal toxicity', 'Hepatotoxicity (higher risk than other NSAIDs)', 'Cardiovascular events (MI, stroke)'],qt_prolongation': False,
            'hepatotoxicity': True,
            'nephrotoxicity': True,
