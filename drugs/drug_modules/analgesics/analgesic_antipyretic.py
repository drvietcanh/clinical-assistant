...
ANALGESIC_ANTIPYRETIC_DRUGS = {
                ...
                },
    {
        ...
        "pregnancy_lactation": {
            "fda_category": "B",
            "pregnancy_details": """Được xem là an toàn để hạ sốt và giảm đau trong tất cả các giai đoạn của thai kỳ khi dùng ở liều điều trị. Tuy nhiên, nên dùng liều thấp nhất có hiệu quả trong thời gian ngắn nhất.""",
            "lactation": {
                "safety": "Compatible",
