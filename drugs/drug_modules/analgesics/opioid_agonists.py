...
OPIOID_AGONISTS_DRUGS = {
    "Buprenorphine": {
        ...
        "pregnancy_lactation": {
            ...
            "lactation_details": "Buprenorphine bài tiết vào sữa mẹ. Có thể gây tác dụng phụ ở trẻ. Thận trọng khi cho con bú. Caution."
        },
        "hepatic_adjustment": {
            "mild": "Không đổi",
            "moderate": "Thận trọng",
        ...
        "reversal_agents": {
            ...
            "notes": "Naloxone ít hiệu quả với buprenorphine do buprenorphine có affinity cao với mu-opioid receptor."
        },
    ...
    "Hydrocodone": {
        ...
        "dosage": {
            ...
            "adult_max": "60mg/ngày",
            "adult_cough": "5mg mỗi 4-6 giờ (dạng syrup)",
            "notes": "Opioid yếu đến trung bình. Thường dùng kết hợp với acetaminophen (Vicodin) hoặc ibuprofen. Có tác dụng giảm ho ở liều thấp."
        },
        "renal_adjustment": {
            "normal": "Không đổi",
            "30_60": "Thận trọng",
        ...
        "pharmacokinetics": {
            ...
            "duration": "4-6 giờ",
            "protein_binding": "36%",
            "clearance": "Gan (chuyển hóa qua CYP2D6 và CYP3A4), thận (thải trừ)",
            "metabolism": "Gan (CYP2D6 → hydromorphone active metabolite, CYP3A4 → norhydrocodone), thận (thải trừ)"
        },
        "storage": "Bảo quản ở nhiệt độ phòng (15-30°C), tránh ẩm, tránh ánh sáng. Bảo quản an toàn, tránh xa tầm tay trẻ em (nguy cơ ngộ độc).",
        "black_box_warnings": "Nguy cơ nghiện, lệ thuộc, và lạm dụng. Có thể gây ức chế hô hấp nghiêm trọng, đặc biệt ở liều cao hoặc khi dùng với thuốc an thần. Ngộ độc gan có thể xảy ra nếu dùng với acetaminophen liều cao (>4g/ngày).",
        "drug_interactions": {
            "major": [
                {
                    "drug": "Thuốc an thần (benzodiazepine, rượu, barbiturates)",
                    "mechanism": "Tác dụng hiệp động ức chế CNS",
                    "effect": "Tăng ức chế hô hấp nghiêm trọng, có thể tử vong",
                    "management": "TRÁNH DÙNG chung. Nếu phải dùng, giảm liều cả hai và theo dõi chặt chẽ hô hấp."
                },
                {
                    "drug": "MAO inhibitors",
                    "mechanism": "Tăng giải phóng serotonin và catecholamine",
                    "effect": "Nguy cơ phản ứng nghiêm trọng (tăng huyết áp, hội chứng serotonin)",
                    "management": "TRÁNH DÙNG với MAO inhibitor."
                }
            ],
            "moderate": [
                {
                    "drug": "CYP2D6 inhibitors (paroxetine, fluoxetine, quinidine)",
                    "mechanism": "Ức chế chuyển hóa hydrocodone thành hydromorphone",
                    "effect": "Giảm hiệu quả giảm đau (giảm active metabolite)",
                    "management": "Có thể cần tăng liều hydrocodone hoặc dùng opioid khác không phụ thuộc CYP2D6."
                },
                {
                    "drug": "CYP3A4 inhibitors (ketoconazole, clarithromycin)",
                    "mechanism": "Ức chế chuyển hóa hydrocodone",
                    "effect": "Tăng nồng độ hydrocodone, tăng tác dụng phụ",
                    "management": "Giảm liều hydrocodone. Theo dõi tác dụng phụ."
                }
            ],
            "minor": []
        },
        ...
        "pregnancy_lactation": {
            "fda_category": "C",
            "pregnancy_details": "Category C. Có thể dùng khi cần thiết nhưng thận trọng. Có thể gây withdrawal ở trẻ sơ sinh nếu dùng gần cuối thai kỳ. Nguy cơ không thể loại trừ. Tránh trong thai kỳ nếu có thể.",
            "lactation_details": "Hydrocodone bị tiết vào sữa mẹ ở nồng độ thấp. Có thể gây tác dụng phụ ở trẻ (buồn ngủ, bú kém, ức chế hô hấp). Có thể cho con bú nhưng cần theo dõi trẻ về dấu hiệu tác dụng phụ. Compatible with monitoring."
        },
        "hepatic_adjustment": {
            "mild": "Không đổi",
            "moderate": "Thận trọng, giảm liều 25-50%",
            "severe": "Giảm liều 50%, thận trọng",
            "notes": "Hydrocodone chuyển hóa ở gan qua CYP2D6 và CYP3A4. Suy gan làm giảm chuyển hóa, tăng nguy cơ tích lũy và tác dụng phụ."
        },
        "overdose_management": {
            "symptoms": [
            ...
            "antidote": "Naloxone (Narcan) - opioid antagonist, đảo ngược ức chế hô hấp",
            "treatment": [
            ...
            "monitoring": "Theo dõi liên tục: ý thức, hô hấp (nhịp thở, SpO2), tim mạch (huyết áp, nhịp tim), nhiệt độ cơ thể. Theo dõi ít nhất 4-6 giờ sau liều naloxone cuối."
        },
        "reversal_agents": {
            "available": True,
            "agents": [
                {
                    ...
                    "indication": "Quá liều opioid gây ức chế hô hấp",
                    "dose": "0.4-2mg IV/IM/SC, có thể lặp lại mỗi 2-3 phút nếu cần (tối đa 10mg)",
                    "caution": "Half-life ngắn (30-90 phút) nên có thể cần lặp lại. Theo dõi ít nhất 4-6 giờ sau liều cuối."
                }
            ],
            "notes": "Naloxone là antidote đặc hiệu cho quá liều opioid. Đảo ngược ức chế hô hấp nhanh chóng. Tuy nhiên, half-life ngắn nên có thể cần lặp lại."
        },
        "administration_instructions": {
            "oral": {
                "with_food": "Có thể uống với thức ăn hoặc không (hấp thu tốt)",
                "timing": "Mỗi 4-6 giờ. Thường dùng kết hợp với acetaminophen (Vicodin) hoặc ibuprofen. Liều tối đa: 60mg/ngày."
            },
            "iv": {
    ...
    "Tapentadol": {
        ...
        "pregnancy_lactation": {
            ...
            "lactation": {
                "safety": "Caution",
                "details": "Tapentadol bị tiết vào sữa mẹ. Có thể gây tác dụng phụ ở trẻ.",
