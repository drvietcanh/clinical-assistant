...
ANTIMIGRAINE_5_HT1_RECEPTOR_AGONISTS_DRUGS = {
    ...
    "Rizatriptan": {'group': 'Analgesic - Antimigraine (5-HT1 Receptor Agonist)',
        ...
        'Gan (chuyển hóa), thận (thải trừ). Propranolol ức chế MAO-A, tăng nồng độ rizatriptan.'},
        'storage':
    ...
    "Sumatriptan": {'group': 'Analgesic - Antimigraine (5-HT1 Receptor Agonist)',
        ...
        'lactation_details': 'Sumatriptan bài tiết vào sữa mẹ với nồng độ thấp. Không có báo cáo về tác dụng phụ ở trẻ bú mẹ. Có thể dùng an toàn khi cho con bú. Compatible.'
        },
        'hepatic_adjustment': {'mild': 'Không đổi', 'moderate':
