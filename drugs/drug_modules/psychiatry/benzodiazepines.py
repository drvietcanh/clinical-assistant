...
BENZODIAZEPINES_DRUGS = {
    "Diazepam": {
        ...
        "brand_names": {
            "common": ["Valium"],
            "vietnam": ["Diazepam 5mg/10mg", "Seduxen"]
        },
    ...
    "Midazolam": {
        ...
        "brand_names": {
            "common": ["Versed", "Dormicum"],
            "vietnam": ["Dormicum 5mg/ml"]
        },
    ...
    "Alprazolam": {
        ...
        "brand_names": {
            "common": ["Xanax"],
            "vietnam": ["Xanax 0.25/0.5mg", "Alprazolam"]
        },
        "administration": ["PO"],
        "indications": [
    ...
    "Clonazepam": {
        ...
        "brand_names": {
            "common": ["Klonopin", "Rivotril"],
            "vietnam": ["Rivotril 0.5/2mg"]
        },
        "administration": ["PO"],
        "indications": [
            "Rối loạn hoảng sợ (Panic disorder)",
